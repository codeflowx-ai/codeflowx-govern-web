# Prompt de Migración - Core - OVERVIEWS
...
### ViewModels Identificados (5)


#### AdminDashboardViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.core`
- **Archivo:** `com/codeflowx/govern/viewmodel/core/AdminDashboardViewModel.java`
- **Servicios Usados:** AdminDashboardSummaryService
- **Entidades Usadas:** N/A
- **Mock Mode:** ❌ No

#### MenuViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.core`
- **Archivo:** `com/codeflowx/govern/viewmodel/core/MenuViewModel.java`
- **Servicios Usados:** MenuService
- **Entidades Usadas:** Menu
- **Mock Mode:** ❌ No

#### SecurityAuditViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.core`
- **Archivo:** `com/codeflowx/govern/viewmodel/core/SecurityAuditViewModel.java`
- **Servicios Usados:** SecurityAuditSummaryService
- **Entidades Usadas:** N/A
- **Mock Mode:** ❌ No

#### SystemHealthViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.core`
- **Archivo:** `com/codeflowx/govern/viewmodel/core/SystemHealthViewModel.java`
- **Servicios Usados:** SystemHealthOverviewService
- **Entidades Usadas:** N/A
- **Mock Mode:** ❌ No

#### UserActivityViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.core`
- **Archivo:** `com/codeflowx/govern/viewmodel/core/UserActivityViewModel.java`
- **Servicios Usados:** UserActivitySummaryService
- **Entidades Usadas:** N/A
- **Mock Mode:** ❌ No
...
- **Department** - `com.codeflowx.govern.entity.core`
- **LoginAttempt** - `com.codeflowx.govern.entity.core`
- **Menu** - `com.codeflowx.govern.entity.core`
- **Permission** - `com.codeflowx.govern.entity.core`
- **Role** - `com.codeflowx.govern.entity.core`
- **User** - `com.codeflowx.govern.entity.core`
- **UserSession** - `com.codeflowx.govern.entity.core`
...
**Total encontradas:** 29

- `app/(app)/admin/page.tsx`
- `app/(app)/admin/audit/page.tsx`
- `app/(app)/admin/departments/page.tsx`
- `app/(app)/admin/licenses/page.tsx`
- `app/(app)/admin/menu-management/page.tsx`
- `app/(app)/admin/nodes/page.tsx`
- `app/(app)/admin/notifications/page.tsx`
- `app/(app)/admin/sessions/page.tsx`
- `app/(app)/admin/updates/page.tsx`
- `app/(app)/admin/updates/installations/page.tsx`
- ... y 19 más
...
- `app/config/invoices/page.tsx`
- `app/config/roles/page.tsx`
- `app/config/security/page.tsx`
...
**Total encontradas:** 33

- `/admin/departments`
- `/admin/departments/hierarchy`
...
```typescript
{
  name: t("menu.core.screen_name", "Nombre de la Pantalla"),
  href: "/core/screen_path",
...
- **Archivo ZUL:** `console/platform/core/department-overview.zul`
...
### 2. login-attempt-overview
- **Archivo ZUL:** `console/platform/core/login-attempt-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
### 3. menu-overview
- **Archivo ZUL:** `console/platform/core/menu-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
- **Archivo ZUL:** `console/platform/core/permission-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
### 5. role-overview
- **Archivo ZUL:** `console/platform/core/role-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 6. security-audit-summary-overview
- **Archivo ZUL:** `console/platform/core/security-audit-summary-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 7. system-health-overview-overview
- **Archivo ZUL:** `console/platform/core/system-health-overview-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 8. user-activity-summary-overview
- **Archivo ZUL:** `console/platform/core/user-activity-summary-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
### 9. user-overview
- **Archivo ZUL:** `console/platform/core/user-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 10. user-session-overview
- **Archivo ZUL:** `console/platform/core/user-session-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
1. **ViewModel Java:** Buscar en `com.codeflowx.govern.viewmodel.core`
...
|---------------|--------|-------------------|-------------|
| `com.codeflowx.govern.service.core.EntityService.findAll()` | GET List | `/api/core/[entity]` | GET |
| `com.codeflowx.govern.service.core.EntityService.findById(id)` | GET Detail | `/api/core/[entity]/[id]` | GET |
| `com.codeflowx.govern.service.core.EntityService.create(entity)` | POST | `/api/core/[entity]` | POST |
| `com.codeflowx.govern.service.core.EntityService.update(entity)` | PUT | `/api/core/[entity]/[id]` | PUT |
| `com.codeflowx.govern.service.core.EntityService.deleteById(id)` | DELETE | `/api/core/[entity]/[id]` | DELETE |

**BusinessService (genérico):**
- `businessService.findAllEntity(Entity.class, pageParams, criterias)` → `/api/core/[entity]?page=1&size=10&...`
- `businessService.findById(Entity.class, id)` → `/api/core/[entity]/[id]`
- `businessService.save(entity)` → `/api/core/[entity]` (POST/PUT según ID)
...
**ZUL Original:**
- `console/platform/core/example-overview.zul`

**ViewModel:**
- `com.codeflowx.govern.viewmodel.core.ExampleOverviewViewModel`

**Servicios:**
- `com.codeflowx.govern.service.core.ExampleService`

**Entidades:**
- `com.codeflowx.govern.entity.core.Example`

**Página Next.js:**
- `app/(app)/core/example/page.tsx`

**API Route Mock:**
- `app/api/core/example/route.ts`
