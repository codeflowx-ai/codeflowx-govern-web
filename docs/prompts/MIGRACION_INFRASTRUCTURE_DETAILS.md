# Prompt de Migración - Infrastructure - DETAILS
...
## Pantallas a Migrar (12)


### 1. cloud-credential-detail
- **Archivo ZUL:** `console/platform/infrastructure/cloud-credential-detail.zul`
...
### 2. cloud-provider-detail
- **Archivo ZUL:** `console/platform/infrastructure/cloud-provider-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 3. cloud-region-detail
- **Archivo ZUL:** `console/platform/infrastructure/cloud-region-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 4. cloud-resource-detail
- **Archivo ZUL:** `console/platform/infrastructure/cloud-resource-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 5. gpu-instance-detail
- **Archivo ZUL:** `console/platform/infrastructure/gpu-instance-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 6. infrastructure-audit-detail
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-audit-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 7. infrastructure-cost-detail
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-cost-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 8. infrastructure-metric-detail
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-metric-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 9. infrastructure-template-detail
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-template-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 10. kubernetes-cluster-detail
- **Archivo ZUL:** `console/platform/infrastructure/kubernetes-cluster-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 11. kubernetes-node-detail
- **Archivo ZUL:** `console/platform/infrastructure/kubernetes-node-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 12. resource-quota-detail
- **Archivo ZUL:** `console/platform/infrastructure/resource-quota-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
