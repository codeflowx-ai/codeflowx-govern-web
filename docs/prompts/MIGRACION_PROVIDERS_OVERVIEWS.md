# Prompt de Migración - Providers - OVERVIEWS
...
#### ProvidersDetailViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.providers`
- **Archivo:** `com/codeflowx/govern/viewmodel/providers/ProvidersDetailViewModel.java`
- **Servicios Usados:** ModelService, ModelProviderService, ProviderCredentialService
- **Entidades Usadas:** Model, ModelProvider, ProviderCredential
- **Mock Mode:** ❌ No

#### ProvidersOverviewViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.providers`
- **Archivo:** `com/codeflowx/govern/viewmodel/providers/ProvidersOverviewViewModel.java`
- **Servicios Usados:** ModelService, ProvidersOverviewService, ProvidersMetricsSummaryService
...
```typescript
{
  name: t("menu.providers.screen_name", "Nombre de la Pantalla"),
  href: "/providers/screen_path",
...
### 1. providers-metrics-summary-overview
- **Archivo ZUL:** `console/platform/providers/providers-metrics-summary-overview.zul`
...
1. **ViewModel Java:** Buscar en `com.codeflowx.govern.viewmodel.providers`
...
|---------------|--------|-------------------|-------------|
| `com.codeflowx.govern.service.providers.EntityService.findAll()` | GET List | `/api/providers/[entity]` | GET |
| `com.codeflowx.govern.service.providers.EntityService.findById(id)` | GET Detail | `/api/providers/[entity]/[id]` | GET |
| `com.codeflowx.govern.service.providers.EntityService.create(entity)` | POST | `/api/providers/[entity]` | POST |
| `com.codeflowx.govern.service.providers.EntityService.update(entity)` | PUT | `/api/providers/[entity]/[id]` | PUT |
| `com.codeflowx.govern.service.providers.EntityService.deleteById(id)` | DELETE | `/api/providers/[entity]/[id]` | DELETE |

**BusinessService (genérico):**
- `businessService.findAllEntity(Entity.class, pageParams, criterias)` → `/api/providers/[entity]?page=1&size=10&...`
- `businessService.findById(Entity.class, id)` → `/api/providers/[entity]/[id]`
- `businessService.save(entity)` → `/api/providers/[entity]` (POST/PUT según ID)
...
**ZUL Original:**
- `console/platform/providers/example-overview.zul`

**ViewModel:**
- `com.codeflowx.govern.viewmodel.providers.ExampleOverviewViewModel`

**Servicios:**
- `com.codeflowx.govern.service.providers.ExampleService`

**Entidades:**
- `com.codeflowx.govern.entity.providers.Example`

**Página Next.js:**
- `app/(app)/providers/example/page.tsx`

**API Route Mock:**
- `app/api/providers/example/route.ts`
