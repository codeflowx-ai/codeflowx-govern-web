# Prompt de Migración - Monitoring - FORMS
...
### 1. response-form
- **Archivo ZUL:** `console/platform/monitoring/alerts/response-form.zul`
...
### 2. views-performance
- **Archivo ZUL:** `console/platform/monitoring/distributed/views-performance.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** forms
...
### 3. intervention-form
- **Archivo ZUL:** `console/platform/monitoring/performance/intervention-form.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** forms
