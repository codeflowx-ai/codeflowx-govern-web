# Prompt de Migración - Core - DETAILS
...
### 1. department-detail
- **Archivo ZUL:** `console/platform/core/department-detail.zul`
...
### 2. login-attempt-detail
- **Archivo ZUL:** `console/platform/core/login-attempt-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 3. menu-detail
- **Archivo ZUL:** `console/platform/core/menu-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 4. permission-detail
- **Archivo ZUL:** `console/platform/core/permission-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 5. role-detail
- **Archivo ZUL:** `console/platform/core/role-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 6. user-detail
- **Archivo ZUL:** `console/platform/core/user-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 7. user-session-detail
- **Archivo ZUL:** `console/platform/core/user-session-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
