# Prompt de Migración - Analytics - OVERVIEWS

## Contexto del Módulo

**Módulo:** Analytics
**Tipo de Pantallas:** overviews
**Total de Pantallas:** 3
...
### ViewModels Identificados (9)


#### AnalyticsAccountabilityViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsAccountabilityViewModel.java`
- **Servicios Usados:** PolicyService, PolicyEvaluationService, PolicyAuditLogService
- **Entidades Usadas:** PolicyEvaluation, PolicyAuditLog
- **Mock Mode:** ❌ No

#### AnalyticsBiasViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsBiasViewModel.java`
- **Servicios Usados:** ModelService, BiasAnalysisService, BiasDetectionService
- **Entidades Usadas:** BiasDetection, BiasAnalysis
- **Mock Mode:** ❌ No

#### AnalyticsFairnessViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsFairnessViewModel.java`
- **Servicios Usados:** ModelService
- **Entidades Usadas:** BiasAnalysis, FairnessMetric
- **Mock Mode:** ❌ No

#### AnalyticsImpactViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsImpactViewModel.java`
...
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsMetricViewModel.java`
- **Servicios Usados:** AnalyticsMetricService
- **Entidades Usadas:** AnalyticsMetric
- **Mock Mode:** ❌ No

#### AnalyticsOverviewViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsOverviewViewModel.java`
- **Servicios Usados:** ModelService, AnalyticsOverviewService
- **Entidades Usadas:** N/A
- **Mock Mode:** ❌ No

#### AnalyticsReportViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsReportViewModel.java`
- **Servicios Usados:** AnalyticsReportService
- **Entidades Usadas:** AnalyticsReport
- **Mock Mode:** ❌ No

#### AnalyticsTransparencyViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsTransparencyViewModel.java`
- **Servicios Usados:** PolicyService, PolicyAuditLogService, ModelService
- **Entidades Usadas:** Model, PolicyAuditLog
- **Mock Mode:** ❌ No

#### AnalyticsTrendsViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.analytics`
- **Archivo:** `com/codeflowx/govern/viewmodel/analytics/AnalyticsTrendsViewModel.java`
- **Servicios Usados:** ModelService, AnalyticsTrendsService
- **Entidades Usadas:** N/A
- **Mock Mode:** ❌ No
...
- **AnalyticsMetric** - `com.codeflowx.govern.entity.analytics`
- **AnalyticsReport** - `com.codeflowx.govern.entity.analytics`
...
```typescript
{
  name: t("menu.analytics.screen_name", "Nombre de la Pantalla"),
  href: "/analytics/screen_path",
...
## Pantallas a Migrar (3)


### 1. overview
- **Archivo ZUL:** `console/platform/analytics/metrics/overview.zul`
...
### 2. overview
- **Archivo ZUL:** `console/platform/analytics/reports/overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
### 3. overview
- **Archivo ZUL:** `console/platform/analytics/trends/overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
1. **ViewModel Java:** Buscar en `com.codeflowx.govern.viewmodel.analytics`
...
|---------------|--------|-------------------|-------------|
| `com.codeflowx.govern.service.analytics.EntityService.findAll()` | GET List | `/api/analytics/[entity]` | GET |
| `com.codeflowx.govern.service.analytics.EntityService.findById(id)` | GET Detail | `/api/analytics/[entity]/[id]` | GET |
| `com.codeflowx.govern.service.analytics.EntityService.create(entity)` | POST | `/api/analytics/[entity]` | POST |
| `com.codeflowx.govern.service.analytics.EntityService.update(entity)` | PUT | `/api/analytics/[entity]/[id]` | PUT |
| `com.codeflowx.govern.service.analytics.EntityService.deleteById(id)` | DELETE | `/api/analytics/[entity]/[id]` | DELETE |

**BusinessService (genérico):**
- `businessService.findAllEntity(Entity.class, pageParams, criterias)` → `/api/analytics/[entity]?page=1&size=10&...`
- `businessService.findById(Entity.class, id)` → `/api/analytics/[entity]/[id]`
- `businessService.save(entity)` → `/api/analytics/[entity]` (POST/PUT según ID)
...
**ZUL Original:**
- `console/platform/analytics/example-overview.zul`

**ViewModel:**
- `com.codeflowx.govern.viewmodel.analytics.ExampleOverviewViewModel`

**Servicios:**
- `com.codeflowx.govern.service.analytics.ExampleService`

**Entidades:**
- `com.codeflowx.govern.entity.analytics.Example`

**Página Next.js:**
- `app/(app)/analytics/example/page.tsx`

**API Route Mock:**
- `app/api/analytics/example/route.ts`
