# Prompt de Migración - Training - DASHBOARDS
...
### 1. dashboard
- **Archivo ZUL:** `console/platform/training/governance/dashboard.zul`
...
### 2. dashboard
- **Archivo ZUL:** `console/platform/training/hpo/dashboard.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** dashboards
