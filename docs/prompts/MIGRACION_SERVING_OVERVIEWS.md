# Prompt de Migración - Serving - OVERVIEWS
...
## Pantallas a Migrar (16)


### 1. deployment-instance-overview
- **Archivo ZUL:** `console/platform/serving/deployment-instance-overview.zul`
...
### 2. deployment-log-overview
- **Archivo ZUL:** `console/platform/serving/deployment-log-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 3. deployment-metric-overview
- **Archivo ZUL:** `console/platform/serving/deployment-metric-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
- **Archivo ZUL:** `console/platform/serving/error-analysis-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 6. model-deployment-overview
- **Archivo ZUL:** `console/platform/serving/model-deployment-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 7. model-metrics-overview
- **Archivo ZUL:** `console/platform/serving/model-metrics-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
### 8. model-overview
- **Archivo ZUL:** `console/platform/serving/model-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 9. model-prediction-overview
- **Archivo ZUL:** `console/platform/serving/model-prediction-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 10. model-version-overview
- **Archivo ZUL:** `console/platform/serving/model-version-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 11. serving-cost-breakdown-overview
- **Archivo ZUL:** `console/platform/serving/serving-cost-breakdown-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 12. serving-endpoint-overview
- **Archivo ZUL:** `console/platform/serving/serving-endpoint-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 13. serving-error-analysis-overview
- **Archivo ZUL:** `console/platform/serving/serving-error-analysis-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 14. serving-request-overview
- **Archivo ZUL:** `console/platform/serving/serving-request-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 15. serving-sla-compliance-overview
- **Archivo ZUL:** `console/platform/serving/serving-sla-compliance-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 16. sla-compliance-overview
- **Archivo ZUL:** `console/platform/serving/sla-compliance-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
