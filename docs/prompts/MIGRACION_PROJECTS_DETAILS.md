# Prompt de Migración - Projects - DETAILS
...
## Pantallas a Migrar (18)


### 1. project-artifact-detail
- **Archivo ZUL:** `console/platform/projects/project-artifact-detail.zul`
...
- **Archivo ZUL:** `console/platform/projects/project-billing-detail-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
- **Archivo ZUL:** `console/platform/projects/project-cost-estimator-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 4. project-detail
- **Archivo ZUL:** `console/platform/projects/project-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 5. project-document-detail
- **Archivo ZUL:** `console/platform/projects/project-document-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 6. project-domain-detail
- **Archivo ZUL:** `console/platform/projects/project-domain-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 7. project-invoice-detail
- **Archivo ZUL:** `console/platform/projects/project-invoice-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 8. project-license-detail
- **Archivo ZUL:** `console/platform/projects/project-license-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 9. project-member-detail
- **Archivo ZUL:** `console/platform/projects/project-member-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 10. project-requirement-detail
- **Archivo ZUL:** `console/platform/projects/project-requirement-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 11. project-resource-consumption-detail
- **Archivo ZUL:** `console/platform/projects/project-resource-consumption-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 12. project-roi-detail
- **Archivo ZUL:** `console/platform/projects/project-roi-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 13. project-stack-detail
- **Archivo ZUL:** `console/platform/projects/project-stack-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 14. project-task-detail
- **Archivo ZUL:** `console/platform/projects/project-task-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 15. project-technology-detail
- **Archivo ZUL:** `console/platform/projects/project-technology-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 16. project-time-tracking-detail
- **Archivo ZUL:** `console/platform/projects/project-time-tracking-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 17. project-token-detail
- **Archivo ZUL:** `console/platform/projects/project-token-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 18. project-version-detail
- **Archivo ZUL:** `console/platform/projects/project-version-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
