# Prompt de Migración - Monitoring - DETAILS
...
## Pantallas a Migrar (7)


### 1. detail
- **Archivo ZUL:** `console/platform/monitoring/alerts/detail.zul`
...
### 2. system-detail
- **Archivo ZUL:** `console/platform/monitoring/alerts/system-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 3. audit-log-detail
- **Archivo ZUL:** `console/platform/monitoring/distributed/audit-log-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 4. governance-detail
- **Archivo ZUL:** `console/platform/monitoring/distributed/governance-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details

### 5. system-health-detail
- **Archivo ZUL:** `console/platform/monitoring/distributed/system-health-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 6. detail
- **Archivo ZUL:** `console/platform/monitoring/metrics/detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
...
### 7. system-detail
- **Archivo ZUL:** `console/platform/monitoring/metrics/system-detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
