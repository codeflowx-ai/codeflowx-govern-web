# Prompt de Migración - Analytics - DETAILS
...
### 1. detail
- **Archivo ZUL:** `console/platform/analytics/metrics/detail.zul`
...
### 2. detail
- **Archivo ZUL:** `console/platform/analytics/reports/detail.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** details
