# Prompt de Migración - Monitoring - OVERVIEWS
...
**Documento:** `docs/funcional/monitoring/01_REORGANIZACION_PANTALLAS_MONITORING.md`

**Ubicación:** `suinsit.nova.web/docs/funcional/monitoring/01_REORGANIZACION_PANTALLAS_MONITORING.md`
...
- **Paquete:** `com.codeflowx.govern.viewmodel.monitoring`
- **Archivo:** `com/codeflowx/govern/viewmodel/monitoring/MonitoringDashboardViewModel.java`
- **Servicios Usados:** ModelService, MonitoringDashboardService, MetricsVisualizationService, AnomalyHeatmapService, AlertSummaryService
...
- **AuditLog** - `com.codeflowx.govern.entity.monitoring`
- **DriftDetection** - `com.codeflowx.govern.entity.monitoring`
- **MonitoringAlert** - `com.codeflowx.govern.entity.monitoring`
- **MonitoringMetric** - `com.codeflowx.govern.entity.monitoring`
- **PerformanceMetrics** - `com.codeflowx.govern.entity.monitoring`
- **ProcessExecution** - `com.codeflowx.govern.entity.monitoring`
- **SystemAlert** - `com.codeflowx.govern.entity.monitoring`
- **SystemHealth** - `com.codeflowx.govern.entity.monitoring`
- **SystemMetric** - `com.codeflowx.govern.entity.monitoring`
...
```typescript
{
  name: t("menu.monitoring.screen_name", "Nombre de la Pantalla"),
  href: "/monitoring/screen_path",
...
## Pantallas a Migrar (8)


### 1. overview
- **Archivo ZUL:** `console/platform/monitoring/alerts/overview.zul`
...
### 2. system-overview
- **Archivo ZUL:** `console/platform/monitoring/alerts/system-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
### 3. overview
- **Archivo ZUL:** `console/platform/monitoring/dashboard/overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 4. audit-log-overview
- **Archivo ZUL:** `console/platform/monitoring/distributed/audit-log-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
- **Archivo ZUL:** `console/platform/monitoring/distributed/system-health-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
### 6. overview
- **Archivo ZUL:** `console/platform/monitoring/metrics/overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
- **Archivo ZUL:** `console/platform/monitoring/metrics/performance-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
### 8. system-overview
- **Archivo ZUL:** `console/platform/monitoring/metrics/system-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
1. **ViewModel Java:** Buscar en `com.codeflowx.govern.viewmodel.monitoring`
...
|---------------|--------|-------------------|-------------|
| `com.codeflowx.govern.service.monitoring.EntityService.findAll()` | GET List | `/api/monitoring/[entity]` | GET |
| `com.codeflowx.govern.service.monitoring.EntityService.findById(id)` | GET Detail | `/api/monitoring/[entity]/[id]` | GET |
| `com.codeflowx.govern.service.monitoring.EntityService.create(entity)` | POST | `/api/monitoring/[entity]` | POST |
| `com.codeflowx.govern.service.monitoring.EntityService.update(entity)` | PUT | `/api/monitoring/[entity]/[id]` | PUT |
| `com.codeflowx.govern.service.monitoring.EntityService.deleteById(id)` | DELETE | `/api/monitoring/[entity]/[id]` | DELETE |

**BusinessService (genérico):**
- `businessService.findAllEntity(Entity.class, pageParams, criterias)` → `/api/monitoring/[entity]?page=1&size=10&...`
- `businessService.findById(Entity.class, id)` → `/api/monitoring/[entity]/[id]`
- `businessService.save(entity)` → `/api/monitoring/[entity]` (POST/PUT según ID)
...
**ZUL Original:**
- `console/platform/monitoring/example-overview.zul`

**ViewModel:**
- `com.codeflowx.govern.viewmodel.monitoring.ExampleOverviewViewModel`

**Servicios:**
- `com.codeflowx.govern.service.monitoring.ExampleService`

**Entidades:**
- `com.codeflowx.govern.entity.monitoring.Example`

**Página Next.js:**
- `app/(app)/monitoring/example/page.tsx`

**API Route Mock:**
- `app/api/monitoring/example/route.ts`
