# Prompt de Migración - Compliance - DASHBOARDS
...
### 2. post-market-monitoring-dashboard
- **Archivo ZUL:** `console/gobierno/compliance/post-market-monitoring-dashboard.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** dashboards
...
### 3. sector-dashboard
- **Archivo ZUL:** `console/gobierno/compliance/sector-dashboard.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** dashboards
