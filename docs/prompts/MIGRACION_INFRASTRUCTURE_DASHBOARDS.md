# Prompt de Migración - Infrastructure - DASHBOARDS
...
### 1. resource-utilization-dashboard-overview
- **Archivo ZUL:** `console/platform/infrastructure/resource-utilization-dashboard-overview.zul`
