# Prompt de Migración - Infrastructure - OVERVIEWS

## Contexto del Módulo

**Módulo:** Infrastructure
**Tipo de Pantallas:** overviews
**Total de Pantallas:** 17
...
#### InfrastructureDetailViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.infrastructure`
- **Archivo:** `com/codeflowx/govern/viewmodel/infrastructure/InfrastructureDetailViewModel.java`
- **Servicios Usados:** CloudResourceService, InfrastructureMetricService, InfrastructureCostService
- **Entidades Usadas:** InfrastructureMetric, InfrastructureCost, CloudResource
- **Mock Mode:** ❌ No

#### InfrastructureOverviewViewModel
- **Paquete:** `com.codeflowx.govern.viewmodel.infrastructure`
- **Archivo:** `com/codeflowx/govern/viewmodel/infrastructure/InfrastructureOverviewViewModel.java`
- **Servicios Usados:** CloudResourceService, InfrastructureOverviewService, InfrastructureMetricsSummaryService
- **Entidades Usadas:** CloudResource
- **Mock Mode:** ❌ No
...
- **CloudCredential** - `com.codeflowx.govern.entity.infrastructure`
- **CloudProvider** - `com.codeflowx.govern.entity.infrastructure`
- **CloudRegion** - `com.codeflowx.govern.entity.infrastructure`
- **CloudResource** - `com.codeflowx.govern.entity.infrastructure`
- **GpuInstance** - `com.codeflowx.govern.entity.infrastructure`
- **InfrastructureAudit** - `com.codeflowx.govern.entity.infrastructure`
- **InfrastructureCost** - `com.codeflowx.govern.entity.infrastructure`
- **InfrastructureMetric** - `com.codeflowx.govern.entity.infrastructure`
- **InfrastructureTemplate** - `com.codeflowx.govern.entity.infrastructure`
- **KubernetesCluster** - `com.codeflowx.govern.entity.infrastructure`
...
- `app/(app)/infrastructure/cost-management/page.tsx`
- `app/(app)/infrastructure/credentials/page.tsx`
- `app/(app)/infrastructure/deployments/page.tsx`
- `app/(app)/infrastructure/gpu-instances/page.tsx`
- `app/(app)/infrastructure/kubernetes/page.tsx`
- `app/(app)/infrastructure/providers/page.tsx`
- `app/(app)/infrastructure/resources/page.tsx`
...
```typescript
{
  name: t("menu.infrastructure.screen_name", "Nombre de la Pantalla"),
  href: "/infrastructure/screen_path",
...
## Pantallas a Migrar (17)


### 1. capacity-forecast-overview
- **Archivo ZUL:** `console/platform/infrastructure/capacity-forecast-overview.zul`
...
### 2. cloud-credential-overview
- **Archivo ZUL:** `console/platform/infrastructure/cloud-credential-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 3. cloud-provider-overview
- **Archivo ZUL:** `console/platform/infrastructure/cloud-provider-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 4. cloud-region-overview
- **Archivo ZUL:** `console/platform/infrastructure/cloud-region-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 5. cloud-resource-overview
- **Archivo ZUL:** `console/platform/infrastructure/cloud-resource-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 6. gpu-instance-overview
- **Archivo ZUL:** `console/platform/infrastructure/gpu-instance-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 7. infrastructure-audit-overview
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-audit-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 8. infrastructure-cost-analysis-overview
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-cost-analysis-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 9. infrastructure-cost-overview
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-cost-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 10. infrastructure-health-matrix-overview
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-health-matrix-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 11. infrastructure-metric-overview
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-metric-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 12. infrastructure-metrics-summary-overview
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-metrics-summary-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 13. infrastructure-overview-overview
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-overview-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 14. infrastructure-template-overview
- **Archivo ZUL:** `console/platform/infrastructure/infrastructure-template-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 15. kubernetes-cluster-overview
- **Archivo ZUL:** `console/platform/infrastructure/kubernetes-cluster-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 16. kubernetes-node-overview
- **Archivo ZUL:** `console/platform/infrastructure/kubernetes-node-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews

### 17. resource-quota-overview
- **Archivo ZUL:** `console/platform/infrastructure/resource-quota-overview.zul`
- **ViewModel Asociado:** [Identificar en el código ZUL]
- **Servicio Backend:** [Identificar del ViewModel]
- **Entidad JPA:** [Identificar del ViewModel]
- **Tipo:** overviews
...
1. **ViewModel Java:** Buscar en `com.codeflowx.govern.viewmodel.infrastructure`
...
- Crear API routes mock: `/api/infrastructure/dashboard/metrics`

#### Para Overview/Listados:
- Implementar tabla con paginación
- Filtros y búsqueda
- Mock data para lista
- API route: `/api/infrastructure/[entity]/list`

#### Para Detail/CRUD:
- Formulario completo con validaciones
- Estados: create, edit, view
- Mock data para formulario
- API routes: `/api/infrastructure/[entity]/[id]` (GET, POST, PUT, DELETE)

#### Para Forms:
- Formulario simple con validaciones
- Mock data para campos
- API route: `/api/infrastructure/[entity]/submit`
...
|---------------|--------|-------------------|-------------|
| `com.codeflowx.govern.service.infrastructure.EntityService.findAll()` | GET List | `/api/infrastructure/[entity]` | GET |
| `com.codeflowx.govern.service.infrastructure.EntityService.findById(id)` | GET Detail | `/api/infrastructure/[entity]/[id]` | GET |
| `com.codeflowx.govern.service.infrastructure.EntityService.create(entity)` | POST | `/api/infrastructure/[entity]` | POST |
| `com.codeflowx.govern.service.infrastructure.EntityService.update(entity)` | PUT | `/api/infrastructure/[entity]/[id]` | PUT |
| `com.codeflowx.govern.service.infrastructure.EntityService.deleteById(id)` | DELETE | `/api/infrastructure/[entity]/[id]` | DELETE |

**BusinessService (genérico):**
- `businessService.findAllEntity(Entity.class, pageParams, criterias)` → `/api/infrastructure/[entity]?page=1&size=10&...`
- `businessService.findById(Entity.class, id)` → `/api/infrastructure/[entity]/[id]`
- `businessService.save(entity)` → `/api/infrastructure/[entity]` (POST/PUT según ID)
...
**ZUL Original:**
- `console/platform/infrastructure/example-overview.zul`

**ViewModel:**
- `com.codeflowx.govern.viewmodel.infrastructure.ExampleOverviewViewModel`

**Servicios:**
- `com.codeflowx.govern.service.infrastructure.ExampleService`

**Entidades:**
- `com.codeflowx.govern.entity.infrastructure.Example`

**Página Next.js:**
- `app/(app)/infrastructure/example/page.tsx`

**API Route Mock:**
- `app/api/infrastructure/example/route.ts`
