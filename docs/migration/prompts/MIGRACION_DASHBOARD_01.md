# Migración de ViewModels a Servicios Dedicados - Dashboard
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/dashboard/MainDashboardViewModel.java`

**Problemas encontrados**:
- Línea 195: businessService.findAllEntity(
- -> Debería usar:
- Línea 220: businessService.findAllEntity(
- -> Debería usar:
- Línea 245: businessService.findAllEntity(
- -> Debería usar:
- Línea 270: businessService.findAllEntity(
- -> Debería usar:
- Línea 169: businessService.findAllView(
- -> Debería usar:
- ... y 8 más
...
### CostMetricsDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/CostMetricsDetailViewModel.java`

**Problemas encontrados**:
- Línea 172: businessService.findById(CostMetrics.class
- -> Debería usar: CostMetricsService
...
### CostMetricsOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/CostMetricsOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(CostMetrics.class
- -> Debería usar: CostMetricsService
- Línea 194: businessService.findAllView(CostMetricsMetricsSummary.class
- -> Debería usar: CostMetricsMetricsSummaryService

**Servicios a usar**:
- `CostMetricsMetricsSummaryService`
- `CostMetricsService`

---


### DistributionDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/DistributionDetailViewModel.java`

**Problemas encontrados**:
- Línea 169: businessService.findById(Distribution.class
- -> Debería usar: DistributionService
...
### DistributionOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/DistributionOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(Distribution.class
- -> Debería usar: DistributionService
- Línea 194: businessService.findAllView(DistributionMetricsSummary.class
- -> Debería usar: DistributionMetricsSummaryService

**Servicios a usar**:
- `DistributionMetricsSummaryService`
- `DistributionService`

---


### ModuleActivityDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/ModuleActivityDetailViewModel.java`

**Problemas encontrados**:
- Línea 173: businessService.findById(ModuleActivity.class
- -> Debería usar: ModuleActivityService
...
### ModuleActivityOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/ModuleActivityOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(ModuleActivity.class
- -> Debería usar: ModuleActivityService
- Línea 194: businessService.findAllView(ModuleActivityMetricsSummary.class
- -> Debería usar: ModuleActivityMetricsSummaryService

**Servicios a usar**:
- `ModuleActivityMetricsSummaryService`
- `ModuleActivityService`

---


### ModuleStatsDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/ModuleStatsDetailViewModel.java`

**Problemas encontrados**:
- Línea 169: businessService.findById(ModuleStats.class
- -> Debería usar: ModuleStatsService
...
### ModuleStatsOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/ModuleStatsOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(ModuleStats.class
- -> Debería usar: ModuleStatsService
- Línea 194: businessService.findAllView(ModuleStatsMetricsSummary.class
- -> Debería usar: ModuleStatsMetricsSummaryService

**Servicios a usar**:
- `ModuleStatsMetricsSummaryService`
- `ModuleStatsService`

---


### QuickActionDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/QuickActionDetailViewModel.java`

**Problemas encontrados**:
- Línea 168: businessService.findById(QuickAction.class
- -> Debería usar: QuickActionService
...
### QuickActionOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/QuickActionOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(QuickAction.class
- -> Debería usar: QuickActionService
- Línea 194: businessService.findAllView(QuickActionMetricsSummary.class
- -> Debería usar: QuickActionMetricsSummaryService

**Servicios a usar**:
- `QuickActionMetricsSummaryService`
- `QuickActionService`

---


### TimeSeriesDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/TimeSeriesDetailViewModel.java`

**Problemas encontrados**:
- Línea 171: businessService.findById(TimeSeries.class
- -> Debería usar: TimeSeriesService
...
### TimeSeriesOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/TimeSeriesOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(TimeSeries.class
- -> Debería usar: TimeSeriesService
- Línea 194: businessService.findAllView(TimeSeriesMetricsSummary.class
- -> Debería usar: TimeSeriesMetricsSummaryService

**Servicios a usar**:
- `TimeSeriesMetricsSummaryService`
- `TimeSeriesService`

---


### TokenMetricsDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/TokenMetricsDetailViewModel.java`

**Problemas encontrados**:
- Línea 173: businessService.findById(TokenMetrics.class
- -> Debería usar: TokenMetricsService
...
### TokenMetricsOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/dashboard/TokenMetricsOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(TokenMetrics.class
- -> Debería usar: TokenMetricsService
- Línea 194: businessService.findAllView(TokenMetricsMetricsSummary.class
- -> Debería usar: TokenMetricsMetricsSummaryService

**Servicios a usar**:
- `TokenMetricsMetricsSummaryService`
- `TokenMetricsService`
