# Migración de ViewModels a Servicios Dedicados - Notifications

## Información del Documento
- **Módulo**: Notifications
- **Total ViewModels**: 10
- **Documento**: 1 de 1
- **ViewModels en este documento**: 10
...
### NotificationChannelDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationChannelDetailViewModel.java`

**Problemas encontrados**:
- Línea 312: businessService.findAllEntity(NotificationLog.class
- -> Debería usar: NotificationLogService
- Línea 338: businessService.findAllEntity(Notification.class
- -> Debería usar: NotificationService
- Línea 177: businessService.findById(NotificationChannel.class
- -> Debería usar: NotificationChannelService
...
### NotificationChannelOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationChannelOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 250: businessService.removeFromID(NotificationChannel.class
- -> Debería usar: NotificationChannelService
- Línea 187: businessService.findAllView(NotificationChannelMetricsSummary.class
- -> Debería usar: NotificationChannelMetricsSummaryService

**Servicios a usar**:
- `NotificationChannelMetricsSummaryService`
- `NotificationChannelService`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationDetailViewModel.java`

**Problemas encontrados**:
- Línea 342: businessService.findAllEntity(NotificationLog.class
- -> Debería usar: NotificationLogService
- Línea 177: businessService.findById(Notification.class
- -> Debería usar: NotificationService
...
### NotificationLogDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationLogDetailViewModel.java`

**Problemas encontrados**:
- Línea 171: businessService.findById(NotificationLog.class
- -> Debería usar: NotificationLogService
...
### NotificationLogOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationLogOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 250: businessService.removeFromID(NotificationLog.class
- -> Debería usar: NotificationLogService
- Línea 187: businessService.findAllView(NotificationLogMetricsSummary.class
- -> Debería usar: NotificationLogMetricsSummaryService

**Servicios a usar**:
- `NotificationLogMetricsSummaryService`
- `NotificationLogService`

---


### NotificationOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 250: businessService.removeFromID(Notification.class
- -> Debería usar: NotificationService
- Línea 187: businessService.findAllView(NotificationMetricsSummary.class
- -> Debería usar: NotificationMetricsSummaryService

**Servicios a usar**:
- `NotificationMetricsSummaryService`
- `NotificationService`

---


### NotificationPreferenceDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationPreferenceDetailViewModel.java`

**Problemas encontrados**:
- Línea 169: businessService.findById(NotificationPreference.class
- -> Debería usar: NotificationPreferenceService
...
### NotificationPreferenceOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationPreferenceOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 250: businessService.removeFromID(NotificationPreference.class
- -> Debería usar: NotificationPreferenceService
- Línea 187: businessService.findAllView(NotificationPreferenceMetricsSummary.class
- -> Debería usar: NotificationPreferenceMetricsSummaryService

**Servicios a usar**:
- `NotificationPreferenceMetricsSummaryService`
- `NotificationPreferenceService`

---


### NotificationTemplateDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationTemplateDetailViewModel.java`

**Problemas encontrados**:
- Línea 320: businessService.findAllEntity(Notification.class
- -> Debería usar: NotificationService
- Línea 175: businessService.findById(NotificationTemplate.class
- -> Debería usar: NotificationTemplateService
...
### NotificationTemplateOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/notifications/NotificationTemplateOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 250: businessService.removeFromID(NotificationTemplate.class
- -> Debería usar: NotificationTemplateService
- Línea 187: businessService.findAllView(NotificationTemplateMetricsSummary.class
- -> Debería usar: NotificationTemplateMetricsSummaryService

**Servicios a usar**:
- `NotificationTemplateMetricsSummaryService`
- `NotificationTemplateService`
