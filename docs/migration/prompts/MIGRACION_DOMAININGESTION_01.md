# Migración de ViewModels a Servicios Dedicados - Domainingestion

## Información del Documento
- **Módulo**: Domainingestion
- **Total ViewModels**: 7
- **Documento**: 1 de 1
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/domainingestion/ConfigureApiViewModel.java`

**Problemas encontrados**:
- Línea 62: businessService.findAllEntity(Domain.class
- -> Debería usar: DomainService
- Línea 78: businessService.findAllEntity(DomainDataSource.class
- -> Debería usar: DomainDataSourceService
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/domainingestion/ConfigureDatabaseViewModel.java`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/domainingestion/ConfigureDocumentsViewModel.java`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/domainingestion/ConfigureWebScrapingViewModel.java`
...
### DomainIngestionDashboardViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/domainingestion/DomainIngestionDashboardViewModel.java`

**Problemas encontrados**:
- Línea 85: businessService.findAllEntity(
- -> Debería usar:
- Línea 121: businessService.findAllEntity(
- -> Debería usar:
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/domainingestion/DomainManagementViewModel.java`

**Problemas encontrados**:
- Línea 67: businessService.findAllEntity(Domain.class
- -> Debería usar: DomainService
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/domainingestion/JobMonitorViewModel.java`

**Problemas encontrados**:
- Línea 79: businessService.findAllEntity(Domain.class
- -> Debería usar: DomainService
- Línea 93: businessService.findAllEntity(IngestionJob.class
- -> Debería usar: IngestionJobService
- Línea 129: businessService.findAllEntity(IngestionJob.class
- -> Debería usar: IngestionJobService
