# Migración de ViewModels a Servicios Dedicados - Datasources
...
### DataSourceApiOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceApiOverviewViewModel.java`

**Problemas encontrados**:
- Línea 77: businessService.findAllEntity(
- -> Debería usar:
...
### DataSourceApiViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceApiViewModel.java`

**Problemas encontrados**:
- Línea 56: businessService.findById(DataSource.class
- -> Debería usar: DataSourceService
- Línea 152: businessService.removeFromID(DataSourceApi.class
- -> Debería usar: DataSourceApiService
...
### DataSourceDatabaseOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceDatabaseOverviewViewModel.java`

**Problemas encontrados**:
- Línea 61: businessService.findAllEntity(DataSourceDatabase.class
- -> Debería usar: DataSourceDatabaseService

**Servicios a usar**:
- `DataSourceDatabaseService`

---


### DataSourceDatabaseViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceDatabaseViewModel.java`

**Problemas encontrados**:
- Línea 90: businessService.findAllEntity(
- -> Debería usar:
...
### DataSourceDocumentOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceDocumentOverviewViewModel.java`

**Problemas encontrados**:
- Línea 61: businessService.findAllEntity(DataSourceDocument.class
- -> Debería usar: DataSourceDocumentService

**Servicios a usar**:
- `DataSourceDocumentService`

---


### DataSourceDocumentViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceDocumentViewModel.java`

**Problemas encontrados**:
- Línea 78: businessService.findAllEntity(
- -> Debería usar:
...
### DataSourceOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceOverviewViewModel.java`

**Problemas encontrados**:
- Línea 165: businessService.removeFromID(DataSource.class
- -> Debería usar: DataSourceService
...
### DataSourcesOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourcesOverviewViewModel.java`

**Problemas encontrados**:
- Línea 93: businessService.findAllEntity(
- -> Debería usar:
...
### DataSourceWebscrapingOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceWebscrapingOverviewViewModel.java`

**Problemas encontrados**:
- Línea 70: businessService.findAllEntity(DataSourceWebscraping.class
- -> Debería usar: DataSourceWebscrapingService

**Servicios a usar**:
- `DataSourceWebscrapingService`

---


### DataSourceWebscrapingViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/datasources/DataSourceWebscrapingViewModel.java`

**Problemas encontrados**:
- Línea 92: businessService.findAllEntity(
- -> Debería usar:
