# Migración de ViewModels a Servicios Dedicados - Providers

## Información del Documento
- **Módulo**: Providers
- **Total ViewModels**: 3
- **Documento**: 1 de 1
- **ViewModels en este documento**: 3
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/providers/ProvidersOverviewViewModel.java`

**Problemas encontrados**:
- Línea 162: businessService.findAllView(ProvidersOverview.class
- -> Debería usar: ProvidersOverviewService
- Línea 218: businessService.findAllView(ProvidersMetricsSummary.class
- -> Debería usar: ProvidersMetricsSummaryService

**Servicios a usar**:
- `ProvidersMetricsSummaryService`
- `ProvidersOverviewService`

---


### ProvidersMetricsSummaryOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/providers/ProvidersMetricsSummaryOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(ProvidersMetricsSummary.class
- -> Debería usar: ProvidersMetricsSummaryService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(ProvidersMetricsSummaryMetricsSummary.class
- -> Debería usar: ProvidersMetricsSummaryMetricsSummaryService

**Servicios a usar**:
- `ProvidersMetricsSummaryMetricsSummaryService`
- `ProvidersMetricsSummaryService`

---


### ProvidersOverviewOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/providers/ProvidersOverviewOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(ProvidersOverview.class
- -> Debería usar: ProvidersOverviewService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(ProvidersOverviewMetricsSummary.class
- -> Debería usar: ProvidersOverviewMetricsSummaryService

**Servicios a usar**:
- `ProvidersOverviewMetricsSummaryService`
- `ProvidersOverviewService`
