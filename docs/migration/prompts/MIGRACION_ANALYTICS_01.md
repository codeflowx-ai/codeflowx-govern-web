# Migración de ViewModels a Servicios Dedicados - Analytics

## Información del Documento
- **Módulo**: Analytics
- **Total ViewModels**: 11
- **Documento**: 1 de 1
- **ViewModels en este documento**: 11
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/analytics/AnalyticsBiasViewModel.java`

**Problemas encontrados**:
- Línea 102: businessService.findAllEntity(
- -> Debería usar:
- Línea 118: businessService.findAllEntity(
- -> Debería usar:
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/analytics/AnalyticsMetricViewModel.java`

**Problemas encontrados**:
- Línea 202: businessService.findById(AnalyticsMetric.class
- -> Debería usar: AnalyticsMetricService
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/analytics/AnalyticsOverviewViewModel.java`

**Problemas encontrados**:
- Línea 59: businessService.findAllView(AnalyticsOverview.class
- -> Debería usar: AnalyticsOverviewService
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/analytics/AnalyticsReportViewModel.java`

**Problemas encontrados**:
- Línea 186: businessService.findById(AnalyticsReport.class
- -> Debería usar: AnalyticsReportService
- Línea 231: businessService.findById(AnalyticsReport.class
- -> Debería usar: AnalyticsReportService
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/analytics/AnalyticsTrendsViewModel.java`

**Problemas encontrados**:
- Línea 70: businessService.findAllView(AnalyticsTrends.class
- -> Debería usar: AnalyticsTrendsService
...
### AnalyticsMetricDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/analytics/AnalyticsMetricDetailViewModel.java`

**Problemas encontrados**:
- Línea 176: businessService.findById(AnalyticsMetric.class
- -> Debería usar: AnalyticsMetricService
...
### AnalyticsMetricOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/analytics/AnalyticsMetricOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(AnalyticsMetric.class
- -> Debería usar: AnalyticsMetricService
- Línea 194: businessService.findAllView(AnalyticsMetricMetricsSummary.class
- -> Debería usar: AnalyticsMetricMetricsSummaryService

**Servicios a usar**:
- `AnalyticsMetricMetricsSummaryService`
- `AnalyticsMetricService`

---


### AnalyticsOverviewOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/analytics/AnalyticsOverviewOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(AnalyticsOverview.class
- -> Debería usar: AnalyticsOverviewService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(AnalyticsOverviewMetricsSummary.class
- -> Debería usar: AnalyticsOverviewMetricsSummaryService

**Servicios a usar**:
- `AnalyticsOverviewMetricsSummaryService`
- `AnalyticsOverviewService`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/analytics/AnalyticsReportDetailViewModel.java`

**Problemas encontrados**:
- Línea 176: businessService.findById(AnalyticsReport.class
- -> Debería usar: AnalyticsReportService
...
### AnalyticsReportOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/analytics/AnalyticsReportOverviewViewModel.java`

**Problemas encontrados**:
- Línea 130: businessService.findAllEntity(
- -> Debería usar:
- Línea 258: businessService.removeFromID(AnalyticsReport.class
- -> Debería usar: AnalyticsReportService
- Línea 194: businessService.findAllView(AnalyticsReportMetricsSummary.class
- -> Debería usar: AnalyticsReportMetricsSummaryService

**Servicios a usar**:
- `AnalyticsReportMetricsSummaryService`
- `AnalyticsReportService`

---


### AnalyticsTrendsOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/analytics/AnalyticsTrendsOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(AnalyticsTrends.class
- -> Debería usar: AnalyticsTrendsService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(AnalyticsTrendsMetricsSummary.class
- -> Debería usar: AnalyticsTrendsMetricsSummaryService

**Servicios a usar**:
- `AnalyticsTrendsMetricsSummaryService`
- `AnalyticsTrendsService`
