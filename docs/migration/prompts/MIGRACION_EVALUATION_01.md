# Migración de ViewModels a Servicios Dedicados - Evaluation

## Información del Documento
- **Módulo**: Evaluation
- **Total ViewModels**: 18
- **Documento**: 1 de 1
- **ViewModels en este documento**: 18
...
### BiasAnalysisDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/BiasAnalysisDetailViewModel.java`

**Problemas encontrados**:
- Línea 322: businessService.findAllEntity(BiasDetection.class
- -> Debería usar: BiasDetectionService
- Línea 348: businessService.findAllEntity(BiasRecommendation.class
- -> Debería usar: BiasRecommendationService
- Línea 374: businessService.findAllEntity(FairnessMetric.class
- -> Debería usar: FairnessMetricService
- Línea 179: businessService.findById(BiasAnalysis.class
- -> Debería usar: BiasAnalysisService

**Servicios a usar**:
- `BiasAnalysisService`
- `BiasDetectionService`
- `BiasRecommendationService`
- `FairnessMetricService`

---


### BiasAnalysisOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/BiasAnalysisOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(BiasAnalysis.class
- -> Debería usar: BiasAnalysisService
- Línea 180: businessService.findAllView(BiasAnalysisMetricsSummary.class
- -> Debería usar: BiasAnalysisMetricsSummaryService

**Servicios a usar**:
- `BiasAnalysisMetricsSummaryService`
- `BiasAnalysisService`

---


### BiasDetectionDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/BiasDetectionDetailViewModel.java`

**Problemas encontrados**:
- Línea 172: businessService.findById(BiasDetection.class
- -> Debería usar: BiasDetectionService
...
### BiasDetectionOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/BiasDetectionOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(BiasDetection.class
- -> Debería usar: BiasDetectionService
- Línea 180: businessService.findAllView(BiasDetectionMetricsSummary.class
- -> Debería usar: BiasDetectionMetricsSummaryService

**Servicios a usar**:
- `BiasDetectionMetricsSummaryService`
- `BiasDetectionService`

---


### BiasRecommendationDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/BiasRecommendationDetailViewModel.java`

**Problemas encontrados**:
- Línea 172: businessService.findById(BiasRecommendation.class
- -> Debería usar: BiasRecommendationService
...
### BiasRecommendationOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/BiasRecommendationOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(BiasRecommendation.class
- -> Debería usar: BiasRecommendationService
- Línea 180: businessService.findAllView(BiasRecommendationMetricsSummary.class
- -> Debería usar: BiasRecommendationMetricsSummaryService

**Servicios a usar**:
- `BiasRecommendationMetricsSummaryService`
- `BiasRecommendationService`

---


### EvaluationMetricDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/EvaluationMetricDetailViewModel.java`

**Problemas encontrados**:
- Línea 171: businessService.findById(EvaluationMetric.class
- -> Debería usar: EvaluationMetricService
...
### EvaluationMetricOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/EvaluationMetricOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(EvaluationMetric.class
- -> Debería usar: EvaluationMetricService
- Línea 180: businessService.findAllView(EvaluationMetricMetricsSummary.class
- -> Debería usar: EvaluationMetricMetricsSummaryService

**Servicios a usar**:
- `EvaluationMetricMetricsSummaryService`
- `EvaluationMetricService`

---


### EvaluationMetricsOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/EvaluationMetricsOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(EvaluationMetrics.class
- -> Debería usar: EvaluationMetricsService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(EvaluationMetricsMetricsSummary.class
- -> Debería usar: EvaluationMetricsMetricsSummaryService

**Servicios a usar**:
- `EvaluationMetricsMetricsSummaryService`
- `EvaluationMetricsService`

---


### EvaluationSummaryOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/EvaluationSummaryOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(EvaluationSummary.class
- -> Debería usar: EvaluationSummaryService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(EvaluationSummaryMetricsSummary.class
- -> Debería usar: EvaluationSummaryMetricsSummaryService

**Servicios a usar**:
- `EvaluationSummaryMetricsSummaryService`
- `EvaluationSummaryService`

---


### FairnessMetricDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/FairnessMetricDetailViewModel.java`

**Problemas encontrados**:
- Línea 171: businessService.findById(FairnessMetric.class
- -> Debería usar: FairnessMetricService
...
### FairnessMetricOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/FairnessMetricOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(FairnessMetric.class
- -> Debería usar: FairnessMetricService
- Línea 180: businessService.findAllView(FairnessMetricMetricsSummary.class
- -> Debería usar: FairnessMetricMetricsSummaryService

**Servicios a usar**:
- `FairnessMetricMetricsSummaryService`
- `FairnessMetricService`

---


### ModelBiasAnalysisDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/ModelBiasAnalysisDetailViewModel.java`

**Problemas encontrados**:
- Línea 172: businessService.findById(ModelBiasAnalysis.class
...
### ModelBiasAnalysisOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/ModelBiasAnalysisOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(ModelBiasAnalysis.class
- -> Debería usar: ModelBiasAnalysisService
- Línea 180: businessService.findAllView(ModelBiasAnalysisMetricsSummary.class
- -> Debería usar: ModelBiasAnalysisMetricsSummaryService

**Servicios a usar**:
- `ModelBiasAnalysisMetricsSummaryService`
- `ModelBiasAnalysisService`

---


### ModelEvaluationDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/ModelEvaluationDetailViewModel.java`

**Problemas encontrados**:
- Línea 344: businessService.findAllEntity(EvaluationMetric.class
- -> Debería usar: EvaluationMetricService
- Línea 178: businessService.findById(ModelEvaluation.class
- -> Debería usar: ModelEvaluationService
...
### ModelEvaluationOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/ModelEvaluationOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(ModelEvaluation.class
- -> Debería usar: ModelEvaluationService
- Línea 180: businessService.findAllView(ModelEvaluationMetricsSummary.class
- -> Debería usar: ModelEvaluationMetricsSummaryService

**Servicios a usar**:
- `ModelEvaluationMetricsSummaryService`
- `ModelEvaluationService`

---


### ModelPerformanceDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/ModelPerformanceDetailViewModel.java`

**Problemas encontrados**:
- Línea 171: businessService.findById(ModelPerformance.class
- -> Debería usar: ModelPerformanceService
...
### ModelPerformanceOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/evaluation/ModelPerformanceOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(ModelPerformance.class
- -> Debería usar: ModelPerformanceService
- Línea 180: businessService.findAllView(ModelPerformanceMetricsSummary.class
- -> Debería usar: ModelPerformanceMetricsSummaryService

**Servicios a usar**:
- `ModelPerformanceMetricsSummaryService`
- `ModelPerformanceService`
