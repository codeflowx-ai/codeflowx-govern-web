# Migración de ViewModels a Servicios Dedicados - Playground

## Información del Documento
- **Módulo**: Playground
- **Total ViewModels**: 7
- **Documento**: 1 de 1
- **ViewModels en este documento**: 7
...
### PlaygroundChatViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/playground/PlaygroundChatViewModel.java`

**Problemas encontrados**:
- Línea 95: businessService.findById(PlaygroundSession.class
- -> Debería usar: PlaygroundSessionService
...
### PlaygroundImageViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/playground/PlaygroundImageViewModel.java`

**Problemas encontrados**:
- Línea 147: businessService.removeFromID(PlaygroundImage.class
- -> Debería usar: PlaygroundImageService

**Servicios a usar**:
- `PlaygroundImageService`

---


### PlaygroundOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/playground/PlaygroundOverviewViewModel.java`

**Problemas encontrados**:
- Línea 159: businessService.removeFromID(PlaygroundSession.class
- -> Debería usar: PlaygroundSessionService
...
### PlaygroundRoutingViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/playground/PlaygroundRoutingViewModel.java`

**Problemas encontrados**:
- Línea 194: businessService.removeFromID(PlaygroundRouting.class
- -> Debería usar: PlaygroundRoutingService

**Servicios a usar**:
- `PlaygroundRoutingService`

---


### PlaygroundSessionsViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/playground/PlaygroundSessionsViewModel.java`

**Problemas encontrados**:
- Línea 60: businessService.findAllEntity(PlaygroundSession.class
- -> Debería usar: PlaygroundSessionService
...
### PlaygroundTranslationViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/playground/PlaygroundTranslationViewModel.java`

**Problemas encontrados**:
- Línea 184: businessService.removeFromID(PlaygroundTranslation.class
- -> Debería usar: PlaygroundTranslationService

**Servicios a usar**:
- `PlaygroundTranslationService`

---


### PlaygroundVoiceViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/playground/PlaygroundVoiceViewModel.java`

**Problemas encontrados**:
- Línea 215: businessService.removeFromID(PlaygroundVoice.class
- -> Debería usar: PlaygroundVoiceService

**Servicios a usar**:
- `PlaygroundVoiceService`
