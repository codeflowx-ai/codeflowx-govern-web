# Migración de ViewModels a Servicios Dedicados - Artefacto

## Información del Documento
- **Módulo**: Artefacto
- **Total ViewModels**: 6
- **Documento**: 1 de 1
- **ViewModels en este documento**: 6
...
### ArtifactDependencyDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/artefacto/ArtifactDependencyDetailViewModel.java`

**Problemas encontrados**:
- Línea 170: businessService.findById(ArtifactDependency.class
- -> Debería usar: ArtifactDependencyService
...
### ArtifactDependencyOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/artefacto/ArtifactDependencyOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 250: businessService.removeFromID(ArtifactDependency.class
- -> Debería usar: ArtifactDependencyService
- Línea 187: businessService.findAllView(ArtifactDependencyMetricsSummary.class
- -> Debería usar: ArtifactDependencyMetricsSummaryService

**Servicios a usar**:
- `ArtifactDependencyMetricsSummaryService`
- `ArtifactDependencyService`

---


### ArtifactVersionDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/artefacto/ArtifactVersionDetailViewModel.java`

**Problemas encontrados**:
- Línea 168: businessService.findById(ArtifactVersion.class
- -> Debería usar: ArtifactVersionService
...
### ArtifactVersionOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/artefacto/ArtifactVersionOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 250: businessService.removeFromID(ArtifactVersion.class
- -> Debería usar: ArtifactVersionService
- Línea 187: businessService.findAllView(ArtifactVersionMetricsSummary.class
- -> Debería usar: ArtifactVersionMetricsSummaryService

**Servicios a usar**:
- `ArtifactVersionMetricsSummaryService`
- `ArtifactVersionService`

---


### BaseArtifactDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/artefacto/BaseArtifactDetailViewModel.java`

**Problemas encontrados**:
- Línea 317: businessService.findAllEntity(ArtifactDependency.class
- -> Debería usar: ArtifactDependencyService
- Línea 343: businessService.findAllEntity(ArtifactDependency.class
- -> Debería usar: ArtifactDependencyService
- Línea 369: businessService.findAllEntity(ArtifactVersion.class
- -> Debería usar: ArtifactVersionService
- Línea 179: businessService.findById(BaseArtifact.class
- -> Debería usar: BaseArtifactService
...
### BaseArtifactOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/artefacto/BaseArtifactOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 250: businessService.removeFromID(BaseArtifact.class
- -> Debería usar: BaseArtifactService
- Línea 187: businessService.findAllView(BaseArtifactMetricsSummary.class
- -> Debería usar: BaseArtifactMetricsSummaryService

**Servicios a usar**:
- `BaseArtifactMetricsSummaryService`
- `BaseArtifactService`
