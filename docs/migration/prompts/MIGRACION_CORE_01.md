# Migración de ViewModels a Servicios Dedicados - Core
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/core/AdminDashboardViewModel.java`

**Problemas encontrados**:
- Línea 83: businessService.findAllView(AdminDashboardSummary.class
- -> Debería usar: AdminDashboardSummaryService
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/core/MenuViewModel.java`

**Problemas encontrados**:
- Línea 141: businessService.findById(Menu.class
- -> Debería usar: MenuService
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/core/SecurityAuditViewModel.java`

**Problemas encontrados**:
- Línea 81: businessService.findAllView(SecurityAuditSummary.class
- -> Debería usar: SecurityAuditSummaryService
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/core/SystemHealthViewModel.java`

**Problemas encontrados**:
- Línea 81: businessService.findAllView(SystemHealthOverview.class
- -> Debería usar: SystemHealthOverviewService
...
**Archivo**: `src/main/java/com/codeflowx/govern/viewmodel/core/UserActivityViewModel.java`

**Problemas encontrados**:
- Línea 82: businessService.findAllView(UserActivitySummary.class
- -> Debería usar: UserActivitySummaryService
...
### AdminDashboardSummaryOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/AdminDashboardSummaryOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(AdminDashboardSummary.class
- -> Debería usar: AdminDashboardSummaryService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(AdminDashboardSummaryMetricsSummary.class
- -> Debería usar: AdminDashboardSummaryMetricsSummaryService

**Servicios a usar**:
- `AdminDashboardSummaryMetricsSummaryService`
- `AdminDashboardSummaryService`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/DepartmentDetailViewModel.java`

**Problemas encontrados**:
- Línea 301: businessService.findAllEntity(User.class
- -> Debería usar: UserService
- Línea 173: businessService.findById(Department.class
- -> Debería usar: DepartmentService
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/DepartmentOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(Department.class
- -> Debería usar: DepartmentService
- Línea 180: businessService.findAllView(DepartmentMetricsSummary.class
- -> Debería usar: DepartmentMetricsSummaryService

**Servicios a usar**:
- `DepartmentMetricsSummaryService`
- `DepartmentService`

---


### LoginAttemptDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/LoginAttemptDetailViewModel.java`

**Problemas encontrados**:
- Línea 169: businessService.findById(LoginAttempt.class
- -> Debería usar: LoginAttemptService
...
### LoginAttemptOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/LoginAttemptOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(LoginAttempt.class
- -> Debería usar: LoginAttemptService
- Línea 180: businessService.findAllView(LoginAttemptMetricsSummary.class
- -> Debería usar: LoginAttemptMetricsSummaryService

**Servicios a usar**:
- `LoginAttemptMetricsSummaryService`
- `LoginAttemptService`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/MenuDetailViewModel.java`

**Problemas encontrados**:
- Línea 170: businessService.findById(Menu.class
- -> Debería usar: MenuService
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/MenuOverviewViewModel.java`

**Problemas encontrados**:
- Línea 129: businessService.findAllEntity(
- -> Debería usar:
- Línea 243: businessService.removeFromID(Menu.class
- -> Debería usar: MenuService
- Línea 181: businessService.findAllView(MenuMetricsSummary.class
- -> Debería usar: MenuMetricsSummaryService

**Servicios a usar**:
- `MenuMetricsSummaryService`
- `MenuService`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/PermissionDetailViewModel.java`

**Problemas encontrados**:
- Línea 169: businessService.findById(Permission.class
- -> Debería usar: PermissionService
...
### PermissionOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/PermissionOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(Permission.class
- -> Debería usar: PermissionService
- Línea 180: businessService.findAllView(PermissionMetricsSummary.class
- -> Debería usar: PermissionMetricsSummaryService

**Servicios a usar**:
- `PermissionMetricsSummaryService`
- `PermissionService`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/RoleDetailViewModel.java`

**Problemas encontrados**:
- Línea 169: businessService.findById(Role.class
- -> Debería usar: RoleService
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/RoleOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(Role.class
- -> Debería usar: RoleService
- Línea 180: businessService.findAllView(RoleMetricsSummary.class
- -> Debería usar: RoleMetricsSummaryService

**Servicios a usar**:
- `RoleMetricsSummaryService`
- `RoleService`

---


### SecurityAuditSummaryOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/SecurityAuditSummaryOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(SecurityAuditSummary.class
- -> Debería usar: SecurityAuditSummaryService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(SecurityAuditSummaryMetricsSummary.class
- -> Debería usar: SecurityAuditSummaryMetricsSummaryService

**Servicios a usar**:
- `SecurityAuditSummaryMetricsSummaryService`
- `SecurityAuditSummaryService`

---


### SystemHealthOverviewOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/SystemHealthOverviewOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(SystemHealthOverview.class
- -> Debería usar: SystemHealthOverviewService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(SystemHealthOverviewMetricsSummary.class
- -> Debería usar: SystemHealthOverviewMetricsSummaryService

**Servicios a usar**:
- `SystemHealthOverviewMetricsSummaryService`
- `SystemHealthOverviewService`

---


### UserActivitySummaryOverviewViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/UserActivitySummaryOverviewViewModel.java`

**Problemas encontrados**:
- Línea 241: businessService.removeFromID(UserActivitySummary.class
- -> Debería usar: UserActivitySummaryService
- Línea 127: businessService.findAllView(
- -> Debería usar:
- Línea 179: businessService.findAllView(UserActivitySummaryMetricsSummary.class
- -> Debería usar: UserActivitySummaryMetricsSummaryService

**Servicios a usar**:
- `UserActivitySummaryMetricsSummaryService`
- `UserActivitySummaryService`
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/UserDetailViewModel.java`

**Problemas encontrados**:
- Línea 311: businessService.findAllEntity(AuditLog.class
- -> Debería usar: AuditLogService
- Línea 337: businessService.findAllEntity(UserSession.class
- -> Debería usar: UserSessionService
- Línea 363: businessService.findAllEntity(UpdateSchedule.class
- -> Debería usar: UpdateScheduleService
- Línea 181: businessService.findById(User.class
- -> Debería usar: UserService
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/UserOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(User.class
- -> Debería usar: UserService
- Línea 180: businessService.findAllView(UserMetricsSummary.class
- -> Debería usar: UserMetricsSummaryService

**Servicios a usar**:
- `UserMetricsSummaryService`
- `UserService`

---


### UserSessionDetailViewModel

**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/UserSessionDetailViewModel.java`

**Problemas encontrados**:
- Línea 168: businessService.findById(UserSession.class
- -> Debería usar: UserSessionService
...
**Archivo**: `src/main/java/com/codeflowx/platform/viewmodel/core/UserSessionOverviewViewModel.java`

**Problemas encontrados**:
- Línea 128: businessService.findAllEntity(
- -> Debería usar:
- Línea 242: businessService.removeFromID(UserSession.class
- -> Debería usar: UserSessionService
- Línea 180: businessService.findAllView(UserSessionMetricsSummary.class
- -> Debería usar: UserSessionMetricsSummaryService

**Servicios a usar**:
- `UserSessionMetricsSummaryService`
- `UserSessionService`
