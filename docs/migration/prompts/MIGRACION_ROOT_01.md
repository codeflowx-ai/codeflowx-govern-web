# Migración de ViewModels a Servicios Dedicados - Root

## Información del Documento
- **Módulo**: Root
- **Total ViewModels**: 2
- **Documento**: 1 de 1
- **ViewModels en este documento**: 2
...
**Archivo**: `src/main/java/com/codeflowx/govern/workflow/viewmodels/LlmEvaluationReviewViewModel.java`

**Problemas encontrados**:
- Línea 175: businessService.findById(LlmEvaluation.class
- -> Debería usar: LlmEvaluationService
...
**Archivo**: `src/main/java/com/codeflowx/govern/workflow/viewmodels/PromptHumanReviewViewModel.java`

**Problemas encontrados**:
- Línea 170: businessService.findById(Prompt.class
- -> Debería usar: PromptService
- Línea 173: businessService.findById(PromptApproval.class
- -> Debería usar: PromptApprovalService
