# 🤖 PROMPT PARA AGENTE - Guía de Gestión de Incidentes
...
### **Objetivo Principal**
Implementar flujo completo de gestión de incidentes
...
### **Tareas Principales**
1. Crear módulo específico de gestión de incidentes
2. Implementar workflow completo: reporte, investigación, resolución
3. Validar notificación a autoridades según severidad
4. Integrar con PMM para detección automática
5. Crear dashboard de incidentes
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/14-guia-gestion-de-incidentes.txt` para identificar:
...
2. **Cobertura Actual:** 75% - Buena cobertura, identificar mejoras
