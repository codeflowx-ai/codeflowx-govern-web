# 🤖 PROMPT PARA AGENTE - Guía de Documentación Técnica
...
### **Objetivo Principal**
Implementar documentación técnica completa según Art. 11 y Anexo IV
...
### **Tareas Principales**
1. Revisar módulo de documentación técnica completo
2. Validar cumplimiento de Anexo IV
3. Verificar que toda la documentación requerida esté disponible
4. Implementar generación automática de documentación
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/15-guia-documentacion-tecnica.txt` para identificar:
