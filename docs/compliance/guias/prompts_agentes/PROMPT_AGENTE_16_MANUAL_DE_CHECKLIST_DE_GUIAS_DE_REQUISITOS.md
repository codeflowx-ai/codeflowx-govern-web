# 🤖 PROMPT PARA AGENTE - Manual de Checklist de Guías de Requisitos
...
### **Objetivo Principal**
Crear checklist completo de verificación de requisitos
...
### **Tareas Principales**
1. Implementar checklist interactivo de requisitos
2. Validar que cubra todos los requisitos del Reglamento
3. Integrar con Conformity Assessment y QMS
4. Crear reporte de cumplimiento automático
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/16-manual-de-checklist-de-guias-de-requisitos.txt` para identificar:
...
1. **Prioridad:** Esta guía tiene prioridad **Media** según el análisis de cumplimiento
2. **Cobertura Actual:** 70% - Buena cobertura, identificar mejoras
3. **Enfoque:** Identificar gaps y proponer mejoras específicas
