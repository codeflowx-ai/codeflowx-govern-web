# 🤖 PROMPT PARA AGENTE - Guía de Vigilancia Poscomercialización
...
### **Objetivo Principal**
Implementar monitoreo post-mercado completo según Art. 20 y 72
...
### **Tareas Principales**
1. Revisar módulo PMM completo
2. Validar detección de anomalías y drift
3. Verificar notificación a autoridades según Art. 20
4. Implementar métricas continuas de monitoreo
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/13-guia-vigilancia-poscomercializacion.txt` para identificar:
...
2. **Cobertura Actual:** 85% - Excelente cobertura, validar y optimizar
