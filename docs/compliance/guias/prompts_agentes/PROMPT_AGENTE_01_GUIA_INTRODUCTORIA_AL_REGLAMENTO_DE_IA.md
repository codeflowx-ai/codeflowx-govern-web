# 🤖 PROMPT PARA AGENTE - Guía Introductoria al Reglamento de IA
...
### **Objetivo Principal**
Comprender los conceptos fundamentales del Reglamento de IA y su aplicación
...
### **Tareas Principales**
1. Revisar implementación de clasificación de sistemas de IA
2. Verificar cobertura de sistemas prohibidos
3. Validar que la documentación introductoria esté disponible para usuarios
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/01-guia-introductoria-al-reglamento-de-ia.txt` para identificar:
...
2. **Cobertura Actual:** 40% - Cobertura limitada, requiere trabajo significativo
3. **Enfoque:** Diseñar e implementar funcionalidades faltantes
