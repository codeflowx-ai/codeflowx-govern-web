# 🤖 PROMPT PARA AGENTE - Guía de Vigilancia Humana
...
### **Objetivo Principal**
Implementar supervisión humana efectiva según Art. 14
...
### **Tareas Principales**
1. Revisar módulo HITL y su funcionalidad completa
2. Validar que se cubran todos los requisitos del Art. 14
3. Verificar integración con otros módulos de compliance
4. Implementar métricas de supervisión humana
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/06-guia-vigilancia-humana.txt` para identificar:
...
2. **Cobertura Actual:** 80% - Excelente cobertura, validar y optimizar
