# 🤖 PROMPT PARA AGENTE - Guía de Gestión de Riesgos
...
### **Objetivo Principal**
Implementar gestión de riesgos completa según Art. 9 y Art. 27
...
### **Tareas Principales**
1. Revisar módulo FRIA y su integración con gestión de riesgos
2. Validar que QMS incluya gestión de riesgos
3. Verificar cálculo de riesgos y medidas de mitigación
4. Implementar seguimiento de riesgos residuales
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/05-guia-de-gestion-de-riesgos.txt` para identificar:
