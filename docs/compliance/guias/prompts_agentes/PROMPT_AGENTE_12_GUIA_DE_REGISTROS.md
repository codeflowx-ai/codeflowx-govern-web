# 🤖 PROMPT PARA AGENTE - Guía de Registros
...
### **Objetivo Principal**
Implementar registro en base de datos EU según Art. 49
...
### **Tareas Principales**
1. Revisar módulo EU Registration completo
2. Validar integración con trazabilidad y logs
3. Verificar cumplimiento de Anexo VIII
4. Implementar sincronización con base de datos EU
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/12-guia-de-registros.txt` para identificar:
