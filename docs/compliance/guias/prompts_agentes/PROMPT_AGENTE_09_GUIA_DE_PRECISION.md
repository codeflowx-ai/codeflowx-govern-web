# 🤖 PROMPT PARA AGENTE - Guía de Precisión
...
### **Objetivo Principal**
Implementar métricas y validaciones de precisión
...
### **Tareas Principales**
1. Ampliar PMM con métricas específicas de precisión
2. Implementar validaciones de precisión en documentación técnica
3. Crear dashboard de métricas de precisión
4. Validar seguimiento continuo de precisión
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/09-guia-de-precision.txt` para identificar:
...
2. **Cobertura Actual:** 60% - Buena cobertura, identificar mejoras
