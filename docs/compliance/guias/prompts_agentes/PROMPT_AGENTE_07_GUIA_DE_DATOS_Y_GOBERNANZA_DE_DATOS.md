# 🤖 PROMPT PARA AGENTE - Guía de Datos y Gobernanza de Datos
...
### **Objetivo Principal**
Implementar gobernanza de datos según Art. 10
...
### **Tareas Principales**
1. Revisar módulos de trazabilidad y logs inmutables
2. Validar gestión de calidad de datos de entrenamiento
3. Implementar módulo específico de gobernanza de datos si es necesario
4. Verificar cumplimiento de requisitos de datos según Art. 10
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/07-guia-de-datos-y-gobernanza-de-datos.txt` para identificar:
