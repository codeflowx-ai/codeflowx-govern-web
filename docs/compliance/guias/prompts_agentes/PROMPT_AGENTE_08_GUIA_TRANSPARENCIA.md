# 🤖 PROMPT PARA AGENTE - Guía de Transparencia
...
### **Objetivo Principal**
Implementar requisitos de transparencia según Art. 13
...
### **Tareas Principales**
1. Ampliar módulo de documentación técnica con sección de transparencia
2. Implementar información para usuarios según Art. 13
3. Validar que la documentación sea clara y accesible
4. Revisar integración con trazabilidad
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/08-guia-transparencia.txt` para identificar:
...
2. **Cobertura Actual:** 65% - Buena cobertura, identificar mejoras
