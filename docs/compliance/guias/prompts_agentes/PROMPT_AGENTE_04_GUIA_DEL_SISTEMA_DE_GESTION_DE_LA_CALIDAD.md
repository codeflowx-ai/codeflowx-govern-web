# 🤖 PROMPT PARA AGENTE - Guía del Sistema de Gestión de la Calidad
...
### **Objetivo Principal**
Implementar sistema de gestión de calidad completo según Art. 17
...
### **Tareas Principales**
1. Validar que los 13 módulos QMS estén implementados
2. Verificar cálculo de scores de compliance
3. Revisar detección de gaps
4. Validar integración con otros módulos
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/04-guia-del-sistema-de-gestion-de-la-calidad.txt` para identificar:
...
1. **Prioridad:** Esta guía tiene prioridad **Alta** según el análisis de cumplimiento
2. **Cobertura Actual:** 90% - Excelente cobertura, validar y optimizar
3. **Enfoque:** Validar y optimizar implementación existente
