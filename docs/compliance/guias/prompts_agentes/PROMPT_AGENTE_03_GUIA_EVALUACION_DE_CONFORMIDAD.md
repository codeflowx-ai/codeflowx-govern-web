# 🤖 PROMPT PARA AGENTE - Guía de Evaluación de Conformidad
...
### **Objetivo Principal**
Implementar el proceso completo de evaluación de conformidad según Art. 43
...
### **Tareas Principales**
1. Revisar y completar módulo de Conformity Assessment
2. Validar integración con QMS y Technical Docs
3. Verificar cumplimiento de Anexos VI y VII
4. Implementar declaración UE de conformidad
...
El agente debe revisar el texto completo de la guía en `textos_extraidos/03-guia-evaluacion-de-conformidad.txt` para identificar:
