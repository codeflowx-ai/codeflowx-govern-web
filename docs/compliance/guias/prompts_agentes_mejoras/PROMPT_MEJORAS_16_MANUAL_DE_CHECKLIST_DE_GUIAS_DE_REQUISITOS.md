# 🔧 PROMPT PARA AGENTE - MEJORAS: Manual de Checklist de Guías de Requisitos

**Guía:** Manual de Checklist de Guías de Requisitos
**Archivo Guía:** `16-manual-de-checklist-de-guias-de-requisitos.pdf`
**Texto Extraído:** `textos_extraidos/16-manual-de-checklist-de-guias-de-requisitos.txt`
**Fecha:** Diciembre 2025
**Prioridad de Mejoras:** Baja
**Cobertura Actual:** 90% (🟢 Excelente)
...
### **Estado Actual**
La plataforma tiene una cobertura del **90%** para esta guía según los documentos de auditoría real.

### **Artículos del Reglamento Relacionados**
- Múltiples (checklist general)
...
Esta guía está bien implementada, se requiere validación y optimización.
...
1. **Implementar checklist interactivo completo**
2. **Validar que cubra todos los requisitos del Reglamento**
3. **Mejorar reporte de cumplimiento automático**
...
- **PDF Original:** `docs/compliance/guias/16-manual-de-checklist-de-guias-de-requisitos.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/16-manual-de-checklist-de-guias-de-requisitos.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/16-manual-de-checklist-de-guias-de-requisitos.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Implementar checklist interactivo completo
...
- [ ] **Mejora 2:** Validar que cubra todos los requisitos del Reglamento
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Mejorar reporte de cumplimiento automático
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/16-manual-de-checklist-de-guias-de-requisitos.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/16-manual-de-checklist-de-guias-de-requisitos.txt`
...
2. **Cobertura Actual:** 90% - Bien implementada, optimización necesaria
3. **Objetivo:** Alcanzar **90%+ de cobertura** mediante las mejoras identificadas
4. **Enfoque:** Validar y optimizar implementación existente
