# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía del Sistema de Gestión de la Calidad

**Guía:** Guía del Sistema de Gestión de la Calidad
**Archivo Guía:** `04-guia-del-sistema-de-gestion-de-la-calidad.pdf`
**Texto Extraído:** `textos_extraidos/04-guia-del-sistema-de-gestion-de-la-calidad.txt`
**Fecha:** Diciembre 2025
**Prioridad de Mejoras:** Baja
**Cobertura Actual:** 95% (🟢 Excelente)
...
### **Estado Actual**
La plataforma tiene una cobertura del **95%** para esta guía según los documentos de auditoría real.
...
1. **Validar que los 13 módulos QMS estén al 100%**
2. **Completar documentación de procesos QMS**
3. **Mejorar métricas de seguimiento**
...
- **PDF Original:** `docs/compliance/guias/04-guia-del-sistema-de-gestion-de-la-calidad.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/04-guia-del-sistema-de-gestion-de-la-calidad.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/04-guia-del-sistema-de-gestion-de-la-calidad.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Validar que los 13 módulos QMS estén al 100%
...
- [ ] **Mejora 2:** Completar documentación de procesos QMS
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Mejorar métricas de seguimiento
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/04-guia-del-sistema-de-gestion-de-la-calidad.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/04-guia-del-sistema-de-gestion-de-la-calidad.txt`
...
2. **Cobertura Actual:** 95% - Bien implementada, optimización necesaria
