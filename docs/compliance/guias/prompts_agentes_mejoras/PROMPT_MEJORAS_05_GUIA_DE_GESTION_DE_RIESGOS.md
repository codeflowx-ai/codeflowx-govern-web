# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Gestión de Riesgos

**Guía:** Guía de Gestión de Riesgos
**Archivo Guía:** `05-guia-de-gestion-de-riesgos.pdf`
**Texto Extraído:** `textos_extraidos/05-guia-de-gestion-de-riesgos.txt`
...
1. **Completar integración FRIA al 100%**
2. **Mejorar seguimiento de riesgos residuales**
3. **Ampliar métricas de mitigación**
...
- **PDF Original:** `docs/compliance/guias/05-guia-de-gestion-de-riesgos.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/05-guia-de-gestion-de-riesgos.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/05-guia-de-gestion-de-riesgos.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Completar integración FRIA al 100%
...
- [ ] **Mejora 2:** Mejorar seguimiento de riesgos residuales
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Ampliar métricas de mitigación
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/05-guia-de-gestion-de-riesgos.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/05-guia-de-gestion-de-riesgos.txt`
