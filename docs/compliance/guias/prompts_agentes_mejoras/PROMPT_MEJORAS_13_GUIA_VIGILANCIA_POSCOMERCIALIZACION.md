# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Vigilancia Poscomercialización

**Guía:** Guía de Vigilancia Poscomercialización
**Archivo Guía:** `13-guia-vigilancia-poscomercializacion.pdf`
**Texto Extraído:** `textos_extraidos/13-guia-vigilancia-poscomercializacion.txt`
**Fecha:** Diciembre 2025
**Prioridad de Mejoras:** Media
**Cobertura Actual:** 85% (🟢 Excelente)
...
### **Estado Actual**
La plataforma tiene una cobertura del **85%** para esta guía según los documentos de auditoría real.
...
1. **Formalizar documentación completa de PMM**
2. **Completar integración con todos los microservicios**
3. **Mejorar generación automática de informes**
...
- **PDF Original:** `docs/compliance/guias/13-guia-vigilancia-poscomercializacion.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/13-guia-vigilancia-poscomercializacion.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/13-guia-vigilancia-poscomercializacion.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Formalizar documentación completa de PMM
...
- [ ] **Mejora 2:** Completar integración con todos los microservicios
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Mejorar generación automática de informes
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/13-guia-vigilancia-poscomercializacion.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/13-guia-vigilancia-poscomercializacion.txt`
...
2. **Cobertura Actual:** 85% - Requiere mejoras significativas
