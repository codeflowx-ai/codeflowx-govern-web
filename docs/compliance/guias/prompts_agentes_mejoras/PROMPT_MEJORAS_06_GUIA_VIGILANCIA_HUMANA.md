# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Vigilancia Humana

**Guía:** Guía de Vigilancia Humana
**Archivo Guía:** `06-guia-vigilancia-humana.pdf`
**Texto Extraído:** `textos_extraidos/06-guia-vigilancia-humana.txt`
**Fecha:** Diciembre 2025
**Prioridad de Mejoras:** Baja
**Cobertura Actual:** 100% (🟢 Excelente)
...
### **Estado Actual**
La plataforma tiene una cobertura del **100%** para esta guía según los documentos de auditoría real.
...
1. **Validar que todos los workflows BPMN tengan HITL**
2. **Mejorar métricas de supervisión humana**
3. **Documentar casos de uso de HITL**
...
- **PDF Original:** `docs/compliance/guias/06-guia-vigilancia-humana.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/06-guia-vigilancia-humana.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/06-guia-vigilancia-humana.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Validar que todos los workflows BPMN tengan HITL
...
- [ ] **Mejora 2:** Mejorar métricas de supervisión humana
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Documentar casos de uso de HITL
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/06-guia-vigilancia-humana.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/06-guia-vigilancia-humana.txt`
...
2. **Cobertura Actual:** 100% - Bien implementada, optimización necesaria
