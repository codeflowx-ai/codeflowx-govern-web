# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía Práctica y Ejemplos para Entender el Reglamento de IA

**Guía:** Guía Práctica y Ejemplos para Entender el Reglamento de IA
**Archivo Guía:** `02-guia-practica-y-ejemplos-para-entender-el-reglamento-de-ia.pdf`
**Texto Extraído:** `textos_extraidos/02-guia-practica-y-ejemplos-para-entender-el-reglamento-de-ia.txt`
**Fecha:** Diciembre 2025
**Prioridad de Mejoras:** Baja
**Cobertura Actual:** 50% (🟠 Regular)
...
### **Estado Actual**
La plataforma tiene una cobertura del **50%** para esta guía según los documentos de auditoría real.
...
### **Objetivo de Mejora**
🚨 **MEJORAS PRIORITARIAS REQUERIDAS**

Esta guía requiere mejoras significativas para alcanzar el objetivo de 90%+ de cobertura.
...
1. **Crear más casos de uso prácticos**
2. **Ampliar ejemplos por sector**
3. **Mejorar documentación de ejemplos**
...
- **PDF Original:** `docs/compliance/guias/02-guia-practica-y-ejemplos-para-entender-el-reglamento-de-ia.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/02-guia-practica-y-ejemplos-para-entender-el-reglamento-de-ia.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/02-guia-practica-y-ejemplos-para-entender-el-reglamento-de-ia.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Crear más casos de uso prácticos
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
  - [ ] Documentar cambios

- [ ] **Mejora 2:** Ampliar ejemplos por sector
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Mejorar documentación de ejemplos
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/02-guia-practica-y-ejemplos-para-entender-el-reglamento-de-ia.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/02-guia-practica-y-ejemplos-para-entender-el-reglamento-de-ia.txt`
...
1. **Prioridad:** Esta guía tiene prioridad de mejoras **Baja**
2. **Cobertura Actual:** 50% - Requiere mejoras significativas
3. **Objetivo:** Alcanzar **90%+ de cobertura** mediante las mejoras identificadas
4. **Enfoque:** Implementar mejoras prioritarias para cumplimiento completo
