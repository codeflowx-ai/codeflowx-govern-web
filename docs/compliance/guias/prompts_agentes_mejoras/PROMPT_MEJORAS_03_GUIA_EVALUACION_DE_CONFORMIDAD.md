# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Evaluación de Conformidad

**Guía:** Guía de Evaluación de Conformidad
**Archivo Guía:** `03-guia-evaluacion-de-conformidad.pdf`
**Texto Extraído:** `textos_extraidos/03-guia-evaluacion-de-conformidad.txt`
...
1. **Completar integración con declaración UE de conformidad**
2. **Validar cumplimiento completo de Anexos VI y VII**
3. **Mejorar reportes de evaluación**
...
- **PDF Original:** `docs/compliance/guias/03-guia-evaluacion-de-conformidad.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/03-guia-evaluacion-de-conformidad.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/03-guia-evaluacion-de-conformidad.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Completar integración con declaración UE de conformidad
...
- [ ] **Mejora 2:** Validar cumplimiento completo de Anexos VI y VII
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Mejorar reportes de evaluación
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/03-guia-evaluacion-de-conformidad.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/03-guia-evaluacion-de-conformidad.txt`
