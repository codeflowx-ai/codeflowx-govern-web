# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Datos y Gobernanza de Datos

**Guía:** Guía de Datos y Gobernanza de Datos
**Archivo Guía:** `07-guia-de-datos-y-gobernanza-de-datos.pdf`
**Texto Extraído:** `textos_extraidos/07-guia-de-datos-y-gobernanza-de-datos.txt`
**Fecha:** Diciembre 2025
**Prioridad de Mejoras:** Media
...
1. **Completar módulo específico de gobernanza de datos (Art. 10)**
2. **Mejorar gestión de calidad de datos de entrenamiento**
3. **Ampliar validaciones de datasets**
...
- **PDF Original:** `docs/compliance/guias/07-guia-de-datos-y-gobernanza-de-datos.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/07-guia-de-datos-y-gobernanza-de-datos.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/07-guia-de-datos-y-gobernanza-de-datos.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Completar módulo específico de gobernanza de datos (Art. 10)
...
- [ ] **Mejora 2:** Mejorar gestión de calidad de datos de entrenamiento
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Ampliar validaciones de datasets
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/07-guia-de-datos-y-gobernanza-de-datos.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/07-guia-de-datos-y-gobernanza-de-datos.txt`
...
1. **Prioridad:** Esta guía tiene prioridad de mejoras **Media**
2. **Cobertura Actual:** 90% - Requiere mejoras significativas
