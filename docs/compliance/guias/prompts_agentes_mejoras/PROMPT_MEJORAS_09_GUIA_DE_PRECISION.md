# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Precisión

**Guía:** Guía de Precisión
**Archivo Guía:** `09-guia-de-precision.pdf`
**Texto Extraído:** `textos_extraidos/09-guia-de-precision.txt`
**Fecha:** Diciembre 2025
**Prioridad de Mejoras:** Media
**Cobertura Actual:** 80% (🟢 Excelente)
...
### **Estado Actual**
La plataforma tiene una cobertura del **80%** para esta guía según los documentos de auditoría real.
...
1. **Ampliar métricas específicas de precisión en PMM**
2. **Implementar validaciones de precisión continuas**
3. **Crear dashboard específico de métricas de precisión**
...
- **PDF Original:** `docs/compliance/guias/09-guia-de-precision.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/09-guia-de-precision.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/09-guia-de-precision.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Ampliar métricas específicas de precisión en PMM
...
- [ ] **Mejora 2:** Implementar validaciones de precisión continuas
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Crear dashboard específico de métricas de precisión
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/09-guia-de-precision.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/09-guia-de-precision.txt`
...
2. **Cobertura Actual:** 80% - Requiere mejoras significativas
