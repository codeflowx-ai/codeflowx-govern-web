# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Transparencia

**Guía:** Guía de Transparencia
**Archivo Guía:** `08-guia-transparencia.pdf`
**Texto Extraído:** `textos_extraidos/08-guia-transparencia.txt`
**Fecha:** Diciembre 2025
**Prioridad de Mejoras:** Media
**Cobertura Actual:** 75% (🟡 Buena)
...
### **Estado Actual**
La plataforma tiene una cobertura del **75%** para esta guía según los documentos de auditoría real.
...
1. **Ampliar sección de transparencia en documentación técnica**
2. **Implementar información para usuarios según Art. 13**
3. **Mejorar claridad y accesibilidad de documentación**
...
- **PDF Original:** `docs/compliance/guias/08-guia-transparencia.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/08-guia-transparencia.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/08-guia-transparencia.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Ampliar sección de transparencia en documentación técnica
...
- [ ] **Mejora 2:** Implementar información para usuarios según Art. 13
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Mejorar claridad y accesibilidad de documentación
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/08-guia-transparencia.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/08-guia-transparencia.txt`
...
2. **Cobertura Actual:** 75% - Requiere mejoras significativas
