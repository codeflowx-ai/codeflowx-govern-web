# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Registros

**Guía:** Guía de Registros
**Archivo Guía:** `12-guia-de-registros.pdf`
**Texto Extraído:** `textos_extraidos/12-guia-de-registros.txt`
...
1. **Validar sincronización completa con base de datos EU**
2. **Mejorar reportes de registro**
3. **Documentar procesos de registro**
...
- **PDF Original:** `docs/compliance/guias/12-guia-de-registros.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/12-guia-de-registros.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/12-guia-de-registros.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Validar sincronización completa con base de datos EU
...
- [ ] **Mejora 2:** Mejorar reportes de registro
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Documentar procesos de registro
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/12-guia-de-registros.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/12-guia-de-registros.txt`
