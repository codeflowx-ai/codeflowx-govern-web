# 🔧 PROMPT PARA AGENTE - MEJORAS: Guía de Gestión de Incidentes

**Guía:** Guía de Gestión de Incidentes
**Archivo Guía:** `14-guia-gestion-de-incidentes.pdf`
**Texto Extraído:** `textos_extraidos/14-guia-gestion-de-incidentes.txt`
...
1. **Crear flujo específico de gestión de incidentes**
2. **Mejorar workflow completo: reporte, investigación, resolución**
3. **Ampliar dashboard de incidentes**
...
- **PDF Original:** `docs/compliance/guias/14-guia-gestion-de-incidentes.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/14-guia-gestion-de-incidentes.txt`
...
1. **Revisar el texto completo de la guía** en `textos_extraidos/14-guia-gestion-de-incidentes.txt`
...
### **Tareas de Mejora**
- [ ] **Mejora 1:** Crear flujo específico de gestión de incidentes
...
- [ ] **Mejora 2:** Mejorar workflow completo: reporte, investigación, resolución
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- [ ] **Mejora 3:** Ampliar dashboard de incidentes
  - [ ] Analizar requisito específico
  - [ ] Diseñar solución técnica
  - [ ] Implementar mejora
  - [ ] Validar funcionamiento
...
- **Guía Original:** `docs/compliance/guias/14-guia-gestion-de-incidentes.pdf`
- **Texto Extraído:** `docs/compliance/guias/textos_extraidos/14-guia-gestion-de-incidentes.txt`
