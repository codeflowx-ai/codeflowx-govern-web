-- ============================================================================
-- Procedure: sp_schedule_maintenance - Procedimiento simplificado
...
COMMENT ON PROCEDURE sp_schedule_maintenance IS 'Procedimiento simplificado - Schedule Maintenance';
