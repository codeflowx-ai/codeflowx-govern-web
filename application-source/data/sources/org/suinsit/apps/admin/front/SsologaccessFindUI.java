package org.suinsit.apps.admin.front;
import java.io.File;
...
import suinsit.lowcode.web.*;
import lombok.Getter;
import lombok.Setter;
import lombok.extern.slf4j.Slf4j;
import org.suinsit.apps.admin.Ssologaccess;
...
@Setter
@Slf4j
public class   SsologaccessFindUI extends FindPageCtrlUI {
	...
	ListModelEntityGroup groups;
	protected CalculateMathExpression calculateMath = new CalculateMathExpression();
	protected ListModelList<CustomCriteria> customCriterias = new ListModelList<CustomCriteria>();
	protected CustomCriteriaRowRender filterRender = new CustomCriteriaRowRender(customCriterias);
	protected CriteriaBean criteriaBean = new CriteriaBean();
	protected ListModelList<CriteriaBean> criteriasBeans = new ListModelList<CriteriaBean>();
	protected UniqueValidator unique;
	...
	private Ssologaccess data = new Ssologaccess(); 
	String idpagina;
	public SsologaccessFindUI() {
		super();
	}
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
				Selectors.wireComponents(view, this, false);
					idpagina = view.getAttribute("pagina").toString();
	}
