...
@Entity
@Table (
	name = "SLESCHATLEARNING" 
)
@Entidad (
	namespace = "suinless",
	type = "TABLE",
	name = "SLESCHATLEARNING",
	labelMonitor = "CHAT_LEARNING",
	pk = "idxsleschatlearning" 
)
public class Sleschatlearning implements Serializable { 

	private static final long serialVersionUID = 1L;
	@Id
	@Column (
		name = "idxsleschatlearning",
		nullable = true 
	)
	@Field (
		criteria = false,
	...
	private Long idxsleschatlearning;
	@NotNull
	@NotBlank
	@Column (
		name = "learningdate",
	...
	private String feedbackloop;
	@Column (
		name = "improvementmetrics",
		nullable = true 
	)
	@Field (
		criteria = false,
	...
	private String improvementmetrics;
	@Column (
	...
	private String adaptationrules;
