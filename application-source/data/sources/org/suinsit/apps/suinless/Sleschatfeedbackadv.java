...
@Entity
@Table (
	name = "SLESCHATFEEDBACKADV" 
)
@Entidad (
	namespace = "suinless",
	type = "TABLE",
	name = "SLESCHATFEEDBACKADV",
	labelMonitor = "CHAT_FEEDBACK_ADV",
	pk = "idxsleschatfeedbackadv" 
)
public class Sleschatfeedbackadv implements Serializable { 

	private static final long serialVersionUID = 1L;
	@Id
	@Column (
		name = "idxsleschatfeedbackadv",
		nullable = true 
	)
	@Field (
		criteria = false,
	...
	private Long idxsleschatfeedbackadv;
	@NotNull
	@NotBlank
	@Column (
		name = "feedbackdate",
