package org.suinsit.apps.suinless.front;
import java.io.File;
...
@Setter
@Slf4j
public class   SlmrulemoderationFindUI extends FindPageCtrlUI {
	...
	private Slmrulemoderation data = new Slmrulemoderation(); 
	String idpagina;
	public SlmrulemoderationFindUI() {
		super();
	}
	@AfterCompose
