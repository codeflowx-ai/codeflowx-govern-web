...
@Entity
@Table (
	name = "SLESROUTINGSTRATEGY" 
)
@Entidad (
	namespace = "suinless",
	type = "TABLE",
	name = "SLESROUTINGSTRATEGY",
	labelMonitor = "ROUTING_STRATEGY",
	pk = "idxslesroutingstrategy" 
)
public class Slesroutingstrategy implements Serializable { 

	private static final long serialVersionUID = 1L;
	@Id
	@Column (
		name = "idxslesroutingstrategy",
		nullable = true 
	)
	@Field (
		criteria = false,
	...
	private Long idxslesroutingstrategy;
	@NotNull
	@NotBlank
	@Size (
		min = 0,
	...
	private String performancethresholds;
	@Column (
		name = "active",
		nullable = true 
	)
