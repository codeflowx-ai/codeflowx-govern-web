...
import org.suinsit.apps.facturacin.Erplineaconceptohora;
...
public class Erprlineahoras implements Serializable { 
	...
	@JoinColumn (
		name = "IDAUTORIZAUSER0",
		referencedColumnName = "IDXSSOUSUARIO",
		nullable = true,
		insertable = true,
		updatable = true 
	)
	private Ssousuario idautorizauser;
	@ManyToOne (
		fetch = javax.persistence.FetchType.LAZY 
	)
	@JoinColumn (
		name = "IDERPLINEACONCEPTOHORA0",
		referencedColumnName = "IDXERPLINEACONCEPTOHORA",
		nullable = true,
		insertable = true,
		updatable = true 
	)
	private Erplineaconceptohora iderplineaconceptohora; 
	...
	public Ssousuario getIdautorizauser() {
		if(this.idautorizauser==null)this.idautorizauser=new org.suinsit.apps.admin.Ssousuario();
		  return this.idautorizauser; 
	}
	
	public Erplineaconceptohora getIderplineaconceptohora() {
		if(this.iderplineaconceptohora==null)this.iderplineaconceptohora=new org.suinsit.apps.facturacin.Erplineaconceptohora();
		  return this.iderplineaconceptohora; 
	} 
