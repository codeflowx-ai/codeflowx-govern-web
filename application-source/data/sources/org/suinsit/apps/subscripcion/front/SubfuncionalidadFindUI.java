package org.suinsit.apps.subscripcion.front;
import java.io.File;
...
@Setter
@Slf4j
public class   SubfuncionalidadFindUI extends FindPageCtrlUI {
	...
	private Subfuncionalidad data = new Subfuncionalidad(); 
	String idpagina;
	public SubfuncionalidadFindUI() {
		super();
	}
	@AfterCompose
