    ...
    <div className="space-y-4">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-foreground">
              {t("agents.health.title", "Salud de Agentes")}
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-9">
            {t("agents.health.subtitle", "Gestión de salud de agentes")}
          </p>
        </div>
        <Button variant="outline" size="sm" className="flex items-center gap-2" onClick={() => router.push("/governance/agents/monitoring/health/create")}>
            <Plus className="h-4 w-4" />
            {t("agents.health.register", "Registrar Salud")}
          </Button>
      </div>
      ...
      <Card className="backdrop-blur-md bg-background/60 border-border/50">
        <CardHeader className="pb-3">
          <CardTitle className="text-base font-medium">{t("agents.health.list", "Listado de Salud")}</CardTitle>
        </CardHeader>
                      ...
                      <td className="p-2">
                        <div className="flex gap-2">
                          <Button
                            ...
                            onClick={() => router.push(`/governance/agents/monitoring/health/${item.id}`)}
                          >
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (confirm(t("common.confirmDelete", "¿Está seguro de eliminar este registro?"))) {
