...
export default function EuRegistrationProjectsPage() {
      ...
      <div className="relative z-10 w-full px-4 py-6 space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <Button
            ...
            onClick={() => router.push("/governance/compliance/eu-registration/new")}
          >
            <Plus className="w-4 h-4" />
            {t("governance.compliance.euRegistration.createNew", "Create New Registration")}
          </Button>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="relative">
              ...
              <Input
                placeholder={t("governance.compliance.euRegistration.searchPlaceholder", "Search by project or ID...")}
                value={searchQuery}
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/governance/compliance/eu-registration/new?projectId=${project.projectId}`
                        )
                      }
                    >
                      <Plus className="w-4 h-4 mr-2" />
                      {t("governance.compliance.euRegistration.createNew", "New Registration")}
                    </Button>
                  </div>
                </CardHeader>
                <CardBody>
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            <Button
                              ...
                              onClick={() =>
                                router.push(
                                  `/governance/compliance/eu-registration/${registration.registrationId}`
                                )
                              }
                            >
