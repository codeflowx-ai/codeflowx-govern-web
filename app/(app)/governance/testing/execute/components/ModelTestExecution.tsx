  ...
  const handleSubmit = async () => {
    ...
    try {
      if (testType === "AB_TEST") {
        ...
        formDataToSend.append("entityType", "MODEL");
        formDataToSend.append("entityAId", formData.modelId);
        formDataToSend.append("entityBId", formData.modelIdB);
        ...
        // Ejecutar test normal (BIAS_ANALYSIS, EXPLAINABILITY, PERFORMANCE)
        // TODO: Implementar endpoints específicos para cada tipo de test
