...
import { Search, ArrowLeft, Upload, Brain } from "lucide-react";
import { useState } from "react";
import RAGTestExecution from "../components/RAGTestExecution";

const TEST_TYPES = [
  {
    value: "RETRIEVAL_TEST",
    label: "Test de Recuperación",
    description: "Evalúa la calidad de la recuperación de información",
    supportsAB: false,
    requiresFile: true,
    supportsJudge: false,
  },
  {
    value: "ACCURACY_TEST",
    label: "Test de Precisión",
    description: "Evalúa la precisión de las respuestas del RAG",
    supportsAB: false,
    requiresFile: true,
    supportsJudge: true,
  },
  {
    value: "AB_TEST",
    label: "Prueba A/B",
    description: "Compara dos configuraciones RAG",
    supportsAB: true,
    requiresFile: true,
    supportsJudge: true,
  },
  {
    value: "LATENCY_TEST",
    label: "Test de Latencia",
    description: "Mide la latencia del sistema RAG",
    supportsAB: false,
    requiresFile: false,
    supportsJudge: false,
  },
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-foreground">
              {t("governance.testing.execute.rag.title", "Ejecutar Test de RAG")}
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-9">
            {t("governance.testing.execute.rag.subtitle", "Ejecuta tests y validaciones para sistemas RAG")}
          </p>
        </div>
      </div>
