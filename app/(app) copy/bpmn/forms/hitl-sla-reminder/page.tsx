...
function HitlSlaReminderFormContent() {
  ...
  const [interventionData, setInterventionData] = useState<typeof mockHitlSlaReminder & { urgency?: "LOW" | "MEDIUM" | "HIGH" | "CRITICAL" }>(mockHitlSlaReminder)
  ...
  return (
    <div className="space-y-6">
      ...
      <Card
        className="bg-gradient-to-br from-yellow-500 to-red-500 border-yellow-500"
      >
        <CardHeader>
