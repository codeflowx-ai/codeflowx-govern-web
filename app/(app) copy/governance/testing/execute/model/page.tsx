...
import ModelTestExecution from "../components/ModelTestExecution";

const TEST_TYPES = [
  {
    value: "BIAS_ANALYSIS",
    label: "Análisis de Sesgo",
    description: "Analiza sesgos en el modelo usando un dataset de prueba",
    supportsAB: false,
    requiresFile: true,
    supportsJudge: false,
  },
  {
    ...
    description: "Analiza la explicabilidad del modelo usando predicciones",
    supportsAB: false,
    requiresFile: true,
    supportsJudge: false,
  },
  {
    value: "PERFORMANCE",
    label: "Rendimiento",
    description: "Evalúa métricas de rendimiento del modelo",
    supportsAB: false,
    requiresFile: false,
    supportsJudge: false,
  },
  {
    value: "AB_TEST",
    label: "Prueba A/B",
    description: "Compara dos modelos en el mismo dataset",
    supportsAB: true,
    requiresFile: true,
    supportsJudge: false,
  },
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-foreground">
              {t("governance.testing.execute.model.title", "Ejecutar Test de Modelo")}
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-9">
            {t("governance.testing.execute.model.subtitle", "Ejecuta tests y validaciones para modelos de IA")}
          </p>
        </div>
      </div>
