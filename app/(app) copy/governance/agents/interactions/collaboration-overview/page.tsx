    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <Users className="w-8 h-8 animate-spin mx-auto mb-2 text-muted-foreground" />
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-foreground">
              {t("agents.collaboration.title", "Colaboración")}
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-9">
            {t("agents.collaboration.subtitle", "Gestión de colaboración")}
          </p>
        </div>
        <Button variant="outline" size="sm" className="flex items-center gap-2" onClick={() => router.push("/governance/agents/interactions/collaboration/create")}>
            <Plus className="h-4 w-4" />
            {t("agents.collaboration.register", "Registrar Colaboración")}
          </Button>
      </div>
