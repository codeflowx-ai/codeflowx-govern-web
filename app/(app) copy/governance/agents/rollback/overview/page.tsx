  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" className="flex items-center gap-2" onClick={() => router.push("/governance/agents/rollback/create")}>
            <Plus className="h-4 w-4" />
            {t("agents.rollback.register", "Registrar Reversión")}
          </Button>
      </div>
