    ...
    <div className="space-y-4">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-foreground">
              {t("agents.compliance.title", "Compliance de Agentes")}
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-9">
            {t("agents.compliance.subtitle", "Gestión de compliance de agentes")}
          </p>
        </div>
        <Button
          variant="outline"
          ...
          onClick={() => {
            window.location.href = "/governance/agents/compliance/create";
          }}
        >
      ...
      <Card className="backdrop-blur-md bg-background/60 border-border/50">
        <CardHeader className="pb-3">
          <CardTitle className="text-base font-medium">{t("agents.compliance.list", "Listado de Compliance")}</CardTitle>
        </CardHeader>
