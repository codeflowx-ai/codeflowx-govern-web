    ...
    <div className="space-y-4">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-foreground">
              {t("agents.governance.title", "Gobierno de Agentes")}
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-9">
            {t("agents.governance.subtitle", "Gestión de gobierno de agentes")}
          </p>
        </div>
        <Button variant="outline" size="sm" className="flex items-center gap-2" onClick={() => router.push("/governance/agents/governance/create")}>
            <Plus className="h-4 w-4" />
            {t("agents.governance.register", "Registrar Gobierno")}
          </Button>
      </div>
      ...
      <Card className="backdrop-blur-md bg-background/60 border-border/50">
        <CardHeader className="pb-3">
          <CardTitle className="text-base font-medium">{t("agents.governance.list", "Listado de Gobierno")}</CardTitle>
        </CardHeader>
