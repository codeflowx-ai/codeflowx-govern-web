  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" className="flex items-center gap-2" onClick={() => router.push("/governance/agents/alerts/create")}>
            <Plus className="h-4 w-4" />
            {t("agents.alerts.register", "Registrar Alerta")}
          </Button>
      </div>
                      ...
                      <td className="p-2">
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (confirm(t("common.confirmDelete", "¿Está seguro de eliminar esta alerta?"))) {
                                console.log("Eliminar alerta:", alert.id);
                              }
                            }}
                          >
