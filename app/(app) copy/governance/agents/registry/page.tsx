    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          onClick={() => {
            window.location.href = "/governance/agents/registry/new";
          }}
        >
                      ...
                      <td className="p-2">
                        <div className="flex gap-2">
                          <Button
                            ...
                            onClick={() => {
                              window.location.href = `/governance/agents/registry/${agent.id}`;
                            }}
                          >
                          ...
                          <Button
                            ...
                            onClick={() => {
                              window.location.href = `/governance/agents/registry/${agent.id}?edit=true`;
                            }}
                          >
