...
// --- INTERFACES ACTUALIZADAS SEGÚN EL CORE ---
...
// Roles disponibles según el core
const ALL_ROLES = [
  "admin",
  "developer",
  "viewer",
...
// Departamentos mock según el core
const mockDepartments: Department[] = [
  {
    id: 1,
    name: "Administración",
    description: "Departamento de administración general del sistema",
    code: "ADMIN",
    managerId: 1,
    isActive: true,
  ...
  },
  {
    id: 3,
    name: "Consultoría",
    description: "Departamento de consultoría y asesoramiento",
    code: "CONS",
    managerId: 3,
    isActive: true,
    createdAt: "2024-01-01T00:00:00Z",
  ...
  },
  {
    id: 4,
    name: "Analytics",
    description: "Departamento de análisis de negocio",
    code: "ANAL",
    managerId: 4,
    isActive: true,
    createdAt: "2024-01-01T00:00:00Z",
  ...
  },
  {
    id: 5,
    name: "AI & ML",
    description: "Departamento de Inteligencia Artificial y Machine Learning",
    code: "AIML",
    managerId: 5,
    isActive: true,
    createdAt: "2024-01-01T00:00:00Z",
  ...
  },
  {
    id: 6,
    name: "DevOps",
    description: "Departamento de operaciones de desarrollo",
    code: "DEVOPS",
    managerId: 6,
    isActive: true,
    createdAt: "2024-01-01T00:00:00Z",
  ...
  },
  {
    ...
    description: "Departamento de gestión y coordinación de proyectos",
    code: "PM",
    managerId: 7,
    isActive: true,
    createdAt: "2024-01-01T00:00:00Z",
...
// Usuarios mock actualizados según el core
const mockUsers: User[] = [
  ...
  },
  {
    ...
    lastLogin: "2024-01-20T05:00:00Z",
  },
  {
    id: "6",
    firstName: "DevOps",
  ...
  },
  {
    ...
    departmentId: 4,
    department: mockDepartments[3],
    roles: ["business_analytics", "viewer"],
  ...
  },
  {
    ...
    departmentId: 7,
    department: mockDepartments[6],
    roles: ["project_manager", "business_analytics"],
...
export default function UsersPage() {
  ...
  const filteredUsers = users.filter((user) => {
    ...
    const matchesStatus =
      filterStatus === "all" || user.isActive.toString() === filterStatus;
  ...
  const handleResetPassword = (userId: string) => {
    ...
    alert(`Contraseña reset para usuario ${userId}`);
  };
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-2">
          ...
          <p className="text-gray-600">
            Gestiona usuarios, departamentos y permisos del sistema
          </p>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm font-medium text-gray-900">
                  {users.length > 0
                    ? getTimeAgo(users[0].lastLogin || users[0].createdAt)
                    : "N/A"}
                </p>
              </div>
      ...
      >
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <Button
            onClick={() => showPasswordModal && handlePasswordChange(showPasswordModal)}
            disabled={
