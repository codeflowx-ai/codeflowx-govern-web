// app/api/bpmn/processes/route.ts
import { NextRequest, NextResponse } from 'next/server'
import { readdir, readFile } from 'fs/promises'
import { join } from 'path'
import { existsSync } from 'fs'

// En modo demo, usar la misma lógica que /api/bpmn/processes/local
 ...
 * Lista todos los procesos BPMN disponibles (modo demo: usa archivos locales)
 */
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error listing BPMN processes:', error)
    return NextResponse.json(
