...
import com.codeflowx.admin.Ssomenu;
import com.codeflowx.admin.Ssomenuitem;
import com.codeflowx.admin.Ssoruserapp;
import com.codeflowx.admin.Ssousuario;
import com.codeflowx.admin.Ssovpermrol;
import com.codeflowx.bpmn.Bpmnvprocessemails;
...
public class DashboardUI extends MasterHandler {
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
		...
		ssoruserapp = BuildEntityFromClass.build(Ssoruserapp.class);
		eUsuario = BuildEntityFromClass.build(Ssousuario.class);
		permisos = BuildEntityFromClass.build(Ssovpermrol.class);
		clsPermisos = Ssovpermrol.class;
		Bpmnvprocessemails = BuildEntityFromClass.build(Bpmnvprocessemails.class);
		clsBpmnvprocessemails = Bpmnvprocessemails.class;
		ClsSsomenu = Ssomenu.class;
		ssomenuitem = BuildEntityFromClass.build(Ssomenuitem.class); 
		clsSsomenuitem = Ssomenuitem.class;
	...
	private void loadApps(Usuario usuario) {
		...
		try {
			listProjects(dao.query(Ssoruserapp.class, new DataScroll(), query, criterias).getDataList());
		} catch (Exception e) {
			log.error(e);
		}
	}
