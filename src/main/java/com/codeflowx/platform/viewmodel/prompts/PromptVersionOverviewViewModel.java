...
/**
 * ViewModel para búsqueda y listado de PromptVersion
...
public class PromptVersionOverviewViewModel extends BaseFront<PromptVersionOverviewViewModel>{
    ...
    private PageResult<PromptVersion> pageResult;
    ...
    // ========== Datos ==========
    private List<PromptVersion> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = promptVersionService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRMPROMPTVERSIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "prmversion");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptVersionMetricsSummary> metrics = businessService.findAllView(PromptVersionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            promptVersionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRMPROMPTVERSIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
