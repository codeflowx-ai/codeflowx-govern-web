...
/**
 * ViewModel para búsqueda y listado de PromptValidation
...
public class PromptValidationOverviewViewModel extends BaseFront<PromptValidationOverviewViewModel>{
    ...
    private PageResult<PromptValidation> pageResult;
    ...
    // ========== Datos ==========
    private List<PromptValidation> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = promptValidationService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRMPROMPTVALIDATIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "prmvalidationresult");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptValidationMetricsSummary> metrics = businessService.findAllView(PromptValidationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            promptValidationService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRMPROMPTVALIDATIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
