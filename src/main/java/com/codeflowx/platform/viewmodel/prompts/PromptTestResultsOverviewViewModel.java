...
import com.codeflowx.govern.entity.views.prompts.PromptTestResults;
import com.codeflowx.govern.service.prompts.PromptTestResultsService;
...
/**
 * ViewModel para búsqueda y listado de PromptTestResults
...
public class PromptTestResultsOverviewViewModel extends BaseFront<PromptTestResultsOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private PromptTestResultsService promptTestResultsService;
    @WireVariable
    ...
    private PageResult<PromptTestResults> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = promptTestResultsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROMPT_TEST_RESULTS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptTestResultsMetricsSummary> metrics = businessService.findAllView(PromptTestResultsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Nota: PromptTestResults es una vista de solo lectura, no se puede eliminar
                            log.warn("Intento de eliminar vista de solo lectura PromptTestResults ID={}", itemId);
