    ...
    public void loadData() {
        try {
            ...
            pageResult = businessService.findAllView(
                PromptPerformanceComparison.class,
                pageParams,
                criterias
            );
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(PromptPerformanceComparison.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_PROMPT_PERFORMANCE_COMPARISON", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
