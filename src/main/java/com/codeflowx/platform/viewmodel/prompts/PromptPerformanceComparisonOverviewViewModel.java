...
import com.codeflowx.govern.entity.views.prompts.PromptPerformanceComparison;
import com.codeflowx.govern.service.prompts.PromptPerformanceComparisonService;
...
/**
 * ViewModel para búsqueda y listado de PromptPerformanceComparison
...
public class PromptPerformanceComparisonOverviewViewModel extends BaseFront<PromptPerformanceComparisonOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private PromptPerformanceComparisonService promptPerformanceComparisonService;
    @WireVariable
    ...
    private PageResult<PromptPerformanceComparison> pageResult;
    ...
    // ========== Datos ==========
    private List<PromptPerformanceComparison> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = promptPerformanceComparisonService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROMPT_PERFORMANCE_COMPARISON", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptPerformanceComparisonMetricsSummary> metrics = businessService.findAllView(PromptPerformanceComparisonMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Nota: PromptPerformanceComparison es una vista de solo lectura, no se puede eliminar
                            log.warn("Intento de eliminar vista de solo lectura PromptPerformanceComparison ID={}", itemId);
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo);
