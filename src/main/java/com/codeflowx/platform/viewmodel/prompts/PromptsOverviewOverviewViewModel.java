...
/**
 * ViewModel para búsqueda y listado de PromptsOverview
...
public class PromptsOverviewOverviewViewModel extends BaseFront<PromptsOverviewOverviewViewModel>{
    ...
    // ========== Datos ==========
    private List<PromptsOverview> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROMPTS_OVERVIEW", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptsOverviewMetricsSummary> metrics = businessService.findAllView(PromptsOverviewMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Nota: PromptsOverview es una vista de solo lectura, no se puede eliminar
                            log.warn("Intento de eliminar vista de solo lectura PromptsOverview ID={}", itemId);
