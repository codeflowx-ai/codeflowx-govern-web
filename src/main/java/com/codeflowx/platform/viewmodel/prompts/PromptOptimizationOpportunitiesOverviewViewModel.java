...
import com.codeflowx.govern.entity.views.prompts.PromptOptimizationOpportunities;
import com.codeflowx.govern.service.prompts.PromptOptimizationOpportunitiesService;
...
/**
 * ViewModel para búsqueda y listado de PromptOptimizationOpportunities
...
public class PromptOptimizationOpportunitiesOverviewViewModel extends BaseFront<PromptOptimizationOpportunitiesOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private PromptOptimizationOpportunitiesService promptOptimizationOpportunitiesService;
    @WireVariable
    ...
    private PageResult<PromptOptimizationOpportunities> pageResult;
    ...
    // ========== Datos ==========
    private List<PromptOptimizationOpportunities> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = promptOptimizationOpportunitiesService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROMPT_OPTIMIZATION_OPPORTUNITIES", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptOptimizationOpportunitiesMetricsSummary> metrics = businessService.findAllView(PromptOptimizationOpportunitiesMetricsSummary.class);
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/prompts/prompts-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Nota: PromptOptimizationOpportunities es una vista de solo lectura, no se puede eliminar
                            log.warn("Intento de eliminar vista de solo lectura PromptOptimizationOpportunities ID={}", itemId);
     ...
     * @param mensaje  -- mensaje aclaratorio, ejeml, e);
