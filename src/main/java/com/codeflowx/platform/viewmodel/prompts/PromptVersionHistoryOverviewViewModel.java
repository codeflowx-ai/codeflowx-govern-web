...
import com.codeflowx.govern.entity.views.prompts.PromptVersionHistory;
import com.codeflowx.govern.service.prompts.PromptVersionHistoryService;
...
/**
 * ViewModel para búsqueda y listado de PromptVersionHistory
...
public class PromptVersionHistoryOverviewViewModel extends BaseFront<PromptVersionHistoryOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private PromptVersionHistoryService promptVersionHistoryService;
    @WireVariable
    ...
    private PageResult<PromptVersionHistory> pageResult;
    ...
    // ========== Datos ==========
    private List<PromptVersionHistory> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = promptVersionHistoryService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROMPT_VERSION_HISTORY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptVersionHistoryMetricsSummary> metrics = businessService.findAllView(PromptVersionHistoryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Nota: PromptVersionHistory es una vista de solo lectura, no se puede eliminar
                            log.warn("Intento de eliminar vista de solo lectura PromptVersionHistory ID={}", itemId);
