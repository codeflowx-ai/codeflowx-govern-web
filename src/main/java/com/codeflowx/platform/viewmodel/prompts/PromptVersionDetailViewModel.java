...
public class PromptVersionDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentPromptVersion = businessService.findById(PromptVersion.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentPromptVersion);
                ...
                businessService.update(currentPromptVersion);
