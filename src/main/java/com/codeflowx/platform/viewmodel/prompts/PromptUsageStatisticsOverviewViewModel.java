...
import com.codeflowx.govern.entity.views.prompts.PromptUsageStatistics;
import com.codeflowx.govern.service.prompts.PromptUsageStatisticsService;
...
/**
 * ViewModel para búsqueda y listado de PromptUsageStatistics
...
public class PromptUsageStatisticsOverviewViewModel extends BaseFront<PromptUsageStatisticsOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private PromptUsageStatisticsService promptUsageStatisticsService;
    @WireVariable
    ...
    private PageResult<PromptUsageStatistics> pageResult;
    ...
    // ========== Datos ==========
    private List<PromptUsageStatistics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = promptUsageStatisticsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROMPT_USAGE_STATISTICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptUsageStatisticsMetricsSummary> metrics = businessService.findAllView(PromptUsageStatisticsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Nota: PromptUsageStatistics es una vista de solo lectura, no se puede eliminar
                            log.warn("Intento de eliminar vista de solo lectura PromptUsageStatistics ID={}", itemId);
