...
/**
 * ViewModel para búsqueda y listado de PromptCostAnalysis
...
public class PromptCostAnalysisOverviewViewModel extends BaseFront<PromptCostAnalysisOverviewViewModel> {
    ...
    private PageResult<PromptCostAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<PromptCostAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROMPT_COST_ANALYSIS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptCostAnalysisMetricsSummary> metrics = businessService.findAllView(PromptCostAnalysisMetricsSummary.class);
