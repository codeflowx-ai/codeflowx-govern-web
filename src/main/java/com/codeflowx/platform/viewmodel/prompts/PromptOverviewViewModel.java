...
/**
 * ViewModel para búsqueda y listado de Prompt
...
public class PromptOverviewViewModel extends BaseFront<PromptOverviewViewModel>{
    ...
    private PageResult<Prompt> pageResult;
    ...
    // ========== Datos ==========
    private List<Prompt> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRMPROMPTS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PromptMetricsSummary> metrics = businessService.findAllView(PromptMetricsSummary.class);
