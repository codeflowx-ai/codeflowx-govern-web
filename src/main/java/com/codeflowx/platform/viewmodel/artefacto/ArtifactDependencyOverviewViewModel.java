...
/**
 * ViewModel para búsqueda y listado de ArtifactDependency
...
public class ArtifactDependencyOverviewViewModel extends BaseFront<ArtifactDependencyOverviewViewModel>{
    ...
    private PageResult<ArtifactDependency> pageResult;
    ...
    // ========== Datos ==========
    private List<ArtifactDependency> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = artifactDependencyService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CATARTIFACTDEPENDENCIES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "catdeprequiredversion");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ArtifactDependencyMetricsSummary> metrics = businessService.findAllView(ArtifactDependencyMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            artifactDependencyService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "CATARTIFACTDEPENDENCIES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
