...
/**
 * ViewModel para búsqueda y listado de ArtifactVersion
...
public class ArtifactVersionOverviewViewModel extends BaseFront<ArtifactVersionOverviewViewModel>{
    ...
    private PageResult<ArtifactVersion> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = artifactVersionService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CATARTIFACTVERSIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "catverversionnumber");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ArtifactVersionMetricsSummary> metrics = businessService.findAllView(ArtifactVersionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            artifactVersionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "CATARTIFACTVERSIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
