...
public class BaseArtifactDetailViewModel extends BaseFront<BaseArtifactDetailViewModel>{
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentBaseArtifact = baseArtifactService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentBaseArtifact = baseArtifactService.create(currentBaseArtifact);
                ...
                currentBaseArtifact = baseArtifactService.update(currentBaseArtifact);
    ...
    private void loadSubcatartifactdependencies() {
        try {
            if (currentBaseArtifact != null && currentBaseArtifact.getIdxbaseartifact() != null) {
                ...
                PageResult<ArtifactDependency> result = artifactDependencyService.findAll(collectionParams, criterias);
    ...
    private void loadSubcatartifactversions() {
        try {
            if (currentBaseArtifact != null && currentBaseArtifact.getIdxbaseartifact() != null) {
                ...
                PageResult<ArtifactVersion> result = artifactVersionService.findAll(collectionParams, criterias);
