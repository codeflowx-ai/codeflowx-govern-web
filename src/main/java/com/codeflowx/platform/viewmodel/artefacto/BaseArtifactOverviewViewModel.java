...
/**
 * ViewModel para búsqueda y listado de BaseArtifact
...
public class BaseArtifactOverviewViewModel extends BaseFront<BaseArtifactOverviewViewModel>{
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<BaseArtifactMetricsSummary> metrics = businessService.findAllView(BaseArtifactMetricsSummary.class);
