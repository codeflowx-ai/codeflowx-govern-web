...
/**
 * ViewModel para búsqueda y listado de ProvidersMetricsSummary
...
public class ProvidersMetricsSummaryOverviewViewModel extends BaseFront<ProvidersMetricsSummaryOverviewViewModel> {
    ...
    private PageResult<ProvidersMetricsSummary> pageResult;
    ...
    // ========== Datos ==========
    private List<ProvidersMetricsSummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROVIDERS_METRICS_SUMMARY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProvidersMetricsSummaryMetricsSummary> metrics = businessService.findAllView(ProvidersMetricsSummaryMetricsSummary.class);
