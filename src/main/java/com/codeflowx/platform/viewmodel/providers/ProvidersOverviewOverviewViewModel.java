package com.codeflowx.platform.viewmodel.providers;
...
/**
 * ViewModel para búsqueda y listado de ProvidersOverview
...
public class ProvidersOverviewOverviewViewModel extends BaseFront<ProvidersOverviewOverviewViewModel> {
    ...
    // ========== Datos ==========
    private List<ProvidersOverview> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROVIDERS_OVERVIEW", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProvidersOverviewMetricsSummary> metrics = businessService.findAllView(ProvidersOverviewMetricsSummary.class);
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/providers/providers-detail.zul", page.getFellow(IDDESKTOP), params);
    }
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        try {
            // NOTA: ProvidersOverview es una vista (VIEW), no una entidad.
            ...
            log.warn("Intento de eliminar registro de vista ProvidersOverview - ID={}", itemId);
        } catch (Exception e) {
