...
public class UserDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentUser = businessService.findById(User.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentUser);
    ...
    private void loadSubauditlogs() {
        try {
            if (currentUser != null && currentUser.getIdxuser() != null) {
                ...
                PageResult<AuditLog> result = businessService.findAllEntity(AuditLog.class, collectionParams, criterias);
    ...
    private void loadSubcorusersessions() {
        try {
            if (currentUser != null && currentUser.getIdxuser() != null) {
                ...
                PageResult<UserSession> result = businessService.findAllEntity(UserSession.class, collectionParams, criterias);
