...
/**
 * ViewModel para búsqueda y listado de Department
...
public class DepartmentOverviewViewModel extends BaseFront<DepartmentOverviewViewModel>{
    ...
    // ========== Datos ==========
    private List<Department> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = departmentService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CORDEPARTMENTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "corname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<DepartmentMetricsSummary> metrics = businessService.findAllView(DepartmentMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            departmentService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "CORDEPARTMENTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
