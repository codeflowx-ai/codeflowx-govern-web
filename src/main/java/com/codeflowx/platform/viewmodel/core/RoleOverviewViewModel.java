...
/**
 * ViewModel para búsqueda y listado de Role
...
public class RoleOverviewViewModel extends BaseFront<RoleOverviewViewModel>{
    ...
    // ========== Datos ==========
    private List<Role> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = roleService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CORROLES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "rolename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RoleMetricsSummary> metrics = businessService.findAllView(RoleMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            roleService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "CORROLES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
