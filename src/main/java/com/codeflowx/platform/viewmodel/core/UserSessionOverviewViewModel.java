...
/**
 * ViewModel para búsqueda y listado de UserSession
...
public class UserSessionOverviewViewModel extends BaseFront<UserSessionOverviewViewModel>{
    ...
    private PageResult<UserSession> pageResult;
    ...
    // ========== Datos ==========
    private List<UserSession> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = userSessionService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CORUSERSESSIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "sessiontoken");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<UserSessionMetricsSummary> metrics = businessService.findAllView(UserSessionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            userSessionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "CORUSERSESSIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
