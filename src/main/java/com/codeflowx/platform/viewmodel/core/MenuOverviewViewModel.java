...
/**
 * ViewModel para búsqueda y listado de Menu
...
public class MenuOverviewViewModel extends BaseFront<MenuOverviewViewModel> {
    ...
    // ========== Datos ==========
    private List<Menu> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = menuService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CORMENUS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "menuname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<MenuMetricsSummary> metrics = businessService.findAllView(MenuMetricsSummary.class);
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ...
                            logActivity("BORRAR", "CORMENUS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
