...
/**
 * ViewModel para búsqueda y listado de LoginAttempt
...
public class LoginAttemptOverviewViewModel extends BaseFront<LoginAttemptOverviewViewModel>{
    ...
    private PageResult<LoginAttempt> pageResult;
    ...
    // ========== Datos ==========
    private List<LoginAttempt> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = loginAttemptService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CORLOGINATTEMPTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "ipaddress");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<LoginAttemptMetricsSummary> metrics = businessService.findAllView(LoginAttemptMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            loginAttemptService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "CORLOGINATTEMPTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
