...
/**
 * ViewModel para búsqueda y listado de User
...
public class UserOverviewViewModel extends BaseFront<UserOverviewViewModel>{
    ...
    public void loadData() {
        try {
            ...
            pageResult = userService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CORUSERS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "passwordhash");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<UserMetricsSummary> metrics = businessService.findAllView(UserMetricsSummary.class);
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ...
                            logActivity("BORRAR", "CORUSERS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
