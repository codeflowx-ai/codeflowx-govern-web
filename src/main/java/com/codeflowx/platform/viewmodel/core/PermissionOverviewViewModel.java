...
/**
 * ViewModel para búsqueda y listado de Permission
...
public class PermissionOverviewViewModel extends BaseFront<PermissionOverviewViewModel>{
    ...
    private PageResult<Permission> pageResult;
    ...
    // ========== Datos ==========
    private List<Permission> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = permissionService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "CORPERMISSIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "permissionname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PermissionMetricsSummary> metrics = businessService.findAllView(PermissionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            permissionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "CORPERMISSIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
