...
/**
 * ViewModel para búsqueda y listado de SecurityAuditSummary
...
public class SecurityAuditSummaryOverviewViewModel extends BaseFront<SecurityAuditSummaryOverviewViewModel>{
    ...
    private PageResult<SecurityAuditSummary> pageResult;
    ...
    // ========== Datos ==========
    private List<SecurityAuditSummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = securityAuditSummaryService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_SECURITY_AUDIT_SUMMARY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<SecurityAuditSummaryMetricsSummary> metrics = businessService.findAllView(SecurityAuditSummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // Nota: SecurityAuditSummary es una view, no se puede eliminar
                        // Si se necesita eliminar, debe hacerse sobre la entidad base
                        log.warn("Intento de eliminar view SecurityAuditSummary - ID={}", itemId);
