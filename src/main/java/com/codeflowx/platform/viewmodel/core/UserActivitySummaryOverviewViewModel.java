...
/**
 * ViewModel para búsqueda y listado de UserActivitySummary
...
public class UserActivitySummaryOverviewViewModel extends BaseFront<UserActivitySummaryOverviewViewModel>{
    ...
    private PageResult<UserActivitySummary> pageResult;
    ...
    // ========== Datos ==========
    private List<UserActivitySummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = userActivitySummaryService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_USER_ACTIVITY_SUMMARY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<UserActivitySummaryMetricsSummary> metrics = businessService.findAllView(UserActivitySummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // Nota: UserActivitySummary es una view, no se puede eliminar
                        // Si se necesita eliminar, debe hacerse sobre la entidad base
                        log.warn("Intento de eliminar view UserActivitySummary - ID={}", itemId);
