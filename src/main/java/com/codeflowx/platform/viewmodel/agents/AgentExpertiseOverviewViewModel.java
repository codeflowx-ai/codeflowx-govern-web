...
/**
 * ViewModel para búsqueda y listado de AgentExpertise
...
public class AgentExpertiseOverviewViewModel extends BaseFront<AgentExpertiseOverviewViewModel> {
    ...
    private PageResult<AgentExpertise> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentExpertiseService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTEXPERTISE", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtcertificationid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentExpertiseMetricsSummary> metrics = businessService.findAllView(AgentExpertiseMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentExpertiseService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTEXPERTISE", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
