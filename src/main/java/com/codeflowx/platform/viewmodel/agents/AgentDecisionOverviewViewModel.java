...
/**
 * ViewModel para búsqueda y listado de AgentDecision
...
public class AgentDecisionOverviewViewModel extends BaseFront<AgentDecisionOverviewViewModel> {
    ...
    private PageResult<AgentDecision> pageResult;
    
    // ========== Filtros ==========
    private String searchTerm = "";
    private String statusFilter = "ALL";
    private String agtdecisiontypeFilter = "ALL";
    private String agtstatusFilter = "ALL";
    
    // ========== Datos ==========
    private List<AgentDecision> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTDECISIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtreviewedby");
        ...
        if (!"ALL".equals(agtdecisiontypeFilter)) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.EQUALS, "agtdecisiontype");
            criteria.setValues(new Object[]{agtdecisiontypeFilter});
            criterias.addCriteria(criteria);
        }
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentDecisionMetricsSummary> metrics = businessService.findAllView(AgentDecisionMetricsSummary.class);
