...
/**
 * ViewModel para búsqueda y listado de AgentRollback
...
public class AgentRollbackOverviewViewModel extends BaseFront<AgentRollbackOverviewViewModel> {
    ...
    private PageResult<AgentRollback> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentRollbackService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTROLLBACKS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtfromversion");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentRollbackMetricsSummary> metrics = businessService.findAllView(AgentRollbackMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentRollbackService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTROLLBACKS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
