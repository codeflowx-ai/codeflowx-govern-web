...
/**
 * ViewModel para búsqueda y listado de AgentApproval
...
public class AgentApprovalOverviewViewModel extends BaseFront<AgentApprovalOverviewViewModel> {
    ...
    private PageResult<AgentApproval> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentApprovalService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTAPPROVALS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtapproverid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentApprovalMetricsSummary> metrics = businessService.findAllView(AgentApprovalMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentApprovalService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTAPPROVALS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
