...
/**
 * ViewModel para búsqueda y listado de AgentTool
...
public class AgentToolOverviewViewModel extends BaseFront<AgentToolOverviewViewModel> {
    ...
    private PageResult<AgentTool> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentToolService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTTOOLS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agttoolname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentToolMetricsSummary> metrics = businessService.findAllView(AgentToolMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentToolService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTTOOLS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
