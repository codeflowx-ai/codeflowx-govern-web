...
/**
 * ViewModel para búsqueda y listado de AgentHealth
...
public class AgentHealthOverviewViewModel extends BaseFront<AgentHealthOverviewViewModel> {
    ...
    private PageResult<AgentHealth> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentHealthService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTHEALTH", null, 
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentHealthMetricsSummary> metrics = businessService.findAllView(AgentHealthMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentHealthService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTHEALTH", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
