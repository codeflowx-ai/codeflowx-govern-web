...
import com.codeflowx.govern.entity.views.agents.AgentDecisionAudit;
import com.codeflowx.admin.Ssoractividad;
import codeflowx.nocode.persist.BusinessService;
import com.codeflowx.govern.service.agents.AgentDecisionService;
import com.codeflowx.govern.service.agents.AgentDecisionAuditService;
...
/**
 * ViewModel para búsqueda y listado de AgentDecisionAudit
...
public class AgentDecisionAuditOverviewViewModel extends BaseFront<AgentDecisionAuditOverviewViewModel> {
    ...
    @WireVariable
    private AgentDecisionAuditService agentDecisionAuditService;
    ...
    private PageResult<AgentDecisionAudit> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentDecisionAudit> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentDecisionAuditService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_DECISION_AUDIT", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentDecisionAuditMetricsSummary> metrics = businessService.findAllView(AgentDecisionAuditMetricsSummary.class);
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ...
                            // businessService.removeFromID(AgentDecisionAudit.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_DECISION_AUDIT", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
