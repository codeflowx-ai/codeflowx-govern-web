...
/**
 * ViewModel para búsqueda y listado de AgentCollaboration
...
public class AgentCollaborationOverviewViewModel extends BaseFront<AgentCollaborationOverviewViewModel> {
    ...
    private PageResult<AgentCollaboration> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentCollaborationService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTCOLLABORATIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtcreatedby");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentCollaborationMetricsSummary> metrics = businessService.findAllView(AgentCollaborationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentCollaborationService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTCOLLABORATIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
