...
/**
 * ViewModel para búsqueda y listado de AgentInteraction
...
public class AgentInteractionOverviewViewModel extends BaseFront<AgentInteractionOverviewViewModel> {
    ...
    private PageResult<AgentInteraction> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentInteraction> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentInteractionService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTINTERACTIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtuserid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentInteractionMetricsSummary> metrics = businessService.findAllView(AgentInteractionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentInteractionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTINTERACTIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
