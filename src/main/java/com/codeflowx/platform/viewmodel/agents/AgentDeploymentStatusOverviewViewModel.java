...
/**
 * ViewModel para búsqueda y listado de AgentDeploymentStatus
...
public class AgentDeploymentStatusOverviewViewModel extends BaseFront<AgentDeploymentStatusOverviewViewModel> {
    ...
    private PageResult<AgentDeploymentStatus> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentDeploymentStatus> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentDeploymentStatusService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_DEPLOYMENT_STATUS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentDeploymentStatusMetricsSummary> metrics = businessService.findAllView(AgentDeploymentStatusMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(AgentDeploymentStatus.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_DEPLOYMENT_STATUS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
