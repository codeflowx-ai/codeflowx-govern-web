...
import com.codeflowx.govern.entity.views.agents.AgentErrorAnalysis;
import com.codeflowx.admin.Ssoractividad;
import codeflowx.nocode.persist.BusinessService;
import com.codeflowx.govern.service.agents.AgentService;
import com.codeflowx.govern.service.agents.AgentErrorAnalysisService;
...
/**
 * ViewModel para búsqueda y listado de AgentErrorAnalysis
...
public class AgentErrorAnalysisOverviewViewModel extends BaseFront<AgentErrorAnalysisOverviewViewModel> {
    ...
    @WireVariable
    private AgentErrorAnalysisService agentErrorAnalysisService;
    ...
    private PageResult<AgentErrorAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentErrorAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentErrorAnalysisService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_ERROR_ANALYSIS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentErrorAnalysisMetricsSummary> metrics = businessService.findAllView(AgentErrorAnalysisMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(AgentErrorAnalysis.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_ERROR_ANALYSIS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
