...
/**
 * ViewModel para búsqueda y listado de AgentCompliance
...
public class AgentComplianceOverviewViewModel extends BaseFront<AgentComplianceOverviewViewModel> {
    ...
    private PageResult<AgentCompliance> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentComplianceService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTCOMPLIANCE", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtassessmentfrequency");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentComplianceMetricsSummary> metrics = businessService.findAllView(AgentComplianceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentComplianceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTCOMPLIANCE", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
