...
import com.codeflowx.govern.entity.views.agents.AgentWorkflowAnalytics;
import com.codeflowx.admin.Ssoractividad;
import codeflowx.nocode.persist.BusinessService;
import com.codeflowx.govern.service.agents.AgentWorkflowService;
import com.codeflowx.govern.service.agents.AgentWorkflowAnalyticsService;
...
/**
 * ViewModel para búsqueda y listado de AgentWorkflowAnalytics
...
public class AgentWorkflowAnalyticsOverviewViewModel extends BaseFront<AgentWorkflowAnalyticsOverviewViewModel> {
    ...
    @WireVariable
    private AgentWorkflowAnalyticsService agentWorkflowAnalyticsService;
    ...
    private PageResult<AgentWorkflowAnalytics> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentWorkflowAnalytics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentWorkflowAnalyticsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_WORKFLOW_ANALYTICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentWorkflowAnalyticsMetricsSummary> metrics = businessService.findAllView(AgentWorkflowAnalyticsMetricsSummary.class);
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ...
                            // businessService.removeFromID(AgentWorkflowAnalytics.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_WORKFLOW_ANALYTICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
