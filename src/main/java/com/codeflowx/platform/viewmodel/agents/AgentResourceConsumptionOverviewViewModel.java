...
import com.codeflowx.govern.entity.views.agents.AgentResourceConsumption;
import com.codeflowx.admin.Ssoractividad;
import codeflowx.nocode.persist.BusinessService;
import com.codeflowx.govern.service.agents.AgentService;
import com.codeflowx.govern.service.agents.AgentResourceConsumptionService;
...
/**
 * ViewModel para búsqueda y listado de AgentResourceConsumption
...
public class AgentResourceConsumptionOverviewViewModel extends BaseFront<AgentResourceConsumptionOverviewViewModel> {
    ...
    @WireVariable
    private AgentResourceConsumptionService agentResourceConsumptionService;
    ...
    private PageResult<AgentResourceConsumption> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentResourceConsumption> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentResourceConsumptionService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_RESOURCE_CONSUMPTION", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentResourceConsumptionMetricsSummary> metrics = businessService.findAllView(AgentResourceConsumptionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(AgentResourceConsumption.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_RESOURCE_CONSUMPTION", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
