...
/**
 * ViewModel para búsqueda y listado de AgentAlert
...
public class AgentAlertOverviewViewModel extends BaseFront<AgentAlertOverviewViewModel> {
    ...
    private PageResult<AgentAlert> pageResult;
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTALERTS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtalertcategory");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentAlertMetricsSummary> metrics = businessService.findAllView(AgentAlertMetricsSummary.class);
