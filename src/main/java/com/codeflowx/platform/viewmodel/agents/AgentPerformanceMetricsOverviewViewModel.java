...
/**
 * ViewModel para búsqueda y listado de AgentPerformanceMetrics
...
public class AgentPerformanceMetricsOverviewViewModel extends BaseFront<AgentPerformanceMetricsOverviewViewModel> {
    ...
    private PageResult<AgentPerformanceMetrics> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentPerformanceMetrics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentPerformanceMetricsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_PERFORMANCE_METRICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentPerformanceMetricsMetricsSummary> metrics = businessService.findAllView(AgentPerformanceMetricsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(AgentPerformanceMetrics.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_PERFORMANCE_METRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
