...
/**
 * ViewModel para búsqueda y listado de AgentDomain
...
public class AgentDomainOverviewViewModel extends BaseFront<AgentDomainOverviewViewModel> {
    ...
    private PageResult<AgentDomain> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentDomainService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTDOMAINS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtdomainname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentDomainMetricsSummary> metrics = businessService.findAllView(AgentDomainMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentDomainService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTDOMAINS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
