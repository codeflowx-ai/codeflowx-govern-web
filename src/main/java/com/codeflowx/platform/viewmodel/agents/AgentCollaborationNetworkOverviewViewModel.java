...
import com.codeflowx.govern.entity.views.agents.AgentCollaborationNetwork;
import com.codeflowx.admin.Ssoractividad;
import codeflowx.nocode.persist.BusinessService;
import com.codeflowx.govern.service.agents.AgentCollaborationService;
import com.codeflowx.govern.service.agents.AgentCollaborationNetworkService;
...
/**
 * ViewModel para búsqueda y listado de AgentCollaborationNetwork
...
public class AgentCollaborationNetworkOverviewViewModel extends BaseFront<AgentCollaborationNetworkOverviewViewModel> {
    ...
    @WireVariable
    private AgentCollaborationNetworkService agentCollaborationNetworkService;
    ...
    private PageResult<AgentCollaborationNetwork> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentCollaborationNetwork> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentCollaborationNetworkService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_COLLABORATION_NETWORK", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentCollaborationNetworkMetricsSummary> metrics = businessService.findAllView(AgentCollaborationNetworkMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Las views son de solo lectura, no se pueden eliminar
                            // businessService.removeFromID(AgentCollaborationNetwork.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_COLLABORATION_NETWORK", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
