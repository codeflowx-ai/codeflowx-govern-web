...
/**
 * ViewModel para búsqueda y listado de AgentWorkflowExecution
...
public class AgentWorkflowExecutionOverviewViewModel extends BaseFront<AgentWorkflowExecutionOverviewViewModel> {
    ...
    private PageResult<AgentWorkflowExecution> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentWorkflowExecution> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTWORKFLOWEXECUTIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtexecutionid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentWorkflowExecutionMetricsSummary> metrics = businessService.findAllView(AgentWorkflowExecutionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(AgentWorkflowExecution.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTWORKFLOWEXECUTIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
