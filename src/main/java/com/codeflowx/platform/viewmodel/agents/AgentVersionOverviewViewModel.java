...
/**
 * ViewModel para búsqueda y listado de AgentVersion
...
public class AgentVersionOverviewViewModel extends BaseFront<AgentVersionOverviewViewModel> {
    ...
    private PageResult<AgentVersion> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentVersionService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTVERSIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtversion");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentVersionMetricsSummary> metrics = businessService.findAllView(AgentVersionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentVersionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTVERSIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
