...
/**
 * ViewModel para búsqueda y listado de AgentBiasDetection
...
public class AgentBiasDetectionOverviewViewModel extends BaseFront<AgentBiasDetectionOverviewViewModel> {
    ...
    private PageResult<AgentBiasDetection> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentBiasDetectionService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTBIASDETECTIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtbiascategory");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentBiasDetectionMetricsSummary> metrics = businessService.findAllView(AgentBiasDetectionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentBiasDetectionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTBIASDETECTIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
