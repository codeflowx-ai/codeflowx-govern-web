...
/**
 * ViewModel para búsqueda y listado de AgentWorkflow
...
public class AgentWorkflowOverviewViewModel extends BaseFront<AgentWorkflowOverviewViewModel> {
    ...
    private PageResult<AgentWorkflow> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentWorkflowService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTWORKFLOWS", null, 
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentWorkflowMetricsSummary> metrics = businessService.findAllView(AgentWorkflowMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentWorkflowService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTWORKFLOWS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
