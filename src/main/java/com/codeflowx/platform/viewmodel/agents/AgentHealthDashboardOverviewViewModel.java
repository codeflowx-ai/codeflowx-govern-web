...
/**
 * ViewModel para búsqueda y listado de AgentHealthDashboard
...
public class AgentHealthDashboardOverviewViewModel extends BaseFront<AgentHealthDashboardOverviewViewModel> {
    ...
    private PageResult<AgentHealthDashboard> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentHealthDashboard> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentHealthDashboardService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_HEALTH_DASHBOARD", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentHealthDashboardMetricsSummary> metrics = businessService.findAllView(AgentHealthDashboardMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(AgentHealthDashboard.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_HEALTH_DASHBOARD", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
