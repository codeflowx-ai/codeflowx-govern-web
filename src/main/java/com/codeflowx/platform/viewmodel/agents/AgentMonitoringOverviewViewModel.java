...
/**
 * ViewModel para búsqueda y listado de AgentMonitoring
...
public class AgentMonitoringOverviewViewModel extends BaseFront<AgentMonitoringOverviewViewModel> {
    ...
    private PageResult<AgentMonitoring> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentMonitoringService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTMONITORING", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtmetricname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentMonitoringMetricsSummary> metrics = businessService.findAllView(AgentMonitoringMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentMonitoringService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTMONITORING", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
