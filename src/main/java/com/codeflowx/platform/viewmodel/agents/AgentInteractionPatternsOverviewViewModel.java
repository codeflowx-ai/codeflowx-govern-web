...
import com.codeflowx.govern.entity.views.agents.AgentInteractionPatterns;
...
/**
 * ViewModel para búsqueda y listado de AgentInteractionPatterns
...
public class AgentInteractionPatternsOverviewViewModel extends BaseFront<AgentInteractionPatternsOverviewViewModel> {
    ...
    @WireVariable
    private AgentInteractionPatternsService agentInteractionPatternsService;
    ...
    private PageResult<AgentInteractionPatterns> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentInteractionPatterns> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentInteractionPatternsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_INTERACTION_PATTERNS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentInteractionPatternsMetricsSummary> metrics = businessService.findAllView(AgentInteractionPatternsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(AgentInteractionPatterns.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_INTERACTION_PATTERNS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
