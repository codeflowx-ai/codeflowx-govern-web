...
/**
 * ViewModel para búsqueda y listado de AgentTransparency
...
public class AgentTransparencyOverviewViewModel extends BaseFront<AgentTransparencyOverviewViewModel> {
    ...
    private PageResult<AgentTransparency> pageResult;
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTTRANSPARENCY", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtalgorithmdisclosure");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentTransparencyMetricsSummary> metrics = businessService.findAllView(AgentTransparencyMetricsSummary.class);
