...
/**
 * ViewModel para búsqueda y listado de AgentEthicsAssessment
...
public class AgentEthicsAssessmentOverviewViewModel extends BaseFront<AgentEthicsAssessmentOverviewViewModel> {
    ...
    private PageResult<AgentEthicsAssessment> pageResult;
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTETHICSASSESSMENTS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtalgorithmused");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentEthicsAssessmentMetricsSummary> metrics = businessService.findAllView(AgentEthicsAssessmentMetricsSummary.class);
