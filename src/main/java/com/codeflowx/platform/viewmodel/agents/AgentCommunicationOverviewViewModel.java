...
/**
 * ViewModel para búsqueda y listado de AgentCommunication
...
public class AgentCommunicationOverviewViewModel extends BaseFront<AgentCommunicationOverviewViewModel> {
    ...
    private PageResult<AgentCommunication> pageResult;
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTCOMMUNICATIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtsubject");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentCommunicationMetricsSummary> metrics = businessService.findAllView(AgentCommunicationMetricsSummary.class);
