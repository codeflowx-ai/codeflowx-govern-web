...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de AgentCollaboration
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class AgentCollaborationDetailViewModel extends BaseFront<AgentCollaborationDetailViewModel> {
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxagentcollaboration);
        } else {
            log.error("Modo inválido o falta idxagentcollaboration");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentAgentCollaboration.getAgtstatus() == null || currentAgentCollaboration.getAgtstatus().trim().isEmpty()) {
            errors.append("- Status\n");
        }
        if (currentAgentCollaboration.getAgtcreatedby() == null || currentAgentCollaboration.getAgtcreatedby().trim().isEmpty()) {
            errors.append("- Created By\n");
        }
        if (currentAgentCollaboration.getAgtcreatedby() != null && currentAgentCollaboration.getAgtcreatedby().length() > 255) {
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxagentcollaboration);
        params.put("action", Action.LOAD);
        appendPage("plataforma/agents/agents-overview.zul", page.getFellow(IDDESKTOP), params);
    }
    ...
    public void destroy() {
        ...
        try {
            ...
            if (availableAgtcollaborationtypes != null) {
                ...
                availableAgtcollaborationtypes = null;
            }
