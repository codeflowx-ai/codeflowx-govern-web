...
/**
 * ViewModel para búsqueda y listado de AgentDeployment
...
public class AgentDeploymentOverviewViewModel extends BaseFront<AgentDeploymentOverviewViewModel> {
    ...
    private PageResult<AgentDeployment> pageResult;
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTDEPLOYMENTS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtdeploymentname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentDeploymentMetricsSummary> metrics = businessService.findAllView(AgentDeploymentMetricsSummary.class);
