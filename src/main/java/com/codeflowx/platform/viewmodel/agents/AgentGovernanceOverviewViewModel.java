...
/**
 * ViewModel para búsqueda y listado de AgentGovernance
...
public class AgentGovernanceOverviewViewModel extends BaseFront<AgentGovernanceOverviewViewModel> {
    ...
    private PageResult<AgentGovernance> pageResult;
    
    // ========== Filtros ==========
    private String searchTerm = "";
    private String statusFilter = "ALL";
    private String agtenforcementlevelFilter = "ALL";
    private String agtpolicytypeFilter = "ALL";
    private String agtpriorityFilter = "ALL";
    private String agtstatusFilter = "ALL";
    
    // ========== Datos ==========
    private List<AgentGovernance> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentGovernanceService.findAll(pageParams, criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "AGTAGENTGOVERNANCE", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agtpolicyname");
        ...
        if (!"ALL".equals(agtenforcementlevelFilter)) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.EQUALS, "agtenforcementlevel");
            criteria.setValues(new Object[]{agtenforcementlevelFilter});
            criterias.addCriteria(criteria);
        }
        
        if (!"ALL".equals(agtpolicytypeFilter)) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.EQUALS, "agtpolicytype");
            criteria.setValues(new Object[]{agtpolicytypeFilter});
            criterias.addCriteria(criteria);
        }
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentGovernanceMetricsSummary> metrics = businessService.findAllView(AgentGovernanceMetricsSummary.class);
    ...
    public void clearFilters() {
        ...
        searchTerm = "";
        statusFilter = "ALL";
        agtenforcementlevelFilter = "ALL";
        agtpolicytypeFilter = "ALL";
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/agents/agents-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            agentGovernanceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "AGTAGENTGOVERNANCE", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
