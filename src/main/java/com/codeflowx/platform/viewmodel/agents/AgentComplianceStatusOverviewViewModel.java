...
/**
 * ViewModel para búsqueda y listado de AgentComplianceStatus
...
public class AgentComplianceStatusOverviewViewModel extends BaseFront<AgentComplianceStatusOverviewViewModel> {
    ...
    private PageResult<AgentComplianceStatus> pageResult;
    ...
    // ========== Datos ==========
    private List<AgentComplianceStatus> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = agentComplianceStatusService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AGENT_COMPLIANCE_STATUS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AgentComplianceStatusMetricsSummary> metrics = businessService.findAllView(AgentComplianceStatusMetricsSummary.class);
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ...
                            // businessService.removeFromID(AgentComplianceStatus.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_AGENT_COMPLIANCE_STATUS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
