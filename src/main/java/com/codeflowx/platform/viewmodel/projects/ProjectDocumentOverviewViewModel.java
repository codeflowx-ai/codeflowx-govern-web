...
/**
 * ViewModel para búsqueda y listado de ProjectDocument
...
public class ProjectDocumentOverviewViewModel extends BaseFront<ProjectDocumentOverviewViewModel>{
    ...
    private PageResult<ProjectDocument> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectDocument> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectDocumentService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTDOCUMENTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "documentname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectDocumentMetricsSummary> metrics = businessService.findAllView(ProjectDocumentMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectDocumentService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTDOCUMENTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
