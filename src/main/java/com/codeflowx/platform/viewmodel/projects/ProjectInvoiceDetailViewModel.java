...
public class ProjectInvoiceDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentProjectInvoice = businessService.findById(ProjectInvoice.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentProjectInvoice);
                ...
                businessService.update(currentProjectInvoice);
