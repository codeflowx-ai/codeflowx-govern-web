...
/**
 * ViewModel para búsqueda y listado de ProjectCostEstimator
...
public class ProjectCostEstimatorOverviewViewModel extends BaseFront<ProjectCostEstimatorOverviewViewModel>{
    ...
    private PageResult<ProjectCostEstimator> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectCostEstimator> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectCostEstimatorService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJCOSTESTIMATORS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "prjestimationname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectCostEstimatorMetricsSummary> metrics = businessService.findAllView(ProjectCostEstimatorMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectCostEstimatorService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJCOSTESTIMATORS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
