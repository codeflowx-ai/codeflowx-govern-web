...
/**
 * ViewModel para búsqueda y listado de Project
...
public class ProjectOverviewViewModel extends BaseFront<ProjectOverviewViewModel>{
    ...
    private PageResult<Project> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectMetricsSummary> metrics = businessService.findAllView(ProjectMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo ha creado el modelo lanzar excepción para que no interrumpa el flujo normal
        }
    }
