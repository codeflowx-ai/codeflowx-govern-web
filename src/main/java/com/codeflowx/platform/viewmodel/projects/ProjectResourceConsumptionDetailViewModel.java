...
public class ProjectResourceConsumptionDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentProjectResourceConsumption = businessService.findById(ProjectResourceConsumption.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentProjectResourceConsumption);
                ...
                businessService.update(currentProjectResourceConsumption);
