...
/**
 * ViewModel para búsqueda y listado de ProjectRequirement
...
public class ProjectRequirementOverviewViewModel extends BaseFront<ProjectRequirementOverviewViewModel>{
    ...
    private PageResult<ProjectRequirement> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectRequirement> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectRequirementService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTREQUIREMENTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "requirementname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectRequirementMetricsSummary> metrics = businessService.findAllView(ProjectRequirementMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectRequirementService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTREQUIREMENTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
