...
/**
 * ViewModel para búsqueda y listado de ProjectArtifact
...
public class ProjectArtifactOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectArtifactMetricsSummary> metrics = businessService.findAllView(ProjectArtifactMetricsSummary.class);
