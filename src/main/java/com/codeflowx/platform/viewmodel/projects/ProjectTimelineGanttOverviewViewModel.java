...
import com.codeflowx.govern.entity.views.projects.ProjectTimelineGantt;
import com.codeflowx.govern.service.projects.ProjectTimelineGanttService;
...
/**
 * ViewModel para búsqueda y listado de ProjectTimelineGantt
...
public class ProjectTimelineGanttOverviewViewModel extends BaseFront<ProjectTimelineGanttOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private ProjectTimelineGanttService projectTimelineGanttService;
    ...
    private PageResult<ProjectTimelineGantt> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectTimelineGantt> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectTimelineGanttService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROJECT_TIMELINE_GANTT", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectTimelineGanttMetricsSummary> metrics = businessService.findAllView(ProjectTimelineGanttMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ProjectTimelineGantt es una VIEW, no permite eliminación
                            // businessService.removeFromID(ProjectTimelineGantt.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW ProjectTimelineGantt (ID={}) - Operación no permitida", itemId);
