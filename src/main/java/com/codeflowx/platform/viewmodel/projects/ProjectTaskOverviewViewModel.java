...
/**
 * ViewModel para búsqueda y listado de ProjectTask
...
public class ProjectTaskOverviewViewModel extends BaseFront<ProjectTaskOverviewViewModel>{
    ...
    private PageResult<ProjectTask> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectTask> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectTaskService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTTASKS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "taskname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectTaskMetricsSummary> metrics = businessService.findAllView(ProjectTaskMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectTaskService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTTASKS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
