...
/**
 * ViewModel para búsqueda y listado de ProjectPortfolioDashboard
...
public class ProjectPortfolioDashboardOverviewViewModel extends BaseFront<ProjectPortfolioDashboardOverviewViewModel>{
    ...
    private PageResult<ProjectPortfolioDashboard> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectPortfolioDashboard> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectPortfolioDashboardService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROJECT_PORTFOLIO_DASHBOARD", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectPortfolioDashboardMetricsSummary> metrics = businessService.findAllView(ProjectPortfolioDashboardMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ProjectPortfolioDashboard es una VIEW, no permite eliminación
                            // businessService.removeFromID(ProjectPortfolioDashboard.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW ProjectPortfolioDashboard (ID={}) - Operación no permitida", itemId);
