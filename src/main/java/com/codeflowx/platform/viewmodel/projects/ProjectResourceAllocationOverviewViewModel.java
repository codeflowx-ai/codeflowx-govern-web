...
/**
 * ViewModel para búsqueda y listado de ProjectResourceAllocation
...
public class ProjectResourceAllocationOverviewViewModel extends BaseFront<ProjectResourceAllocationOverviewViewModel>{
    ...
    private PageResult<ProjectResourceAllocation> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectResourceAllocation> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectResourceAllocationService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROJECT_RESOURCE_ALLOCATION", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectResourceAllocationMetricsSummary> metrics = businessService.findAllView(ProjectResourceAllocationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ProjectResourceAllocation es una VIEW, no permite eliminación
                            // businessService.removeFromID(ProjectResourceAllocation.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW ProjectResourceAllocation (ID={}) - Operación no permitida", itemId);
