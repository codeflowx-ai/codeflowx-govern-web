...
public class ProjectStackDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentProjectStack = businessService.findById(ProjectStack.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentProjectStack);
                ...
                businessService.update(currentProjectStack);
