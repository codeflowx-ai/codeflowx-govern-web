...
public class ProjectTaskDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentProjectTask = businessService.findById(ProjectTask.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentProjectTask);
                ...
                businessService.update(currentProjectTask);
