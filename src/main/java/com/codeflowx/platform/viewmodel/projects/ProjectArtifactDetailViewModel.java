...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de ProjectArtifact
 */
@Slf4j
@Getter
@Setter
...
public class ProjectArtifactDetailViewModel extends MasterPage {
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxprojectartifact);
        } else {
            log.error("Modo inválido o falta idxprojectartifact");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentProjectArtifact.getArtifactid() == null) {
            errors.append("- Artifact Id\n");
        }
        if (currentProjectArtifact.getArtifactname() == null || currentProjectArtifact.getArtifactname().trim().isEmpty()) {
            errors.append("- Artifact Name\n");
        }
        if (currentProjectArtifact.getArtifactname() != null && currentProjectArtifact.getArtifactname().length() > 100) {
            errors.append("- Artifact Name no puede exceder 100 caracteres\n");
        }
        if (currentProjectArtifact.getRole() == null || currentProjectArtifact.getRole().trim().isEmpty()) {
            errors.append("- Role\n");
        }
        if (currentProjectArtifact.getAddedat() == null) {
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxprojectartifact);
        params.put("action", Action.LOAD);
        appendPage("plataforma/projects/projects-overview.zul", page.getFellow(IDDESKTOP), params);
    }
