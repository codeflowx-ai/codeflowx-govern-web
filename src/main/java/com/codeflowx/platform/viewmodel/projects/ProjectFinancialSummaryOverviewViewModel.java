...
/**
 * ViewModel para búsqueda y listado de ProjectFinancialSummary
...
public class ProjectFinancialSummaryOverviewViewModel extends BaseFront<ProjectFinancialSummaryOverviewViewModel>{
    ...
    private PageResult<ProjectFinancialSummary> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectFinancialSummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectFinancialSummaryService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROJECT_FINANCIAL_SUMMARY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectFinancialSummaryMetricsSummary> metrics = businessService.findAllView(ProjectFinancialSummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ProjectFinancialSummary es una VIEW, no permite eliminación
                            // businessService.removeFromID(ProjectFinancialSummary.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW ProjectFinancialSummary (ID={}) - Operación no permitida", itemId);
