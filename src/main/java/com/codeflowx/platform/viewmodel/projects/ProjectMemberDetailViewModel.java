...
public class ProjectMemberDetailViewModel extends BaseFront<ProjectMemberDetailViewModel>{
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentProjectMember = projectMemberService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentProjectMember = projectMemberService.create(currentProjectMember);
                ...
                currentProjectMember = projectMemberService.update(currentProjectMember);
