...
/**
 * ViewModel para búsqueda y listado de ProjectInvoice
...
public class ProjectInvoiceOverviewViewModel extends BaseFront<ProjectInvoiceOverviewViewModel>{
    ...
    private PageResult<ProjectInvoice> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectInvoice> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectInvoiceService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJINVOICES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "prjinvoicenumber");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectInvoiceMetricsSummary> metrics = businessService.findAllView(ProjectInvoiceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectInvoiceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJINVOICES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
