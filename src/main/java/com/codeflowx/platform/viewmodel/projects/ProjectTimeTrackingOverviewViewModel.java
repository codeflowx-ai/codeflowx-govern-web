...
/**
 * ViewModel para búsqueda y listado de ProjectTimeTracking
...
public class ProjectTimeTrackingOverviewViewModel extends BaseFront<ProjectTimeTrackingOverviewViewModel>{
    ...
    private PageResult<ProjectTimeTracking> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectTimeTracking> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectTimeTrackingService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTTIMETRACKING", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "taskdescription");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectTimeTrackingMetricsSummary> metrics = businessService.findAllView(ProjectTimeTrackingMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectTimeTrackingService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTTIMETRACKING", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
