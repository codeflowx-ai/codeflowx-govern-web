...
import com.codeflowx.govern.entity.views.projects.ProjectRoiAnalysis;
import com.codeflowx.govern.service.projects.ProjectRoiAnalysisService;
...
/**
 * ViewModel para búsqueda y listado de ProjectRoiAnalysis
...
public class ProjectRoiAnalysisOverviewViewModel extends BaseFront<ProjectRoiAnalysisOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private ProjectRoiAnalysisService projectRoiAnalysisService;
    ...
    private PageResult<ProjectRoiAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectRoiAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectRoiAnalysisService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROJECT_ROI_ANALYSIS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectRoiAnalysisMetricsSummary> metrics = businessService.findAllView(ProjectRoiAnalysisMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ProjectRoiAnalysis es una VIEW, no permite eliminación
                            // businessService.removeFromID(ProjectRoiAnalysis.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW ProjectRoiAnalysis (ID={}) - Operación no permitida", itemId);
