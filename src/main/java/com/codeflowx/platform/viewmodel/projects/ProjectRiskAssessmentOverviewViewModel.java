...
/**
 * ViewModel para búsqueda y listado de ProjectRiskAssessment
...
public class ProjectRiskAssessmentOverviewViewModel extends BaseFront<ProjectRiskAssessmentOverviewViewModel>{
    ...
    private PageResult<ProjectRiskAssessment> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectRiskAssessment> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectRiskAssessmentService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROJECT_RISK_ASSESSMENT", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectRiskAssessmentMetricsSummary> metrics = businessService.findAllView(ProjectRiskAssessmentMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ProjectRiskAssessment es una VIEW, no permite eliminación
                            // businessService.removeFromID(ProjectRiskAssessment.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW ProjectRiskAssessment (ID={}) - Operación no permitida", itemId);
