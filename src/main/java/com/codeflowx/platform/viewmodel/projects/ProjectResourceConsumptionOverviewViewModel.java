...
/**
 * ViewModel para búsqueda y listado de ProjectResourceConsumption
...
public class ProjectResourceConsumptionOverviewViewModel extends BaseFront<ProjectResourceConsumptionOverviewViewModel>{
    ...
    private PageResult<ProjectResourceConsumption> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectResourceConsumption> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectResourceConsumptionService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJRESOURCECONSUMPTION", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "prjimagesresolution");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectResourceConsumptionMetricsSummary> metrics = businessService.findAllView(ProjectResourceConsumptionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectResourceConsumptionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJRESOURCECONSUMPTION", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
