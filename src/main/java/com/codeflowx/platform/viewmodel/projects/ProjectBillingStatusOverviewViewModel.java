...
import com.codeflowx.govern.entity.views.projects.ProjectBillingStatus;
import com.codeflowx.govern.service.projects.ProjectBillingStatusService;
...
/**
 * ViewModel para búsqueda y listado de ProjectBillingStatus
...
public class ProjectBillingStatusOverviewViewModel extends BaseFront<ProjectBillingStatusOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private ProjectBillingStatusService projectBillingStatusService;
    ...
    private PageResult<ProjectBillingStatus> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectBillingStatus> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectBillingStatusService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROJECT_BILLING_STATUS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectBillingStatusMetricsSummary> metrics = businessService.findAllView(ProjectBillingStatusMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ProjectBillingStatus es una VIEW, no permite eliminación
                            // businessService.removeFromID(ProjectBillingStatus.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW ProjectBillingStatus (ID={}) - Operación no permitida", itemId);
