...
/**
 * ViewModel para búsqueda y listado de ProjectDomain
...
public class ProjectDomainOverviewViewModel extends BaseFront<ProjectDomainOverviewViewModel>{
    ...
    private PageResult<ProjectDomain> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectDomain> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectDomainService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTDOMAINS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "domainname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectDomainMetricsSummary> metrics = businessService.findAllView(ProjectDomainMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectDomainService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTDOMAINS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
