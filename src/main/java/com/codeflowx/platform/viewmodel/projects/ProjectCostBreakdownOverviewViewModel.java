...
/**
 * ViewModel para búsqueda y listado de ProjectCostBreakdown
...
public class ProjectCostBreakdownOverviewViewModel extends BaseFront<ProjectCostBreakdownOverviewViewModel>{
    ...
    private PageResult<ProjectCostBreakdown> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectCostBreakdown> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectCostBreakdownService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_PROJECT_COST_BREAKDOWN", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectCostBreakdownMetricsSummary> metrics = businessService.findAllView(ProjectCostBreakdownMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ProjectCostBreakdown es una VIEW, no permite eliminación
                            // businessService.removeFromID(ProjectCostBreakdown.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW ProjectCostBreakdown (ID={}) - Operación no permitida", itemId);
