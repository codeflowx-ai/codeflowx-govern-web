...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de ProjectRequirement
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class ProjectRequirementDetailViewModel extends BaseFront<ProjectRequirementDetailViewModel>{
