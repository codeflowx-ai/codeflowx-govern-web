...
public class ProjectDomainDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentProjectDomain = businessService.findById(ProjectDomain.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentProjectDomain);
                ...
                businessService.update(currentProjectDomain);
