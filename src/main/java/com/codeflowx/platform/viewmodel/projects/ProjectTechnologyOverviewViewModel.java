...
/**
 * ViewModel para búsqueda y listado de ProjectTechnology
...
public class ProjectTechnologyOverviewViewModel extends BaseFront<ProjectTechnologyOverviewViewModel>{
    ...
    private PageResult<ProjectTechnology> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectTechnology> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectTechnologyService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTTECHNOLOGIES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "technologyname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectTechnologyMetricsSummary> metrics = businessService.findAllView(ProjectTechnologyMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectTechnologyService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTTECHNOLOGIES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
