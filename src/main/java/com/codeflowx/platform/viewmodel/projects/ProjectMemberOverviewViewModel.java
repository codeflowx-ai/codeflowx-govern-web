...
/**
 * ViewModel para búsqueda y listado de ProjectMember
...
public class ProjectMemberOverviewViewModel extends BaseFront<ProjectMemberOverviewViewModel>{
    ...
    private PageResult<ProjectMember> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectMember> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectMemberService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVPROJECTMEMBERS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "username");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectMemberMetricsSummary> metrics = businessService.findAllView(ProjectMemberMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectMemberService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVPROJECTMEMBERS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
