...
/**
 * ViewModel para búsqueda y listado de ProjectROI
...
public class ProjectROIOverviewViewModel extends BaseFront<ProjectROIOverviewViewModel>{
    ...
    private PageResult<ProjectROI> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectROI> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectROIService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJROIANALYSIS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "prjvsindustry");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectROIMetricsSummary> metrics = businessService.findAllView(ProjectROIMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectROIService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJROIANALYSIS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
