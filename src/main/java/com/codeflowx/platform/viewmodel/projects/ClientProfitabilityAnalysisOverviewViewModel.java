...
/**
 * ViewModel para búsqueda y listado de ClientProfitabilityAnalysis
...
public class ClientProfitabilityAnalysisOverviewViewModel extends BaseFront<ClientProfitabilityAnalysisOverviewViewModel>{
    ...
    private PageResult<ClientProfitabilityAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<ClientProfitabilityAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_CLIENT_PROFITABILITY_ANALYSIS", null, 
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ClientProfitabilityAnalysisMetricsSummary> metrics = businessService.findAllView(ClientProfitabilityAnalysisMetricsSummary.class);
