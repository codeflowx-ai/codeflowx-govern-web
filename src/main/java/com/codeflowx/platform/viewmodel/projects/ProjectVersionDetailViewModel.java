...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de ProjectVersion
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class ProjectVersionDetailViewModel extends BaseFront<ProjectVersionDetailViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxprojectversion);
        } else {
            log.error("Modo inválido o falta idxprojectversion");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentProjectVersion.getVersionnumber() != null && currentProjectVersion.getVersionnumber().length() > 100) {
            errors.append("- Version Number no puede exceder 100 caracteres\n");
        }
        if (currentProjectVersion.getCreatedat() == null) {
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxprojectversion);
        params.put("action", Action.LOAD);
        appendPage("plataforma/projects/projects-overview.zul", page.getFellow(IDDESKTOP), params);
    }
