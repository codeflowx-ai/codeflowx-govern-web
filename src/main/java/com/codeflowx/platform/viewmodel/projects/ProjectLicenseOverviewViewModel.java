...
/**
 * ViewModel para búsqueda y listado de ProjectLicense
...
public class ProjectLicenseOverviewViewModel extends BaseFront<ProjectLicenseOverviewViewModel>{
    ...
    private PageResult<ProjectLicense> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectLicense> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectLicenseService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTLICENSES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "licensename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectLicenseMetricsSummary> metrics = businessService.findAllView(ProjectLicenseMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectLicenseService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTLICENSES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
