...
/**
 * ViewModel para búsqueda y listado de ProjectVersion
...
public class ProjectVersionOverviewViewModel extends BaseFront<ProjectVersionOverviewViewModel>{
    ...
    private PageResult<ProjectVersion> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectVersion> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectVersionService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTVERSIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "versionnumber");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectVersionMetricsSummary> metrics = businessService.findAllView(ProjectVersionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectVersionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTVERSIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
