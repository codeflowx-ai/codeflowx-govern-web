...
/**
 * ViewModel para búsqueda y listado de ProjectBillingDetail
...
public class ProjectBillingDetailOverviewViewModel extends BaseFront<ProjectBillingDetailOverviewViewModel>{
    ...
    private PageResult<ProjectBillingDetail> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectBillingDetail> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectBillingDetailService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJBILLINGDETAILS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "prjcostcategory");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectBillingDetailMetricsSummary> metrics = businessService.findAllView(ProjectBillingDetailMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectBillingDetailService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJBILLINGDETAILS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
