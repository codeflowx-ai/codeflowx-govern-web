...
/**
 * ViewModel para búsqueda y listado de ProjectStack
...
public class ProjectStackOverviewViewModel extends BaseFront<ProjectStackOverviewViewModel>{
    ...
    private PageResult<ProjectStack> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectStack> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectStackService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTSTACKS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "stackname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectStackMetricsSummary> metrics = businessService.findAllView(ProjectStackMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectStackService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTSTACKS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
