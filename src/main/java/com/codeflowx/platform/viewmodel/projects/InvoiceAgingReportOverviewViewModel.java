...
import com.codeflowx.govern.entity.views.projects.InvoiceAgingReport;
import com.codeflowx.govern.service.projects.InvoiceAgingReportService;
...
/**
 * ViewModel para búsqueda y listado de InvoiceAgingReport
...
public class InvoiceAgingReportOverviewViewModel extends BaseFront<InvoiceAgingReportOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private InvoiceAgingReportService invoiceAgingReportService;

    @WireVariable
    private BusinessService businessService; // Mantener para auditoría (Ssoractividad) y initDao
    ...
    private PageResult<InvoiceAgingReport> pageResult;
    ...
    // ========== Datos ==========
    private List<InvoiceAgingReport> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = invoiceAgingReportService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_INVOICE_AGING_REPORT", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InvoiceAgingReportMetricsSummary> metrics = businessService.findAllView(InvoiceAgingReportMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // InvoiceAgingReport es una VIEW, no permite eliminación
                            // businessService.removeFromID(InvoiceAgingReport.class, itemId);
                            log.warn("Intento de eliminar registro de VIEW InvoiceAgingReport (ID={}) - Operación no permitida", itemId);
                            Messagebox.show("No se puede eliminar un registro de una vista de solo lectura",
                                "Error", Messagebox.OK, Messagebox.ERROR);
                            // logActivity("BORRAR", "V_INVOICE_AGING_REPORT", itemId, "Eliminado registro ID: " + itemId);
                            // loadData();
                        } catch (Exception e) {
