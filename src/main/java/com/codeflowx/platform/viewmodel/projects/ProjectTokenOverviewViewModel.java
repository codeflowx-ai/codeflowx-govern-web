...
/**
 * ViewModel para búsqueda y listado de ProjectToken
...
public class ProjectTokenOverviewViewModel extends BaseFront<ProjectTokenOverviewViewModel>{
    ...
    private PageResult<ProjectToken> pageResult;
    ...
    // ========== Datos ==========
    private List<ProjectToken> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = projectTokenService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PRJPROJECTTOKENS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "tokenname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProjectTokenMetricsSummary> metrics = businessService.findAllView(ProjectTokenMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            projectTokenService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PRJPROJECTTOKENS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
