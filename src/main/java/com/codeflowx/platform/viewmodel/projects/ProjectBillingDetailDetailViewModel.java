...
public class ProjectBillingDetailDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentProjectBillingDetail = businessService.findById(ProjectBillingDetail.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentProjectBillingDetail);
                ...
                businessService.update(currentProjectBillingDetail);
