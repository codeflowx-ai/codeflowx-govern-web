...
import com.codeflowx.govern.entity.views.models.ModelComparisonMetricsSummary;
import com.codeflowx.govern.service.models.ModelComparisonService;
import com.codeflowx.govern.service.models.ModelComparisonMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de ModelComparison
...
public class ModelComparisonOverviewViewModel extends BaseFront<ModelComparisonOverviewViewModel>{
    ...
    @WireVariable
    private ModelComparisonMetricsSummaryService modelComparisonMetricsSummaryService;
    @WireVariable
    ...
    private PageResult<ModelComparison> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelComparison> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelComparisonService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODMODELCOMPARISONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modcomparisonname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            List<ModelComparisonMetricsSummary> metrics = modelComparisonMetricsSummaryService.findAll();
            if (metrics != null && !metrics.isEmpty()) {
                ModelComparisonMetricsSummary summary = metrics.get(0);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelComparisonService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODMODELCOMPARISONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
    ...
    public void destroy() {
        ...
        try {
            ...
            modelComparisonMetricsSummaryService = null;
