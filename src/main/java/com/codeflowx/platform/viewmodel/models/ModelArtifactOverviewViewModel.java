...
import com.codeflowx.govern.entity.views.models.ModelArtifactMetricsSummary;
import com.codeflowx.govern.service.models.ModelArtifactService;
import com.codeflowx.govern.service.models.ModelArtifactMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de ModelArtifact
...
public class ModelArtifactOverviewViewModel extends BaseFront<ModelArtifactOverviewViewModel>{
    ...
    @WireVariable
    private ModelArtifactMetricsSummaryService modelArtifactMetricsSummaryService;
    @WireVariable
    ...
    private PageResult<ModelArtifact> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelArtifact> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelArtifactService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODMODELARTIFACTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modartifactname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            List<ModelArtifactMetricsSummary> metrics = modelArtifactMetricsSummaryService.findAll();
            if (metrics != null && !metrics.isEmpty()) {
                ModelArtifactMetricsSummary summary = metrics.get(0);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelArtifactService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODMODELARTIFACTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
    ...
    public void destroy() {
        ...
        try {
            ...
            modelArtifactMetricsSummaryService = null;
