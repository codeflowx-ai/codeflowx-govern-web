...
import com.codeflowx.govern.entity.views.models.ModelCapabilityMetricsSummary;
import com.codeflowx.govern.service.models.ModelCapabilityService;
import com.codeflowx.govern.service.models.ModelCapabilityMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de ModelCapability
...
public class ModelCapabilityOverviewViewModel extends BaseFront<ModelCapabilityOverviewViewModel>{
    ...
    @WireVariable
    private ModelCapabilityMetricsSummaryService modelCapabilityMetricsSummaryService;
    @WireVariable
    ...
    private PageResult<ModelCapability> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelCapability> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelCapabilityService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODCAPABILITIES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modbenchmarkname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            List<ModelCapabilityMetricsSummary> metrics = modelCapabilityMetricsSummaryService.findAll();
            if (metrics != null && !metrics.isEmpty()) {
                ModelCapabilityMetricsSummary summary = metrics.get(0);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelCapabilityService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODCAPABILITIES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
    ...
    public void destroy() {
        ...
        try {
            ...
            modelCapabilityMetricsSummaryService = null;
