...
/**
 * ViewModel para búsqueda y listado de ModelStageTransition
...
public class ModelStageTransitionOverviewViewModel extends BaseFront<ModelStageTransitionOverviewViewModel>{
    ...
    private PageResult<ModelStageTransition> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelStageTransition> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODMODELSTAGETRANSITIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modfromstage");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelStageTransitionMetricsSummary> metrics = businessService.findAllView(ModelStageTransitionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ModelStageTransition.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODMODELSTAGETRANSITIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
