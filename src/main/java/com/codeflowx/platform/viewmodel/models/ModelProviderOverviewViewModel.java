...
/**
 * ViewModel para búsqueda y listado de ModelProvider
...
public class ModelProviderOverviewViewModel extends BaseFront<ModelProviderOverviewViewModel>{
    ...
    private PageResult<ModelProvider> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelProvider> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODPROVIDERS", null, 
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelProviderMetricsSummary> metrics = businessService.findAllView(ModelProviderMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ModelProvider.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODPROVIDERS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
