...
import com.codeflowx.govern.entity.views.models.ModelEndpointMetricsSummary;
import com.codeflowx.govern.service.models.ModelEndpointService;
import com.codeflowx.govern.service.models.ModelEndpointMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de ModelEndpoint
...
public class ModelEndpointOverviewViewModel extends MasterPage {
    ...
    @WireVariable
    private ModelEndpointMetricsSummaryService modelEndpointMetricsSummaryService;
    @WireVariable
    ...
    private PageResult<ModelEndpoint> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelEndpoint> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelEndpointService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODENDPOINTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modendpointname");
