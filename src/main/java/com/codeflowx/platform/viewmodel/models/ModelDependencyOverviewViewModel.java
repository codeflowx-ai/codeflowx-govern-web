...
import com.codeflowx.govern.entity.views.models.ModelDependencyMetricsSummary;
import com.codeflowx.govern.service.models.ModelDependencyService;
import com.codeflowx.govern.service.models.ModelDependencyMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de ModelDependency
...
public class ModelDependencyOverviewViewModel extends BaseFront<ModelDependencyOverviewViewModel>{
    ...
    @WireVariable
    private ModelDependencyMetricsSummaryService modelDependencyMetricsSummaryService;
    @WireVariable
    ...
    private PageResult<ModelDependency> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelDependency> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelDependencyService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODMODELDEPENDENCIES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modversionconstraint");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            List<ModelDependencyMetricsSummary> metrics = modelDependencyMetricsSummaryService.findAll();
            if (metrics != null && !metrics.isEmpty()) {
                ModelDependencyMetricsSummary summary = metrics.get(0);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelDependencyService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODMODELDEPENDENCIES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
    ...
    public void destroy() {
        ...
        try {
            ...
            modelDependencyMetricsSummaryService = null;
