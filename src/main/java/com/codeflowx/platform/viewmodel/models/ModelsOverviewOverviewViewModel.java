...
/**
 * ViewModel para búsqueda y listado de ModelsOverview
...
public class ModelsOverviewOverviewViewModel extends BaseFront<ModelsOverviewOverviewViewModel>{
    ...
    // ========== Datos ==========
    private List<ModelsOverview> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_MODELS_OVERVIEW", null, 
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelsOverviewMetricsSummary> metrics = businessService.findAllView(ModelsOverviewMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ModelsOverview.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_MODELS_OVERVIEW", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
