...
/**
 * ViewModel para búsqueda y listado de ModelRecommendation
...
public class ModelRecommendationOverviewViewModel extends BaseFront<ModelRecommendationOverviewViewModel>{
    ...
    private PageResult<ModelRecommendation> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelRecommendation> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODRECOMMENDATIONS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "moduserid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelRecommendationMetricsSummary> metrics = businessService.findAllView(ModelRecommendationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ModelRecommendation.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODRECOMMENDATIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
