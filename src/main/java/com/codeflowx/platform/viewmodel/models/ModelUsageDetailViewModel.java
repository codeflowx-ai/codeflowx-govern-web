...
public class ModelUsageDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentModelUsage = businessService.findById(ModelUsage.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentModelUsage);
                ...
                businessService.update(currentModelUsage);
