...
/**
 * ViewModel para búsqueda y listado de ProviderCredential
...
public class ProviderCredentialOverviewViewModel extends BaseFront<ProviderCredentialOverviewViewModel>{
    ...
    private PageResult<ProviderCredential> pageResult;
    ...
    // ========== Datos ==========
    private List<ProviderCredential> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODPROVIDERCREDENTIALS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modcredentialname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ProviderCredentialMetricsSummary> metrics = businessService.findAllView(ProviderCredentialMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ProviderCredential.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODPROVIDERCREDENTIALS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
