...
/**
 * ViewModel para búsqueda y listado de ModelUsage
...
public class ModelUsageOverviewViewModel extends BaseFront<ModelUsageOverviewViewModel>{
    ...
    private PageResult<ModelUsage> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelUsage> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODUSAGE", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modrequestid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelUsageMetricsSummary> metrics = businessService.findAllView(ModelUsageMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ModelUsage.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODUSAGE", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
