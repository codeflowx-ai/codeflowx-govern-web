...
/**
 * ViewModel para búsqueda y listado de ModelsMetricsSummary
...
public class ModelsMetricsSummaryOverviewViewModel extends BaseFront<ModelsMetricsSummaryOverviewViewModel>{
    ...
    private PageResult<ModelsMetricsSummary> pageResult;
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_MODELS_METRICS_SUMMARY", null, 
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelsMetricsSummaryMetricsSummary> metrics = businessService.findAllView(ModelsMetricsSummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ModelsMetricsSummary.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_MODELS_METRICS_SUMMARY", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
