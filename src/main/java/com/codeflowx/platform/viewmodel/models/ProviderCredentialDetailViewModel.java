...
public class ProviderCredentialDetailViewModel extends BaseFront<ProviderCredentialDetailViewModel>{
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentProviderCredential = providerCredentialService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentProviderCredential = providerCredentialService.create(currentProviderCredential);
                ...
                currentProviderCredential = providerCredentialService.update(currentProviderCredential);
