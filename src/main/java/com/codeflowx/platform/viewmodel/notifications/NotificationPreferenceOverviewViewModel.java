...
/**
 * ViewModel para búsqueda y listado de NotificationPreference
...
public class NotificationPreferenceOverviewViewModel extends BaseFront<NotificationPreferenceOverviewViewModel>{
    ...
    private PageResult<NotificationPreference> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = notificationPreferenceService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "NTFPREFERENCES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "ntfpreferenceuserid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<NotificationPreferenceMetricsSummary> metrics = businessService.findAllView(NotificationPreferenceMetricsSummary.class);
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/notifications/notifications-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            notificationPreferenceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "NTFPREFERENCES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
