...
import com.codeflowx.govern.service.notifications.NotificationTemplateService;
...
/**
 * ViewModel para búsqueda y listado de NotificationTemplate
...
public class NotificationTemplateOverviewViewModel extends BaseFront<NotificationTemplateOverviewViewModel>{
    ...
    private PageResult<NotificationTemplate> pageResult;
    ...
    // ========== Datos ==========
    private List<NotificationTemplate> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = notificationTemplateService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "NTFTEMPLATES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "ntftemplatename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<NotificationTemplateMetricsSummary> metrics = businessService.findAllView(NotificationTemplateMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            notificationTemplateService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "NTFTEMPLATES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
