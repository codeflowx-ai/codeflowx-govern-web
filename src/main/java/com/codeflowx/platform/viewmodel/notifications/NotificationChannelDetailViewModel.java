...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de NotificationChannel
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class NotificationChannelDetailViewModel extends BaseFront<NotificationChannelDetailViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxnotificationchannel);
        } else {
            log.error("Modo inválido o falta idxnotificationchannel");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentNotificationChannel.getNtfchannelname() != null && currentNotificationChannel.getNtfchannelname().length() > 255) {
            errors.append("- Ntfchannelname no puede exceder 255 caracteres\n");
        }
        if (currentNotificationChannel.getNtfchanneltype() == null || currentNotificationChannel.getNtfchanneltype().trim().isEmpty()) {
            errors.append("- Ntfchanneltype\n");
        }
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxnotificationchannel);
        params.put("action", Action.LOAD);
        appendPage("plataforma/notifications/notifications-overview.zul", page.getFellow(IDDESKTOP), params);
    }
