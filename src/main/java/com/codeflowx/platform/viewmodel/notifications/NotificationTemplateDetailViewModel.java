...
public class NotificationTemplateDetailViewModel extends BaseFront<NotificationTemplateDetailViewModel>{
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentNotificationTemplate = notificationTemplateService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentNotificationTemplate = notificationTemplateService.create(currentNotificationTemplate);
                ...
                currentNotificationTemplate = notificationTemplateService.update(currentNotificationTemplate);
