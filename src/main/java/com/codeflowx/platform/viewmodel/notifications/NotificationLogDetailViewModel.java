...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de NotificationLog
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class NotificationLogDetailViewModel extends BaseFront<NotificationLogDetailViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxnotificationlog);
        } else {
            log.error("Modo inválido o falta idxnotificationlog");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentNotificationLog.getNtflogattempts() == null) {
            errors.append("- Ntflogattempts\n");
        }
        if (currentNotificationLog.getNtflogrecipientid() == null || currentNotificationLog.getNtflogrecipientid().trim().isEmpty()) {
            errors.append("- Ntflogrecipientid\n");
        }
        if (currentNotificationLog.getNtflogrecipientid() != null && currentNotificationLog.getNtflogrecipientid().length() > 255) {
            errors.append("- Ntflogrecipientid no puede exceder 255 caracteres\n");
        }
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxnotificationlog);
        params.put("action", Action.LOAD);
        appendPage("plataforma/notifications/notifications-overview.zul", page.getFellow(IDDESKTOP), params);
    }
