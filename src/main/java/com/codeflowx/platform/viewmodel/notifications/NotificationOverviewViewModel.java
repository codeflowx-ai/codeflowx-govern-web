...
/**
 * ViewModel para búsqueda y listado de Notification
...
public class NotificationOverviewViewModel extends BaseFront<NotificationOverviewViewModel>{
    ...
    private PageResult<Notification> pageResult;
    ...
    // ========== Datos ==========
    private List<Notification> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = notificationService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "NTFNOTIFICATIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "ntfnotificationtitle");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<NotificationMetricsSummary> metrics = businessService.findAllView(NotificationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            notificationService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "NTFNOTIFICATIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
