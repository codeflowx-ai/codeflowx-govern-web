...
/**
 * ViewModel para búsqueda y listado de NotificationLog
...
public class NotificationLogOverviewViewModel extends BaseFront<NotificationLogOverviewViewModel>{
    ...
    private PageResult<NotificationLog> pageResult;
    ...
    // ========== Datos ==========
    private List<NotificationLog> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = notificationLogService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "NTFLOGS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "ntflogerrorcode");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<NotificationLogMetricsSummary> metrics = businessService.findAllView(NotificationLogMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            notificationLogService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "NTFLOGS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
