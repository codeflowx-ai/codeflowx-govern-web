...
/**
 * ViewModel para búsqueda y listado de AnalyticsOverview
...
public class AnalyticsOverviewOverviewViewModel extends BaseFront<AnalyticsOverviewOverviewViewModel>{
    ...
    private PageResult<AnalyticsOverview> pageResult;
    ...
    // ========== Datos ==========
    private List<AnalyticsOverview> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = analyticsOverviewService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_ANALYTICS_OVERVIEW", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AnalyticsOverviewMetricsSummary> metrics = businessService.findAllView(AnalyticsOverviewMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Nota: AnalyticsOverview es una view, no se puede eliminar
                            // Si se necesita eliminar, debe hacerse sobre la entidad base
                            log.warn("Intento de eliminar view AnalyticsOverview - operación no permitida");
                            Messagebox.show("No se puede eliminar una vista. Debe eliminar la entidad base correspondiente.",
