...
public class AnalyticsReportDetailViewModel extends BaseFront<AnalyticsReportDetailViewModel>{
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentAnalyticsReport = analyticsReportService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentAnalyticsReport = analyticsReportService.create(currentAnalyticsReport);
                ...
                currentAnalyticsReport = analyticsReportService.update(currentAnalyticsReport);
