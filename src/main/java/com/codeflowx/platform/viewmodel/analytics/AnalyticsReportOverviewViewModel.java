...
/**
 * ViewModel para búsqueda y listado de AnalyticsReport
...
public class AnalyticsReportOverviewViewModel extends BaseFront<AnalyticsReportOverviewViewModel>{
    ...
    public void loadData() {
        try {
            ...
            pageResult = analyticsReportService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "ANLANALYTICSREPORTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "anlreportname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AnalyticsReportMetricsSummary> metrics = businessService.findAllView(AnalyticsReportMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            analyticsReportService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "ANLANALYTICSREPORTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
