...
/**
 * ViewModel para búsqueda y listado de AnalyticsTrends
...
public class AnalyticsTrendsOverviewViewModel extends BaseFront<AnalyticsTrendsOverviewViewModel>{
    ...
    private PageResult<AnalyticsTrends> pageResult;
    ...
    // ========== Datos ==========
    private List<AnalyticsTrends> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = analyticsTrendsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_ANALYTICS_TRENDS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AnalyticsTrendsMetricsSummary> metrics = businessService.findAllView(AnalyticsTrendsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Nota: AnalyticsTrends es una view, no se puede eliminar
                            // Si se necesita eliminar, debe hacerse sobre la entidad base
                            log.warn("Intento de eliminar view AnalyticsTrends - operación no permitida");
