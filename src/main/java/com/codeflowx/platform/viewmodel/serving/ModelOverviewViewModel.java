...
/**
 * ViewModel para búsqueda y listado de Model
...
public class ModelOverviewViewModel extends BaseFront<ModelOverviewViewModel>{
    ...
    // ========== Datos ==========
    private List<Model> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVMODELS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "srvmodelname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelMetricsSummary> metrics = businessService.findAllView(ModelMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVMODELS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
