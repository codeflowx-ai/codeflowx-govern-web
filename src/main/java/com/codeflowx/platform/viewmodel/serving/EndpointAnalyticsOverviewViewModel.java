...
/**
 * ViewModel para búsqueda y listado de EndpointAnalytics
...
public class EndpointAnalyticsOverviewViewModel extends BaseFront<EndpointAnalyticsOverviewViewModel>{
    ...
    private PageResult<EndpointAnalytics> pageResult;
    ...
    // ========== Datos ==========
    private List<EndpointAnalytics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = endpointAnalyticsService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_ENDPOINT_ANALYTICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<EndpointAnalyticsMetricsSummary> metrics = businessService.findAllView(EndpointAnalyticsMetricsSummary.class);
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        // EndpointAnalytics es una vista de solo lectura, no se puede eliminar
        Messagebox.show("EndpointAnalytics es una vista de solo lectura. No se pueden eliminar registros.",
            "Información",
            Messagebox.OK,
