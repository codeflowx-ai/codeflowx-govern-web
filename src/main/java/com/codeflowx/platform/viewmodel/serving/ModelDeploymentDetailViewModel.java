...
public class ModelDeploymentDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentModelDeployment = businessService.findById(ModelDeployment.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentModelDeployment);
                ...
                businessService.update(currentModelDeployment);
    ...
    private void loadSubsrvpredictions() {
        try {
            if (currentModelDeployment != null && currentModelDeployment.getIdxdeployment() != null) {
                ...
                PageResult<ModelPrediction> result = businessService.findAllEntity(ModelPrediction.class, collectionParams, criterias);
