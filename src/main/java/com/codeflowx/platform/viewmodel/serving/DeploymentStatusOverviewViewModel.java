...
/**
 * ViewModel para búsqueda y listado de DeploymentStatus
...
public class DeploymentStatusOverviewViewModel extends BaseFront<DeploymentStatusOverviewViewModel>{
    ...
    private PageResult<DeploymentStatus> pageResult;
    ...
    // ========== Datos ==========
    private List<DeploymentStatus> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = deploymentStatusService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_DEPLOYMENT_STATUS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<DeploymentStatusMetricsSummary> metrics = businessService.findAllView(DeploymentStatusMetricsSummary.class);
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        // DeploymentStatus es una vista de solo lectura, no se puede eliminar
        Messagebox.show("DeploymentStatus es una vista de solo lectura. No se pueden eliminar registros.",
            "Información",
            Messagebox.OK,
