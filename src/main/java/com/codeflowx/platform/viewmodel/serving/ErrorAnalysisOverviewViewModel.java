...
import com.codeflowx.govern.entity.views.serving.ErrorAnalysis;
import com.codeflowx.admin.Ssoractividad;
import com.codeflowx.govern.service.serving.ErrorAnalysisService;
...
/**
 * ViewModel para búsqueda y listado de ErrorAnalysis
...
public class ErrorAnalysisOverviewViewModel extends BaseFront<ErrorAnalysisOverviewViewModel>{
    ...
    private PageResult<ErrorAnalysis> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = errorAnalysisService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_ERROR_ANALYSIS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ErrorAnalysisMetricsSummary> metrics = businessService.findAllView(ErrorAnalysisMetricsSummary.class);
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        // ErrorAnalysis es una vista de solo lectura, no se puede eliminar
        Messagebox.show("ErrorAnalysis es una vista de solo lectura. No se pueden eliminar registros.",
            "Información",
            Messagebox.OK,
