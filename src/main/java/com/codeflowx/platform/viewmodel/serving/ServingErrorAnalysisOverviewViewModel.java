...
/**
 * ViewModel para búsqueda y listado de ServingErrorAnalysis
...
public class ServingErrorAnalysisOverviewViewModel extends BaseFront<ServingErrorAnalysisOverviewViewModel>{
    ...
    private PageResult<ServingErrorAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<ServingErrorAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = servingErrorAnalysisService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_SERVING_ERROR_ANALYSIS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ServingErrorAnalysisMetricsSummary> metrics = businessService.findAllView(ServingErrorAnalysisMetricsSummary.class);
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        // ServingErrorAnalysis es una vista de solo lectura, no se puede eliminar
        Messagebox.show("ServingErrorAnalysis es una vista de solo lectura. No se pueden eliminar registros.",
            "Información",
            Messagebox.OK,
