...
/**
 * ViewModel para búsqueda y listado de ModelVersion
...
public class ModelVersionOverviewViewModel extends MasterPage {
    ...
    private PageResult<ModelVersion> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelVersion> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelVersionService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVMODELVERSIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "srvversionnumber");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelVersionMetricsSummary> metrics = businessService.findAllView(ModelVersionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelVersionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVMODELVERSIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
