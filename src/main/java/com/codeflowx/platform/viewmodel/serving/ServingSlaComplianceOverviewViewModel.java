...
/**
 * ViewModel para búsqueda y listado de ServingSlaCompliance
...
public class ServingSlaComplianceOverviewViewModel extends BaseFront<ServingSlaComplianceOverviewViewModel>{
    ...
    private PageResult<ServingSlaCompliance> pageResult;
    ...
    // ========== Datos ==========
    private List<ServingSlaCompliance> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = servingSlaComplianceService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_SERVING_SLA_COMPLIANCE", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ServingSlaComplianceMetricsSummary> metrics = businessService.findAllView(ServingSlaComplianceMetricsSummary.class);
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        // ServingSlaCompliance es una vista de solo lectura, no se puede eliminar
        Messagebox.show("ServingSlaCompliance es una vista de solo lectura. No se pueden eliminar registros.",
            "Información",
            Messagebox.OK,
