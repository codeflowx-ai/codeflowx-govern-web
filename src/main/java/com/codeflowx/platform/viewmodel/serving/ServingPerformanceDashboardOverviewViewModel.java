...
/**
 * ViewModel para búsqueda y listado de ServingPerformanceDashboard
...
public class ServingPerformanceDashboardOverviewViewModel extends BaseFront<ServingPerformanceDashboardOverviewViewModel>{
    ...
    private PageResult<ServingPerformanceDashboard> pageResult;
    ...
    // ========== Datos ==========
    private List<ServingPerformanceDashboard> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = servingPerformanceDashboardService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_SERVING_PERFORMANCE_DASHBOARD", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ServingPerformanceDashboardMetricsSummary> metrics = businessService.findAllView(ServingPerformanceDashboardMetricsSummary.class);
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        // ServingPerformanceDashboard es una vista de solo lectura, no se puede eliminar
        Messagebox.show("ServingPerformanceDashboard es una vista de solo lectura. No se pueden eliminar registros.",
            "Información",
            Messagebox.OK,
