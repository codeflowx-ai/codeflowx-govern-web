...
/**
 * ViewModel para búsqueda y listado de ServingCostBreakdown
...
public class ServingCostBreakdownOverviewViewModel extends BaseFront<ServingCostBreakdownOverviewViewModel>{
    ...
    private PageResult<ServingCostBreakdown> pageResult;
    ...
    // ========== Datos ==========
    private List<ServingCostBreakdown> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = servingCostBreakdownService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_SERVING_COST_BREAKDOWN", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ServingCostBreakdownMetricsSummary> metrics = businessService.findAllView(ServingCostBreakdownMetricsSummary.class);
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        // ServingCostBreakdown es una vista de solo lectura, no se puede eliminar
        Messagebox.show("ServingCostBreakdown es una vista de solo lectura. No se pueden eliminar registros.",
            "Información",
            Messagebox.OK,
