...
/**
 * ViewModel para búsqueda y listado de ServingEndpoint
...
public class ServingEndpointOverviewViewModel extends BaseFront<ServingEndpointOverviewViewModel>{
    ...
    private PageResult<ServingEndpoint> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = servingEndpointService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVSERVINGENDPOINTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "endpointname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ServingEndpointMetricsSummary> metrics = businessService.findAllView(ServingEndpointMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            servingEndpointService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVSERVINGENDPOINTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
