...
/**
 * ViewModel para búsqueda y listado de DeploymentInstance
...
public class DeploymentInstanceOverviewViewModel extends BaseFront<DeploymentInstanceOverviewViewModel>{
    ...
    private PageResult<DeploymentInstance> pageResult;
    ...
    // ========== Datos ==========
    private List<DeploymentInstance> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = deploymentInstanceService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVDEPLOYMENTINSTANCES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "instanceid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Si existe DeploymentInstanceMetricsSummaryService, usar:
            // List<DeploymentInstanceMetricsSummary> metrics = deploymentInstanceMetricsSummaryService.findAll();
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/serving/serving-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            deploymentInstanceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVDEPLOYMENTINSTANCES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
