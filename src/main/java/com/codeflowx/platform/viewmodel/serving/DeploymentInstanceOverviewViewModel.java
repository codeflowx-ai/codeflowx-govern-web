...
public class DeploymentInstanceOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<DeploymentInstanceMetricsSummary> metrics = businessService.findAllView(DeploymentInstanceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(DeploymentInstance.class, itemId);
