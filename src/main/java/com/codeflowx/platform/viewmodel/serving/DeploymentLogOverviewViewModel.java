...
/**
 * ViewModel para búsqueda y listado de DeploymentLog
...
public class DeploymentLogOverviewViewModel extends BaseFront<DeploymentLogOverviewViewModel>{
    ...
    private PageResult<DeploymentLog> pageResult;
    ...
    // ========== Datos ==========
    private List<DeploymentLog> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = deploymentLogService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVDEPLOYMENTLOGS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<DeploymentLogMetricsSummary> metrics = businessService.findAllView(DeploymentLogMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            deploymentLogService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVDEPLOYMENTLOGS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
