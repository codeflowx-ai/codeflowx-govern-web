...
public class DeploymentMetricDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentDeploymentMetric = businessService.findById(DeploymentMetric.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentDeploymentMetric);
                ...
                businessService.update(currentDeploymentMetric);
