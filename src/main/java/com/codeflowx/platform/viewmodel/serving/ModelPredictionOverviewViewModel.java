...
/**
 * ViewModel para búsqueda y listado de ModelPrediction
...
public class ModelPredictionOverviewViewModel extends BaseFront<ModelPredictionOverviewViewModel>{
    ...
    private PageResult<ModelPrediction> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelPrediction> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelPredictionService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVPREDICTIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "srvpredictionsessionid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelPredictionMetricsSummary> metrics = businessService.findAllView(ModelPredictionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelPredictionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVPREDICTIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
