...
/**
 * ViewModel para búsqueda y listado de ModelMetrics
...
public class ModelMetricsOverviewViewModel extends BaseFront<ModelMetricsOverviewViewModel>{
    ...
    private PageResult<ModelMetrics> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelMetrics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelMetricsService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVMODELMETRICS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "srvmetricname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelMetricsMetricsSummary> metrics = businessService.findAllView(ModelMetricsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelMetricsService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVMODELMETRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
