...
import com.codeflowx.govern.service.serving.ServingRequestService;
...
/**
 * ViewModel para búsqueda y listado de ServingRequest
...
public class ServingRequestOverviewViewModel extends BaseFront<ServingRequestOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private ServingRequestService servingRequestService;
    ...
    private PageResult<ServingRequest> pageResult;
    ...
    // ========== Datos ==========
    private List<ServingRequest> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = servingRequestService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVSERVINGREQUESTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "requestid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ServingRequestMetricsSummary> metrics = businessService.findAllView(ServingRequestMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            servingRequestService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVSERVINGREQUESTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
