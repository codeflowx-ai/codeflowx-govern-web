...
public class ModelPredictionDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentModelPrediction = businessService.findById(ModelPrediction.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentModelPrediction);
                ...
                businessService.update(currentModelPrediction);
