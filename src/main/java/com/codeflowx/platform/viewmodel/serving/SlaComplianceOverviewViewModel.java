...
import com.codeflowx.govern.entity.views.serving.SlaCompliance;
import com.codeflowx.admin.Ssoractividad;
import com.codeflowx.govern.service.serving.SlaComplianceService;
...
/**
 * ViewModel para búsqueda y listado de SlaCompliance
...
public class SlaComplianceOverviewViewModel extends BaseFront<SlaComplianceOverviewViewModel>{
    ...
    private PageResult<SlaCompliance> pageResult;
    ...
    // ========== Datos ==========
    private List<SlaCompliance> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = slaComplianceService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_SLA_COMPLIANCE", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<SlaComplianceMetricsSummary> metrics = businessService.findAllView(SlaComplianceMetricsSummary.class);
    ...
    public void deleteItem(@BindingParam("itemId") Long itemId) {
        // SlaCompliance es una vista de solo lectura, no se puede eliminar
        Messagebox.show("SlaCompliance es una vista de solo lectura. No se pueden eliminar registros.",
            "Información",
            Messagebox.OK,
