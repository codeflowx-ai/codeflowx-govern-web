...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de DeploymentLog
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class DeploymentLogDetailViewModel extends BaseFront<DeploymentLogDetailViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxdeploymentlog);
        } else {
            log.error("Modo inválido o falta idxdeploymentlog");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentDeploymentLog.getLogmessage() == null || currentDeploymentLog.getLogmessage().trim().isEmpty()) {
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxdeploymentlog);
        params.put("action", Action.LOAD);
        appendPage("plataforma/serving/serving-overview.zul", page.getFellow(IDDESKTOP), params);
    }
