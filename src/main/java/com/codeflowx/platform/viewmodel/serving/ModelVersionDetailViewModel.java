...
import com.codeflowx.govern.entity.serving.ModelVersion;
...
public class ModelVersionDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            editing = true;
            pageTitle = "Editar: " + currentModelVersion.getSrvversiondescription();
            ...
            logActivity("CONSULTA", "SRVMODELVERSIONS", id, "Consulta: " + currentModelVersion.getSrvversiondescription());
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                ...
                logActivity("CREACION", "SRVMODELVERSIONS", currentModelVersion.getIdxmodelversion(), 
                    "Creado: " + currentModelVersion.getSrvversiondescription());
                Messagebox.show("Registro creado exitosamente",
                    "Éxito", Messagebox.OK, Messagebox.INFORMATION);
            } else {
                businessService.update(currentModelVersion);
                log.info("Registro actualizado exitosamente");
                logActivity("EDICION", "SRVMODELVERSIONS", currentModelVersion.getIdxmodelversion(), 
                    "Actualizado: " + currentModelVersion.getSrvversiondescription());
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentModelVersion.getSrvversionnumber() == null || currentModelVersion.getSrvversionnumber().trim().isEmpty()) {
            errors.append("- Srvversionnumber\n");
        }
        if (currentModelVersion.getSrvversionnumber() != null && currentModelVersion.getSrvversionnumber().length() > 50) {
            errors.append("- Srvversionnumber no puede exceder 50 caracteres\n");
        }
        if (currentModelVersion.getSrvversioncreatedat() == null) {
            errors.append("- Srvversioncreatedat\n");
        }
