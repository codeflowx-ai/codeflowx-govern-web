...
/**
 * ViewModel para búsqueda y listado de ModelDeployment
...
public class ModelDeploymentOverviewViewModel extends BaseFront<ModelDeploymentOverviewViewModel>{
    ...
    private PageResult<ModelDeployment> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelDeployment> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelDeploymentService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "SRVDEPLOYMENTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "srvdeploymentname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelDeploymentMetricsSummary> metrics = businessService.findAllView(ModelDeploymentMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelDeploymentService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "SRVDEPLOYMENTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
