...
/**
 * ViewModel para búsqueda y listado de PlatformUpdate
...
public class PlatformUpdateOverviewViewModel extends BaseFront<PlatformUpdateOverviewViewModel>{
    ...
    private PageResult<PlatformUpdate> pageResult;
    ...
    // ========== Datos ==========
    private List<PlatformUpdate> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = platformUpdateService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PLATFORMUPDATES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "downloadurl");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PlatformUpdateMetricsSummary> metrics = businessService.findAllView(PlatformUpdateMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            platformUpdateService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PLATFORMUPDATES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
