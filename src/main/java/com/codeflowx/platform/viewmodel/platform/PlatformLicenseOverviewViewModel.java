...
/**
 * ViewModel para búsqueda y listado de PlatformLicense
...
public class PlatformLicenseOverviewViewModel extends BaseFront<PlatformLicenseOverviewViewModel> {
    ...
    private PageResult<PlatformLicense> pageResult;
    ...
    // ========== Datos ==========
    private List<PlatformLicense> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = platformLicenseService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PLATFORMLICENSES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "licensekey");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PlatformLicenseMetricsSummary> metrics = businessService.findAllView(PlatformLicenseMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            platformLicenseService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PLATFORMLICENSES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
