...
/**
 * ViewModel para búsqueda y listado de RiskIndicator
...
public class RiskIndicatorOverviewViewModel extends BaseFront<RiskIndicatorOverviewViewModel>{
    ...
    private PageResult<RiskIndicator> pageResult;
    ...
    // ========== Datos ==========
    private List<RiskIndicator> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = riskIndicatorService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVRISKINDICATORS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "indicatorname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RiskIndicatorMetricsSummary> metrics = businessService.findAllView(RiskIndicatorMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            riskIndicatorService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVRISKINDICATORS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
