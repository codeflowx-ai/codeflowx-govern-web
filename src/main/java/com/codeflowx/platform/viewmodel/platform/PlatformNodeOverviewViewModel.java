...
/**
 * ViewModel para búsqueda y listado de PlatformNode
...
public class PlatformNodeOverviewViewModel extends BaseFront<PlatformNodeOverviewViewModel> {
    ...
    private PageResult<PlatformNode> pageResult;
    ...
    // ========== Datos ==========
    private List<PlatformNode> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = platformNodeService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "PLATFORMNODES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "nodename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PlatformNodeMetricsSummary> metrics = businessService.findAllView(PlatformNodeMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            platformNodeService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "PLATFORMNODES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
