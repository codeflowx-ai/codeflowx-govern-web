...
/**
 * ViewModel para búsqueda y listado de UpdateInstallation
...
public class UpdateInstallationOverviewViewModel extends BaseFront<UpdateInstallationOverviewViewModel>{
    ...
    private PageResult<UpdateInstallation> pageResult;
    ...
    // ========== Datos ==========
    private List<UpdateInstallation> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = updateInstallationService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "UPDATEINSTALLATIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "idxupdateinstallation");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<UpdateInstallationMetricsSummary> metrics = businessService.findAllView(UpdateInstallationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            updateInstallationService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "UPDATEINSTALLATIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
