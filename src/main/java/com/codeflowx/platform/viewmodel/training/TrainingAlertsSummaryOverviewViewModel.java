...
import com.codeflowx.govern.entity.views.training.TrainingAlertsSummary;
import com.codeflowx.govern.service.training.TrainingAlertsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de TrainingAlertsSummary
...
public class TrainingAlertsSummaryOverviewViewModel extends BaseFront<TrainingAlertsSummaryOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private TrainingAlertsSummaryService trainingAlertsSummaryService;
    @WireVariable
    ...
    private PageResult<TrainingAlertsSummary> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingAlertsSummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingAlertsSummaryService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_TRAINING_ALERTS_SUMMARY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingAlertsSummaryMetricsSummary> metrics = businessService.findAllView(TrainingAlertsSummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // TrainingAlertsSummary es una vista de solo lectura, no se puede eliminar
                        log.warn("Intento de eliminar vista de solo lectura: TrainingAlertsSummary ID={}", itemId);
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo ha cre         // No lanzar excepción para que no interrumpa el flujo normal
        }
    }
