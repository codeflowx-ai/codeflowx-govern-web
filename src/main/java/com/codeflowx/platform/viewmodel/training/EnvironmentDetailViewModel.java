...
public class EnvironmentDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentEnvironment = environmentService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentEnvironment = environmentService.create(currentEnvironment);
                ...
                currentEnvironment = environmentService.update(currentEnvironment);
