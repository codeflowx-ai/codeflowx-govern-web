...
/**
 * ViewModel para búsqueda y listado de TrainingArtifact
...
public class TrainingArtifactOverviewViewModel extends BaseFront<TrainingArtifactOverviewViewModel>{
    ...
    private PageResult<TrainingArtifact> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingArtifact> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingArtifactService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNTRAININGARTIFACTS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingArtifactMetricsSummary> metrics = businessService.findAllView(TrainingArtifactMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            trainingArtifactService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNTRAININGARTIFACTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
