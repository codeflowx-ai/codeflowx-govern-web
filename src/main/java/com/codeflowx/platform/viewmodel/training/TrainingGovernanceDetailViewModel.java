...
public class TrainingGovernanceDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentTrainingGovernance = businessService.findById(TrainingGovernance.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentTrainingGovernance);
                ...
                businessService.update(currentTrainingGovernance);
