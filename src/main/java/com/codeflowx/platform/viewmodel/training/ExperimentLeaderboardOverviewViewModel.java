...
/**
 * ViewModel para búsqueda y listado de ExperimentLeaderboard
...
public class ExperimentLeaderboardOverviewViewModel extends BaseFront<ExperimentLeaderboardOverviewViewModel>{
    ...
    private PageResult<ExperimentLeaderboard> pageResult;
    ...
    // ========== Datos ==========
    private List<ExperimentLeaderboard> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = experimentLeaderboardService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_EXPERIMENT_LEADERBOARD", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ExperimentLeaderboardMetricsSummary> metrics = businessService.findAllView(ExperimentLeaderboardMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // ExperimentLeaderboard es una vista de solo lectura, no se puede eliminar
                        log.warn("Intento de eliminar vista de solo lectura: ExperimentLeaderboard ID={}", itemId);
