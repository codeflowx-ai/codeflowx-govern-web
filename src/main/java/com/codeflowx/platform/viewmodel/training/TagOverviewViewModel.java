...
/**
 * ViewModel para búsqueda y listado de Tag
...
public class TagOverviewViewModel extends BaseFront<TagOverviewViewModel> {
    ...
    // ========== Datos ==========
    private List<Tag> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = tagService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNTAGS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TagMetricsSummary> metrics = businessService.findAllView(TagMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            tagService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNTAGS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
