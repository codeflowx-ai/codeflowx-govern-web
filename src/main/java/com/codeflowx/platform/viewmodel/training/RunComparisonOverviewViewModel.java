...
/**
 * ViewModel para búsqueda y listado de RunComparison
...
public class RunComparisonOverviewViewModel extends BaseFront<RunComparisonOverviewViewModel>{
    ...
    private PageResult<RunComparison> pageResult;
    ...
    // ========== Datos ==========
    private List<RunComparison> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = runComparisonService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNRUNCOMPARISONS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RunComparisonMetricsSummary> metrics = businessService.findAllView(RunComparisonMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            runComparisonService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNRUNCOMPARISONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
