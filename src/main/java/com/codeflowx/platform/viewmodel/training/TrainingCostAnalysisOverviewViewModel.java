...
/**
 * ViewModel para búsqueda y listado de TrainingCostAnalysis
...
public class TrainingCostAnalysisOverviewViewModel extends BaseFront<TrainingCostAnalysisOverviewViewModel>{
    ...
    private PageResult<TrainingCostAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingCostAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingCostAnalysisService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_TRAINING_COST_ANALYSIS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingCostAnalysisMetricsSummary> metrics = businessService.findAllView(TrainingCostAnalysisMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // TrainingCostAnalysis es una vista de solo lectura, no se puede eliminar
                        log.warn("Intento de eliminar vista de solo lectura: TrainingCostAnalysis ID={}", itemId);
