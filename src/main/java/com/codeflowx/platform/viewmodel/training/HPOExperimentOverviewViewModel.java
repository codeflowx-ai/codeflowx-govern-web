...
/**
 * ViewModel para búsqueda y listado de HPOExperiment
...
public class HPOExperimentOverviewViewModel extends BaseFront<HPOExperimentOverviewViewModel>{
    ...
    private PageResult<HPOExperiment> pageResult;
    ...
    // ========== Datos ==========
    private List<HPOExperiment> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = hpoExperimentService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNHPOEXPERIMENTS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<HPOExperimentMetricsSummary> metrics = businessService.findAllView(HPOExperimentMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            hpoExperimentService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNHPOEXPERIMENTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
