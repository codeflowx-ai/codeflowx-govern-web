...
/**
 * ViewModel para búsqueda y listado de ExperimentTemplate
...
public class ExperimentTemplateOverviewViewModel extends BaseFront<ExperimentTemplateOverviewViewModel>{
    ...
    private PageResult<ExperimentTemplate> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = experimentTemplateService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNEXPERIMENTTEMPLATES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "trnname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ExperimentTemplateMetricsSummary> metrics = businessService.findAllView(ExperimentTemplateMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            experimentTemplateService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNEXPERIMENTTEMPLATES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
