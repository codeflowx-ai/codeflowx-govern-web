...
public class TrainingExecutionDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentTrainingExecution = businessService.findById(TrainingExecution.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentTrainingExecution);
                ...
                businessService.update(currentTrainingExecution);
