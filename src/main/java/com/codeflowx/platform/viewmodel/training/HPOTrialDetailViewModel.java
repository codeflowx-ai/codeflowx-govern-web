...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de HPOTrial
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class HPOTrialDetailViewModel extends BaseFront<HPOTrialDetailViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxhpotrial);
        } else {
            log.error("Modo inválido o falta idxhpotrial");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentHPOTrial.getTrnparams() == null || currentHPOTrial.getTrnparams().trim().isEmpty()) {
            errors.append("- Params\n");
        }
        if (currentHPOTrial.getTrnstatus() == null || currentHPOTrial.getTrnstatus().trim().isEmpty()) {
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxhpotrial);
        params.put("action", Action.LOAD);
        appendPage("plataforma/training/training-overview.zul", page.getFellow(IDDESKTOP), params);
    }
