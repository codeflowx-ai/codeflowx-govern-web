...
/**
 * ViewModel para búsqueda y listado de HPOTrial
...
public class HPOTrialOverviewViewModel extends BaseFront<HPOTrialOverviewViewModel>{
    ...
    private PageResult<HPOTrial> pageResult;
    ...
    // ========== Datos ==========
    private List<HPOTrial> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = hpoTrialService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNHPOTRIALS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "trnprunereason");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<HPOTrialMetricsSummary> metrics = businessService.findAllView(HPOTrialMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            hpoTrialService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNHPOTRIALS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
