...
/**
 * ViewModel para búsqueda y listado de TrainingGovernance
...
public class TrainingGovernanceOverviewViewModel extends BaseFront<TrainingGovernanceOverviewViewModel>{
    ...
    private PageResult<TrainingGovernance> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingGovernance> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingGovernanceService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNTRAININGGOVERNANCE", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "idxtraininggovernance");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingGovernanceMetricsSummary> metrics = businessService.findAllView(TrainingGovernanceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            trainingGovernanceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNTRAININGGOVERNANCE", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
