...
/**
 * ViewModel para búsqueda y listado de ExperimentLineage
...
public class ExperimentLineageOverviewViewModel extends BaseFront<ExperimentLineageOverviewViewModel>{
    ...
    private PageResult<ExperimentLineage> pageResult;
    ...
    // ========== Datos ==========
    private List<ExperimentLineage> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = experimentLineageService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNEXPERIMENTLINEAGE", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "idxexperimentlineage");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ExperimentLineageMetricsSummary> metrics = businessService.findAllView(ExperimentLineageMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            experimentLineageService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNEXPERIMENTLINEAGE", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
