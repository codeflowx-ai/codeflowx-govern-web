...
/**
 * ViewModel para búsqueda y listado de TrainingInfrastructure
...
public class TrainingInfrastructureOverviewViewModel extends BaseFront<TrainingInfrastructureOverviewViewModel>{
    ...
    private PageResult<TrainingInfrastructure> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingInfrastructure> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingInfrastructureService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNTRAININGINFRASTRUCTURE", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "provider");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingInfrastructureMetricsSummary> metrics = businessService.findAllView(TrainingInfrastructureMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            trainingInfrastructureService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNTRAININGINFRASTRUCTURE", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo ha cr          // No lanzar excepción para que no interrumpa el flujo normal
        }
    }
