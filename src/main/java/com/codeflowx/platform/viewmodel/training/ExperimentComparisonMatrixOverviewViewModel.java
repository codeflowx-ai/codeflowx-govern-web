...
public class ExperimentComparisonMatrixOverviewViewModel extends MasterPage {
    ...
    public void loadData() {
        try {
            ...
            pageResult = businessService.findAllView(
                ExperimentComparisonMatrix.class,
                pageParams,
                criterias
            );
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ExperimentComparisonMatrixMetricsSummary> metrics = businessService.findAllView(ExperimentComparisonMatrixMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ExperimentComparisonMatrix.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_EXPERIMENT_COMPARISON_MATRIX", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
