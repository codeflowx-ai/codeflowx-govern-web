...
import com.codeflowx.govern.entity.views.training.ExperimentComparisonMatrix;
import com.codeflowx.govern.service.exception.GovernanceServiceException;
import com.codeflowx.govern.service.training.ExperimentComparisonMatrixService;
...
/**
 * ViewModel para búsqueda y listado de ExperimentComparisonMatrix
...
public class ExperimentComparisonMatrixOverviewViewModel extends BaseFront<ExperimentComparisonMatrixOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private ExperimentComparisonMatrixService experimentComparisonMatrixService;
  @WireVariable
  ...
  private PageResult<ExperimentComparisonMatrix> pageResult;
  ...
  // ========== Datos ==========
  private List<ExperimentComparisonMatrix> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = experimentComparisonMatrixService.findAll(pageParams, criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_EXPERIMENT_COMPARISON_MATRIX", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<ExperimentComparisonMatrixMetricsSummary> metrics =
      // businessService.findAllView(ExperimentComparisonMatrixMetricsSummary.class);
  ...
  public void registerItem() {
    ...
    appendPage("plataforma/training/training-detail.zul", page.getFellow(IDDESKTOP), params);
  }
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              // ExperimentComparisonMatrix es una vista de solo lectura, no se puede eliminar
              log.warn("Intento de eliminar vista de solo lectura: ExperimentComparisonMatrix ID={}", itemId);
              Messagebox.show("Las vistas de solo lectura no se pueden eliminar",
   ...
   * @param mensaje -- mensaje aclaratorio, en, model, e);
