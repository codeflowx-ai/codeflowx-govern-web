...
import com.codeflowx.govern.entity.views.training.CheckpointHistory;
import com.codeflowx.govern.service.training.CheckpointHistoryService;
...
/**
 * ViewModel para búsqueda y listado de CheckpointHistory
...
public class CheckpointHistoryOverviewViewModel extends BaseFront<CheckpointHistoryOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private CheckpointHistoryService checkpointHistoryService;
    @WireVariable
    ...
    private PageResult<CheckpointHistory> pageResult;
    ...
    // ========== Datos ==========
    private List<CheckpointHistory> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = checkpointHistoryService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_CHECKPOINT_HISTORY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<CheckpointHistoryMetricsSummary> metrics = businessService.findAllView(CheckpointHistoryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            checkpointHistoryService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_CHECKPOINT_HISTORY", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
