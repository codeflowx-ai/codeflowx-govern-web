...
/**
 * ViewModel para búsqueda y listado de Param
...
public class ParamOverviewViewModel extends BaseFront<ParamOverviewViewModel>{
    ...
    private PageResult<Param> pageResult;
    ...
    // ========== Datos ==========
    private List<Param> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = paramService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNPARAMS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "trnkey");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ParamMetricsSummary> metrics = businessService.findAllView(ParamMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            paramService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNPARAMS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo ha creado el modelo XXanzar excepción para que no interrumpa el flujo normal
        }
    }
