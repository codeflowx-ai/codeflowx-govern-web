...
/**
 * ViewModel para búsqueda y listado de TrainingMetricsSummary
...
public class TrainingMetricsSummaryOverviewViewModel extends BaseFront<TrainingMetricsSummaryOverviewViewModel>{
    ...
    private PageResult<TrainingMetricsSummary> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingMetricsSummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingMetricsSummaryService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "training_metrics_summary", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingMetricsSummaryMetricsSummary> metrics = businessService.findAllView(TrainingMetricsSummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // TrainingMetricsSummary es una vista de solo lectura, no se puede eliminar
                        log.warn("Intento de eliminar vista de solo lectura: TrainingMetricsSummary ID={}", itemId);
