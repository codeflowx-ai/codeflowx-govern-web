...
/**
 * ViewModel para búsqueda y listado de HpoProgressDashboard
...
public class HpoProgressDashboardOverviewViewModel extends BaseFront<HpoProgressDashboardOverviewViewModel>{
    ...
    private PageResult<HpoProgressDashboard> pageResult;
    ...
    // ========== Datos ==========
    private List<HpoProgressDashboard> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = hpoProgressDashboardService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_HPO_PROGRESS_DASHBOARD", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<HpoProgressDashboardMetricsSummary> metrics = businessService.findAllView(HpoProgressDashboardMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // HpoProgressDashboard es una vista de solo lectura, no se puede eliminar
                        log.warn("Intento de eliminar vista de solo lectura: HpoProgressDashboard ID={}", itemId);
