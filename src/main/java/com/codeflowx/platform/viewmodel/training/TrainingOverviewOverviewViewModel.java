...
/**
 * ViewModel para búsqueda y listado de TrainingOverview
...
public class TrainingOverviewOverviewViewModel extends BaseFront<TrainingOverviewOverviewViewModel>{
    ...
    private PageResult<TrainingOverview> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingOverview> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingOverviewService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "training_overview", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingOverviewMetricsSummary> metrics = businessService.findAllView(TrainingOverviewMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // TrainingOverview es una vista de solo lectura, no se puede eliminar
                        log.warn("Intento de eliminar vista de solo lectura: TrainingOverview ID={}", itemId);
