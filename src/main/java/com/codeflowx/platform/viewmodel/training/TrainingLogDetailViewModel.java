...
public class TrainingLogDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentTrainingLog = businessService.findById(TrainingLog.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentTrainingLog);
                ...
                businessService.update(currentTrainingLog);
