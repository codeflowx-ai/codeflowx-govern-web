...
/**
 * ViewModel para búsqueda y listado de TrainingResourceUtilization
...
public class TrainingResourceUtilizationOverviewViewModel extends BaseFront<TrainingResourceUtilizationOverviewViewModel>{
    ...
    private PageResult<TrainingResourceUtilization> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingResourceUtilization> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingResourceUtilizationService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_TRAINING_RESOURCE_UTILIZATION", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingResourceUtilizationMetricsSummary> metrics = businessService.findAllView(TrainingResourceUtilizationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // TrainingResourceUtilization es una vista de solo lectura, no se puede eliminar
                        log.warn("Intento de eliminar vista de solo lectura: TrainingResourceUtilization ID={}", itemId);
