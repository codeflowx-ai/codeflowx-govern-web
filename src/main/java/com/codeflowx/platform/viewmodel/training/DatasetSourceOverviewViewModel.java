...
/**
 * ViewModel para búsqueda y listado de DatasetSource
...
public class DatasetSourceOverviewViewModel extends BaseFront<DatasetSourceOverviewViewModel>{
    ...
    private PageResult<DatasetSource> pageResult;
    ...
    // ========== Datos ==========
    private List<DatasetSource> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = datasetSourceService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNDATASETSOURCES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "sourcename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<DatasetSourceMetricsSummary> metrics = businessService.findAllView(DatasetSourceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            datasetSourceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNDATASETSOURCES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
