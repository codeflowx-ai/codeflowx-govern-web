...
/**
 * ViewModel para búsqueda y listado de MetricStream
...
public class MetricStreamOverviewViewModel extends BaseFront<MetricStreamOverviewViewModel>{
    ...
    private PageResult<MetricStream> pageResult;
    ...
    // ========== Datos ==========
    private List<MetricStream> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = metricStreamService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNMETRICSTREAMS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "trnstreamid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<MetricStreamMetricsSummary> metrics = businessService.findAllView(MetricStreamMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            metricStreamService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNMETRICSTREAMS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
