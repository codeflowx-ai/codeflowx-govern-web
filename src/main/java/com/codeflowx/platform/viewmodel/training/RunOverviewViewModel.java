...
/**
 * ViewModel para búsqueda y listado de Run
...
public class RunOverviewViewModel extends BaseFront<RunOverviewViewModel>{
    ...
    private PageResult<Run> pageResult;
    ...
    // ========== Datos ==========
    private List<Run> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = runService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNRUNS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "trnrunuuid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RunMetricsSummary> metrics = businessService.findAllView(RunMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            runService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNRUNS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
