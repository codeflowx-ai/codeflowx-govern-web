...
/**
 * ViewModel para búsqueda y listado de Environment
...
public class EnvironmentOverviewViewModel extends BaseFront<EnvironmentOverviewViewModel>{
    ...
    private PageResult<com.codeflowx.govern.entity.training.Environment> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = environmentService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNENVIRONMENTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "trnpythonversion");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<EnvironmentMetricsSummary> metrics = businessService.findAllView(EnvironmentMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            environmentService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNENVIRONMENTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
