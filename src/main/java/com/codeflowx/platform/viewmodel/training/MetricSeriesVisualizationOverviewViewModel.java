...
import com.codeflowx.govern.entity.views.training.MetricSeriesVisualization;
import com.codeflowx.govern.service.training.MetricSeriesVisualizationService;
...
/**
 * ViewModel para búsqueda y listado de MetricSeriesVisualization
...
public class MetricSeriesVisualizationOverviewViewModel extends BaseFront<MetricSeriesVisualizationOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private MetricSeriesVisualizationService metricSeriesVisualizationService;
    @WireVariable
    ...
    private PageResult<MetricSeriesVisualization> pageResult;
    ...
    // ========== Datos ==========
    private List<MetricSeriesVisualization> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = metricSeriesVisualizationService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_METRIC_SERIES_VISUALIZATION", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<MetricSeriesVisualizationMetricsSummary> metrics = businessService.findAllView(MetricSeriesVisualizationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        // MetricSeriesVisualization es una vista de solo lectura, no se puede eliminar
                        log.warn("Intento de eliminar vista de solo lectura: MetricSeriesVisualization ID={}", itemId);
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo ha
