...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de DatasetSource
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class DatasetSourceDetailViewModel extends BaseFront<DatasetSourceDetailViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxdatasetsource);
        } else {
            log.error("Modo inválido o falta idxdatasetsource");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentDatasetSource.getSourcename() == null || currentDatasetSource.getSourcename().trim().isEmpty()) {
            errors.append("- Sourcename\n");
        }
        if (currentDatasetSource.getSourcename() != null && currentDatasetSource.getSourcename().length() > 100) {
            errors.append("- Sourcename no puede exceder 100 caracteres\n");
        }
        if (currentDatasetSource.getCreatedat() == null) {
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxdatasetsource);
        params.put("action", Action.LOAD);
        appendPage("plataforma/training/training-overview.zul", page.getFellow(IDDESKTOP), params);
    }
