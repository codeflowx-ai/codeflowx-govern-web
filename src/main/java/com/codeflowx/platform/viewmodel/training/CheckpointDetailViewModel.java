...
public class CheckpointDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentCheckpoint = businessService.findById(Checkpoint.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentCheckpoint);
                ...
                businessService.update(currentCheckpoint);
