...
public class RunDetailViewModel extends BaseFront<RunDetailViewModel>{
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo ha creado el modelo XXXXr excepción para que no interrumpa el flujo normal
        }
    }
