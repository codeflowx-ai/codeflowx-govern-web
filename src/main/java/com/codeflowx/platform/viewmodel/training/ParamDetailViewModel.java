...
public class ParamDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentParam = businessService.findById(Param.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentParam);
                ...
                businessService.update(currentParam);
