...
/**
 * ViewModel para búsqueda y listado de MetricSeries
...
public class MetricSeriesOverviewViewModel extends BaseFront<MetricSeriesOverviewViewModel>{
    ...
    private PageResult<MetricSeries> pageResult;
    ...
    // ========== Datos ==========
    private List<MetricSeries> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = metricSeriesService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNMETRICSERIES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "trnmetricname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<MetricSeriesMetricsSummary> metrics = businessService.findAllView(MetricSeriesMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            metricSeriesService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNMETRICSERIES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
