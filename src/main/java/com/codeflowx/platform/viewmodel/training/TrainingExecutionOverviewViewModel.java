...
/**
 * ViewModel para búsqueda y listado de TrainingExecution
...
public class TrainingExecutionOverviewViewModel extends BaseFront<TrainingExecutionOverviewViewModel>{
    ...
    private PageResult<TrainingExecution> pageResult;
    ...
    // ========== Datos ==========
    private List<TrainingExecution> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = trainingExecutionService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "TRNTRAININGEXECUTIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "datasetversion");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TrainingExecutionMetricsSummary> metrics = businessService.findAllView(TrainingExecutionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            trainingExecutionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "TRNTRAININGEXECUTIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
