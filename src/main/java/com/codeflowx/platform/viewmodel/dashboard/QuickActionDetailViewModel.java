...
public class QuickActionDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentQuickAction = businessService.findById(QuickAction.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentQuickAction);
                ...
                businessService.update(currentQuickAction);
