...
/**
 * ViewModel para búsqueda y listado de TokenMetrics
...
public class TokenMetricsOverviewViewModel extends BaseFront<TokenMetricsOverviewViewModel>{
    ...
    private PageResult<TokenMetrics> pageResult;
    ...
    // ========== Datos ==========
    private List<TokenMetrics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = tokenMetricsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "DSHTOKENMETRICS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "dshcurrency");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Cuando exista TokenMetricsMetricsSummaryService:
            // List<TokenMetricsMetricsSummary> metrics = tokenMetricsMetricsSummaryService.findAll();
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/dashboard/token-metrics-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Usar servicio dedicado
                            tokenMetricsService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "DSHTOKENMETRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
