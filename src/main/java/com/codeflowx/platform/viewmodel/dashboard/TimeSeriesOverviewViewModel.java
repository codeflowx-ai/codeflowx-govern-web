...
/**
 * ViewModel para búsqueda y listado de TimeSeries
...
public class TimeSeriesOverviewViewModel extends BaseFront<TimeSeriesOverviewViewModel>{
    ...
    protected void initDao() {
        ...
        // Mantener businessService solo para logActivity
    }
    ...
    private PageResult<TimeSeries> pageResult;
    ...
    // ========== Datos ==========
    private List<TimeSeries> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            // Usar servicio dedicado
            pageResult = timeSeriesService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "DSHTIMESERIES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "dshseriesname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Cuando exista TimeSeriesMetricsSummaryService:
            // List<TimeSeriesMetricsSummary> metrics = timeSeriesMetricsSummaryService.findAll();
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/dashboard/time-series-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Usar servicio dedicado
                            timeSeriesService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "DSHTIMESERIES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
