...
public class TimeSeriesOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<TimeSeriesMetricsSummary> metrics = businessService.findAllView(TimeSeriesMetricsSummary.class);
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/dashboard/dashboard-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(TimeSeries.class, itemId);
