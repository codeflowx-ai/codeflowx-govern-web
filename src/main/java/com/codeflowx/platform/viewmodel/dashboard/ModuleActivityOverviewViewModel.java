...
import com.codeflowx.govern.service.dashboard.ModuleActivityService;
...
/**
 * ViewModel para búsqueda y listado de ModuleActivity
...
public class ModuleActivityOverviewViewModel extends BaseFront<ModuleActivityOverviewViewModel>{
    ...
    private PageResult<ModuleActivity> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = moduleActivityService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "DSHMODULEACTIVITY", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "dshmodulename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Cuando exista ModuleActivityMetricsSummaryService:
            // List<ModuleActivityMetricsSummary> metrics = moduleActivityMetricsSummaryService.findAll();
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/dashboard/module-activity-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Usar servicio dedicado
                            moduleActivityService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "DSHMODULEACTIVITY", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
