...
/**
 * ViewModel para búsqueda y listado de Distribution
...
public class DistributionOverviewViewModel extends BaseFront<DistributionOverviewViewModel>{
    ...
    private PageResult<Distribution> pageResult;
    ...
    // ========== Datos ==========
    private List<Distribution> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = distributionService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "DSHDISTRIBUTIONS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Cuando exista DistributionMetricsSummaryService:
            // List<DistributionMetricsSummary> metrics = distributionMetricsSummaryService.findAll();
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/dashboard/distribution-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Usar servicio dedicado
                            distributionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "DSHDISTRIBUTIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
