...
/**
 * ViewModel para búsqueda y listado de QuickAction
...
public class QuickActionOverviewViewModel extends BaseFront<QuickActionOverviewViewModel>{
    ...
    private PageResult<QuickAction> pageResult;
    ...
    // ========== Datos ==========
    private List<QuickAction> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = quickActionService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "DSHQUICKACTIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "dshtitle");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Cuando exista QuickActionMetricsSummaryService:
            // List<QuickActionMetricsSummary> metrics = quickActionMetricsSummaryService.findAll();
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/dashboard/quick-action-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Usar servicio dedicado
                            quickActionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "DSHQUICKACTIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
