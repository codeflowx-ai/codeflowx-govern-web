...
public class ModuleActivityDetailViewModel extends BaseFront<ModuleActivityDetailViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            appendPage("plataforma/dashboard/module-activity-overview.zul", page.getFellow(IDDESKTOP), params);
        }
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentModuleActivity = moduleActivityService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentModuleActivity = moduleActivityService.create(currentModuleActivity);
                ...
                currentModuleActivity = moduleActivityService.update(currentModuleActivity);
