...
public class ModuleStatsOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModuleStatsMetricsSummary> metrics = businessService.findAllView(ModuleStatsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ModuleStats.class, itemId);
