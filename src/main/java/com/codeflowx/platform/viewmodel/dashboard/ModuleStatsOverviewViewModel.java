...
/**
 * ViewModel para búsqueda y listado de ModuleStats
...
public class ModuleStatsOverviewViewModel extends BaseFront<ModuleStatsOverviewViewModel>{
    ...
    private PageResult<ModuleStats> pageResult;
    ...
    // ========== Datos ==========
    private List<ModuleStats> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = moduleStatsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "DSHMODULESTATS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Cuando exista ModuleStatsMetricsSummaryService:
            // List<ModuleStatsMetricsSummary> metrics = moduleStatsMetricsSummaryService.findAll();
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/dashboard/module-stats-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // Usar servicio dedicado
                            moduleStatsService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "DSHMODULESTATS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
