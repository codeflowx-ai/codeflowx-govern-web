...
import com.codeflowx.govern.service.governance.GovernanceMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de GovernanceMetricsSummary
...
public class GovernanceMetricsSummaryOverviewViewModel extends BaseFront<GovernanceMetricsSummaryOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private GovernanceMetricsSummaryService governanceMetricsSummaryService;
  @WireVariable
  ...
  private PageResult<GovernanceMetricsSummary> pageResult;
  ...
  // ========== Datos ==========
  private List<GovernanceMetricsSummary> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = governanceMetricsSummaryService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_GOVERNANCE_METRICS_SUMMARY", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<GovernanceMetricsSummaryMetricsSummary> metrics =
      // businessService.findAllView(GovernanceMetricsSummaryMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                governanceMetricsSummaryService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_GOVERNANCE_METRICS_SUMMARY", itemId, "Eliminado registro ID: " + itemId);
                loadData();
   ...
   * @param mensaje -- mensaje aclaratorio, eje model, e);
