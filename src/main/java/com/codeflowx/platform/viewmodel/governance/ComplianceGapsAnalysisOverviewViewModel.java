...
/**
 * ViewModel para búsqueda y listado de ComplianceGapsAnalysis
...
public class ComplianceGapsAnalysisOverviewViewModel extends BaseFront<ComplianceGapsAnalysisOverviewViewModel>{
  ...
  private PageResult<ComplianceGapsAnalysis> pageResult;
  ...
  // ========== Datos ==========
  private List<ComplianceGapsAnalysis> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = complianceGapsAnalysisService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_COMPLIANCE_GAPS_ANALYSIS", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<ComplianceGapsAnalysisMetricsSummary> metrics =
      // businessService.findAllView(ComplianceGapsAnalysisMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                complianceGapsAnalysisService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_COMPLIANCE_GAPS_ANALYSIS", itemId, "Eliminado registro ID: " + itemId);
                loadData();
