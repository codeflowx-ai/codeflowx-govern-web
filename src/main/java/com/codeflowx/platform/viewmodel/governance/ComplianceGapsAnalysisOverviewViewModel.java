...
public class ComplianceGapsAnalysisOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ComplianceGapsAnalysisMetricsSummary> metrics = businessService.findAllView(ComplianceGapsAnalysisMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ComplianceGapsAnalysis.class, itemId);
