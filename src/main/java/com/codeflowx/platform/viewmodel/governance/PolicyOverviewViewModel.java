...
/**
 * ViewModel para búsqueda y listado de Policy
...
public class PolicyOverviewViewModel extends BaseFront<PolicyOverviewViewModel>{
    ...
    private PageResult<Policy> pageResult;
    ...
    // ========== Datos ==========
    private List<Policy> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = policyService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVPOLICIES", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PolicyMetricsSummary> metrics = businessService.findAllView(PolicyMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            policyService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVPOLICIES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
