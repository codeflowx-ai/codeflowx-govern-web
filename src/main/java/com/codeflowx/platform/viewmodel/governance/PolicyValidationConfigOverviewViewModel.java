...
public class PolicyValidationConfigOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PolicyValidationConfigMetricsSummary> metrics = businessService.findAllView(PolicyValidationConfigMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(PolicyValidationConfig.class, itemId);
