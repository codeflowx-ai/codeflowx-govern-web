...
public class PolicyAuditLogDetailViewModel extends BaseFront<PolicyAuditLogDetailViewModel>{
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentPolicyAuditLog = policyAuditLogService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentPolicyAuditLog = policyAuditLogService.create(currentPolicyAuditLog);
                ...
                currentPolicyAuditLog = policyAuditLogService.update(currentPolicyAuditLog);
