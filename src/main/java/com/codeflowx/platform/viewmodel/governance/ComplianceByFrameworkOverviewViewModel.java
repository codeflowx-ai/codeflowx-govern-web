            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ComplianceByFramework.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_COMPLIANCE_BY_FRAMEWORK", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
