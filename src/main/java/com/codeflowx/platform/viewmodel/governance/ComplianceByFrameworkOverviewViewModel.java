...
import com.codeflowx.govern.service.governance.ComplianceByFrameworkService;
...
/**
 * ViewModel para búsqueda y listado de ComplianceByFramework
...
public class ComplianceByFrameworkOverviewViewModel extends BaseFront<ComplianceByFrameworkOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private ComplianceByFrameworkService complianceByFrameworkService;
    @WireVariable
    ...
    private PageResult<ComplianceByFramework> pageResult;
    ...
    // ========== Datos ==========
    private List<ComplianceByFramework> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = complianceByFrameworkService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_COMPLIANCE_BY_FRAMEWORK", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ComplianceByFrameworkMetricsSummary> metrics = businessService.findAllView(ComplianceByFrameworkMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // ComplianceByFramework es una vista, no se puede eliminar
                            // Si necesitas eliminar, deberías eliminar la entidad relacionada
                            log.warn("Intento de eliminar vista ComplianceByFramework - Las vistas son de solo lectura");
