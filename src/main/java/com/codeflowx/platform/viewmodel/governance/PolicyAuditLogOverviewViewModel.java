...
/**
 * ViewModel para búsqueda y listado de PolicyAuditLog
...
public class PolicyAuditLogOverviewViewModel extends BaseFront<PolicyAuditLogOverviewViewModel>{
    ...
    private PageResult<PolicyAuditLog> pageResult;
    ...
    // ========== Datos ==========
    private List<PolicyAuditLog> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = policyAuditLogService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVPOLICYAUDITLOGS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "action");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PolicyAuditLogMetricsSummary> metrics = businessService.findAllView(PolicyAuditLogMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            policyAuditLogService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVPOLICYAUDITLOGS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
