...
/**
 * ViewModel para búsqueda y listado de PolicyEvaluation
...
public class PolicyEvaluationOverviewViewModel extends BaseFront<PolicyEvaluationOverviewViewModel>{
    ...
    private PageResult<PolicyEvaluation> pageResult;
    ...
    // ========== Datos ==========
    private List<PolicyEvaluation> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = policyEvaluationService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVPOLICYEVALUATIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "artifactid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PolicyEvaluationMetricsSummary> metrics = businessService.findAllView(PolicyEvaluationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            policyEvaluationService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVPOLICYEVALUATIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
