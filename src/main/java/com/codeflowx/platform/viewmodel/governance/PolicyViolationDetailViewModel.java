...
public class PolicyViolationDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentPolicyViolation = businessService.findById(PolicyViolation.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentPolicyViolation);
                ...
                businessService.update(currentPolicyViolation);
