...
/**
 * ViewModel para búsqueda y listado de PolicyChecklistItem
...
public class PolicyChecklistItemOverviewViewModel extends BaseFront<PolicyChecklistItemOverviewViewModel>{
    ...
    private PageResult<PolicyChecklistItem> pageResult;
    ...
    // ========== Datos ==========
    private List<PolicyChecklistItem> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = policyChecklistItemService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVPOLICYCHECKLISTITEMS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "category");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PolicyChecklistItemMetricsSummary> metrics = businessService.findAllView(PolicyChecklistItemMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            policyChecklistItemService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVPOLICYCHECKLISTITEMS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
