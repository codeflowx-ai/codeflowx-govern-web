...
/**
 * ViewModel para búsqueda y listado de PolicyRule
...
public class PolicyRuleOverviewViewModel extends BaseFront<PolicyRuleOverviewViewModel>{
    ...
    private PageResult<PolicyRule> pageResult;
    ...
    // ========== Datos ==========
    private List<PolicyRule> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = policyRuleService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVPOLICYRULES", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PolicyRuleMetricsSummary> metrics = businessService.findAllView(PolicyRuleMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            policyRuleService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVPOLICYRULES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
