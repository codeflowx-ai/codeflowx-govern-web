...
/**
 * ViewModel para búsqueda y listado de ComplianceFinding
...
public class ComplianceFindingOverviewViewModel extends BaseFront<ComplianceFindingOverviewViewModel>{
    ...
    private PageResult<ComplianceFinding> pageResult;
    ...
    // ========== Datos ==========
    private List<ComplianceFinding> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = complianceFindingService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVCOMPLIANCEFINDINGS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "findingtitle");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ComplianceFindingMetricsSummary> metrics = businessService.findAllView(ComplianceFindingMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            complianceFindingService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVCOMPLIANCEFINDINGS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
