...
public class SecurityPolicyOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<SecurityPolicyMetricsSummary> metrics = businessService.findAllView(SecurityPolicyMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(SecurityPolicy.class, itemId);
