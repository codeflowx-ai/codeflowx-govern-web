...
import com.codeflowx.govern.entity.views.governance.AutoApprovalAnalytics;
import com.codeflowx.govern.service.governance.AutoApprovalAnalyticsService;
...
/**
 * ViewModel para búsqueda y listado de AutoApprovalAnalytics
...
public class AutoApprovalAnalyticsOverviewViewModel extends BaseFront<AutoApprovalAnalyticsOverviewViewModel>{

    private static final long serialVersionUID = 1L;
    private static final String IDDESKTOP = "contenedor";

    @WireVariable
    private AutoApprovalAnalyticsService autoApprovalAnalyticsService;
    @WireVariable
    ...
    private PageResult<AutoApprovalAnalytics> pageResult;
    ...
    // ========== Datos ==========
    private List<AutoApprovalAnalytics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = autoApprovalAnalyticsService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_AUTO_APPROVAL_ANALYTICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Si existe AutoApprovalAnalyticsMetricsSummaryService, usar aquí
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/governance/governance-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // AutoApprovalAnalytics es una vista, no se puede eliminar
                            // Si necesitas eliminar, deberías eliminar la entidad relacionada
                            log.warn("Intento de eliminar vista AutoApprovalAnalytics - Las vistas son de solo lectura");
                            Messagebox.show("Las vistas son de solo lectura y no se pueden eliminar directamente",
