...
public class ComplianceFindingDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentComplianceFinding = businessService.findById(ComplianceFinding.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentComplianceFinding);
                ...
                businessService.update(currentComplianceFinding);
