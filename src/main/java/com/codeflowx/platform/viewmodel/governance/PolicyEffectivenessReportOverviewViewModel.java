...
public class PolicyEffectivenessReportOverviewViewModel extends MasterPage {
    ...
    public void loadData() {
        try {
            ...
            pageResult = businessService.findAllView(
                PolicyEffectivenessReport.class,
                pageParams,
                criterias
            );
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PolicyEffectivenessReportMetricsSummary> metrics = businessService.findAllView(PolicyEffectivenessReportMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(PolicyEffectivenessReport.class, itemId);
