...
import com.codeflowx.govern.entity.views.governance.PolicyEffectivenessReport;
import com.codeflowx.govern.service.governance.PolicyEffectivenessReportService;
...
/**
 * ViewModel para búsqueda y listado de PolicyEffectivenessReport
...
public class PolicyEffectivenessReportOverviewViewModel extends BaseFront<PolicyEffectivenessReportOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private PolicyEffectivenessReportService policyEffectivenessReportService;
  @WireVariable
  ...
  private PageResult<PolicyEffectivenessReport> pageResult;
  ...
  // ========== Datos ==========
  private List<PolicyEffectivenessReport> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = policyEffectivenessReportService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_POLICY_EFFECTIVENESS_REPORT", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<PolicyEffectivenessReportMetricsSummary> metrics =
      // businessService.findAllView(PolicyEffectivenessReportMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                policyEffectivenessReportService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_POLICY_EFFECTIVENESS_REPORT", itemId, "Eliminado registro ID: " + itemId);
                loadData();
   ...
   * @param mensaje -- mensaje aclaratorio, ej, model, e);
