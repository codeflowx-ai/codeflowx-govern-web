...
public class SecurityPolicyDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentSecurityPolicy = businessService.findById(SecurityPolicy.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentSecurityPolicy);
                ...
                businessService.update(currentSecurityPolicy);
