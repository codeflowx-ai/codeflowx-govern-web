...
import com.codeflowx.govern.service.governance.RiskAssessmentMatrixService;
...
/**
 * ViewModel para búsqueda y listado de RiskAssessmentMatrix
...
public class RiskAssessmentMatrixOverviewViewModel extends BaseFront<RiskAssessmentMatrixOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private RiskAssessmentMatrixService riskAssessmentMatrixService;
  @WireVariable
  ...
  private PageResult<RiskAssessmentMatrix> pageResult;
  ...
  // ========== Datos ==========
  private List<RiskAssessmentMatrix> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = riskAssessmentMatrixService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_RISK_ASSESSMENT_MATRIX", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<RiskAssessmentMatrixMetricsSummary> metrics =
      // businessService.findAllView(RiskAssessmentMatrixMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                riskAssessmentMatrixService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_RISK_ASSESSMENT_MATRIX", itemId, "Eliminado registro ID: " + itemId);
                loadData();
   ...
   * @param mensaje -- mensaje aclaratorio, ejemploel, e);
