...
import com.codeflowx.govern.service.governance.GovernanceOverviewService;
...
/**
 * ViewModel para búsqueda y listado de GovernanceOverview
...
public class GovernanceOverviewOverviewViewModel extends BaseFront<GovernanceOverviewOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private GovernanceOverviewService governanceOverviewService;
  @WireVariable
  ...
  // ========== Datos ==========
  private List<GovernanceOverview> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = governanceOverviewService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_GOVERNANCE_OVERVIEW", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<GovernanceOverviewMetricsSummary> metrics =
      // businessService.findAllView(GovernanceOverviewMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                governanceOverviewService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_GOVERNANCE_OVERVIEW", itemId, "Eliminado registro ID: " + itemId);
                loadData();
   ...
   * @param mensaje -- mensaje aclaratorio, ejemplo h, e);
