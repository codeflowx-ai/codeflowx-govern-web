...
public class GovernanceOverviewOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<GovernanceOverviewMetricsSummary> metrics = businessService.findAllView(GovernanceOverviewMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(GovernanceOverview.class, itemId);
