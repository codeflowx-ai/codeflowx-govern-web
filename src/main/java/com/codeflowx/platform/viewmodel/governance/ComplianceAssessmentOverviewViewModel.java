...
/**
 * ViewModel para búsqueda y listado de ComplianceAssessment
...
public class ComplianceAssessmentOverviewViewModel extends MasterPage {
    ...
    // ========== Datos ==========
    private List<ComplianceAssessment> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVCOMPLIANCEASSESSMENTS", null, 
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "assessmentname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ComplianceAssessmentMetricsSummary> metrics = businessService.findAllView(ComplianceAssessmentMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ComplianceAssessment.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVCOMPLIANCEASSESSMENTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
