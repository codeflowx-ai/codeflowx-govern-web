...
public class SecurityThreatDetailViewModel extends BaseFront<SecurityThreatDetailViewModel>{
  ...
  private void loadItem(Long id) {
    try {
      ...
      currentSecurityThreat = securityThreatService.findById(id);
  ...
  public void saveItem() {
    try {
      ...
      if (isNew) {
        currentSecurityThreat = securityThreatService.create(currentSecurityThreat);
        ...
        currentSecurityThreat = securityThreatService.update(currentSecurityThreat);
