...
public class PolicyEvaluationDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentPolicyEvaluation = businessService.findById(PolicyEvaluation.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentPolicyEvaluation);
                ...
                businessService.update(currentPolicyEvaluation);
