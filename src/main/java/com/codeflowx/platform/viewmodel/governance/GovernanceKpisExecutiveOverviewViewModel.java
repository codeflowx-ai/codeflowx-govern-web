...
public class GovernanceKpisExecutiveOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<GovernanceKpisExecutiveMetricsSummary> metrics = businessService.findAllView(GovernanceKpisExecutiveMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(GovernanceKpisExecutive.class, itemId);
