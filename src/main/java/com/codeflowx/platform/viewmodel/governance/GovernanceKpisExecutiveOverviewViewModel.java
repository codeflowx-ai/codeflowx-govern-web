...
import com.codeflowx.govern.entity.views.governance.GovernanceKpisExecutive;
import com.codeflowx.govern.service.governance.GovernanceKpisExecutiveService;
...
/**
 * ViewModel para búsqueda y listado de GovernanceKpisExecutive
...
public class GovernanceKpisExecutiveOverviewViewModel extends BaseFront<GovernanceKpisExecutiveOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private GovernanceKpisExecutiveService governanceKpisExecutiveService;
  @WireVariable
  ...
  private PageResult<GovernanceKpisExecutive> pageResult;
  ...
  // ========== Datos ==========
  private List<GovernanceKpisExecutive> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = governanceKpisExecutiveService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_GOVERNANCE_KPIS_EXECUTIVE", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<GovernanceKpisExecutiveMetricsSummary> metrics =
      // businessService.findAllView(GovernanceKpisExecutiveMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                governanceKpisExecutiveService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_GOVERNANCE_KPIS_EXECUTIVE", itemId, "Eliminado registro ID: " + itemId);
                loadData();
   ...
   * @param mensaje -- mensaje aclaratorio, ejemmodel, e);
