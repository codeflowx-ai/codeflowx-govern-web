...
public class PolicyEvaluationTrendsOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<PolicyEvaluationTrendsMetricsSummary> metrics = businessService.findAllView(PolicyEvaluationTrendsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(PolicyEvaluationTrends.class, itemId);
