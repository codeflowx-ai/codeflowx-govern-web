...
import com.codeflowx.govern.service.governance.PolicyEvaluationTrendsService;
...
/**
 * ViewModel para búsqueda y listado de PolicyEvaluationTrends
...
public class PolicyEvaluationTrendsOverviewViewModel extends BaseFront<PolicyEvaluationTrendsOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private PolicyEvaluationTrendsService policyEvaluationTrendsService;
  @WireVariable
  ...
  private PageResult<PolicyEvaluationTrends> pageResult;
  ...
  // ========== Datos ==========
  private List<PolicyEvaluationTrends> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = policyEvaluationTrendsService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_POLICY_EVALUATION_TRENDS", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<PolicyEvaluationTrendsMetricsSummary> metrics =
      // businessService.findAllView(PolicyEvaluationTrendsMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                policyEvaluationTrendsService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_POLICY_EVALUATION_TRENDS", itemId, "Eliminado registro ID: " + itemId);
                loadData();
