...
import com.codeflowx.govern.entity.views.governance.GovernanceAuditTrailDetailed;
import com.codeflowx.govern.service.governance.GovernanceAuditTrailDetailedService;
...
/**
 * ViewModel para búsqueda y listado de GovernanceAuditTrailDetailed
...
public class GovernanceAuditTrailDetailedOverviewViewModel extends BaseFront<GovernanceAuditTrailDetailedOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private GovernanceAuditTrailDetailedService governanceAuditTrailDetailedService;
  @WireVariable
  ...
  private PageResult<GovernanceAuditTrailDetailed> pageResult;
  ...
  // ========== Datos ==========
  private List<GovernanceAuditTrailDetailed> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = governanceAuditTrailDetailedService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_GOVERNANCE_AUDIT_TRAIL_DETAILED", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<GovernanceAuditTrailDetailedMetricsSummary> metrics =
      // businessService.findAllView(GovernanceAuditTrailDetailedMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                governanceAuditTrailDetailedService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_GOVERNANCE_AUDIT_TRAIL_DETAILED", itemId, "Eliminado registro ID: " + itemId);
                loadData();
   ...
   * @param mensaje -- mensaje aclaratorio,ion, model, e);
