...
public class GovernanceAuditTrailDetailedOverviewViewModel extends MasterPage {
    ...
    public void loadData() {
        try {
            ...
            pageResult = businessService.findAllView(
                GovernanceAuditTrailDetailed.class,
                pageParams,
                criterias
            );
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<GovernanceAuditTrailDetailedMetricsSummary> metrics = businessService.findAllView(GovernanceAuditTrailDetailedMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(GovernanceAuditTrailDetailed.class, itemId);
