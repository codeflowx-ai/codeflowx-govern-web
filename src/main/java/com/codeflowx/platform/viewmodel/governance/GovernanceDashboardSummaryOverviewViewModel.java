...
/**
 * ViewModel para búsqueda y listado de GovernanceDashboardSummary
...
public class GovernanceDashboardSummaryOverviewViewModel extends BaseFront<GovernanceDashboardSummaryOverviewViewModel>{
  ...
  private PageResult<GovernanceDashboardSummary> pageResult;
  ...
  // ========== Datos ==========
  private List<GovernanceDashboardSummary> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = governanceDashboardSummaryService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_GOVERNANCE_DASHBOARD_SUMMARY", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<GovernanceDashboardSummaryMetricsSummary> metrics =
      // businessService.findAllView(GovernanceDashboardSummaryMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                governanceDashboardSummaryService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_GOVERNANCE_DASHBOARD_SUMMARY", itemId, "Eliminado registro ID: " + itemId);
                loadData();
