...
public class GovernanceDashboardSummaryOverviewViewModel extends MasterPage {
    ...
    public void loadData() {
        try {
            ...
            pageResult = businessService.findAllView(
                GovernanceDashboardSummary.class,
                pageParams,
                criterias
            );
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<GovernanceDashboardSummaryMetricsSummary> metrics = businessService.findAllView(GovernanceDashboardSummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(GovernanceDashboardSummary.class, itemId);
