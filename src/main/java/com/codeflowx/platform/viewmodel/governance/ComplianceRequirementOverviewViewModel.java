...
/**
 * ViewModel para búsqueda y listado de ComplianceRequirement
...
public class ComplianceRequirementOverviewViewModel extends BaseFront<ComplianceRequirementOverviewViewModel>{
    ...
    private PageResult<ComplianceRequirement> pageResult;
    ...
    // ========== Datos ==========
    private List<ComplianceRequirement> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = complianceRequirementService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVCOMPLIANCEREQUIREMENTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "requirementid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ComplianceRequirementMetricsSummary> metrics = businessService.findAllView(ComplianceRequirementMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            complianceRequirementService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVCOMPLIANCEREQUIREMENTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
