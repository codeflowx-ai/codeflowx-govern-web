...
public class GovernanceMetricOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<GovernanceMetricMetricsSummary> metrics = businessService.findAllView(GovernanceMetricMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(GovernanceMetric.class, itemId);
