...
import com.codeflowx.govern.entity.views.governance.ViolationHeatmap;
import com.codeflowx.govern.service.governance.ViolationHeatmapService;
...
/**
 * ViewModel para búsqueda y listado de ViolationHeatmap
...
public class ViolationHeatmapOverviewViewModel extends BaseFront<ViolationHeatmapOverviewViewModel>{

  private static final long serialVersionUID = 1L;
  private static final String IDDESKTOP = "contenedor";

  @WireVariable
  private ViolationHeatmapService violationHeatmapService;
  @WireVariable
  ...
  private PageResult<ViolationHeatmap> pageResult;
  ...
  // ========== Datos ==========
  private List<ViolationHeatmap> filteredItems = new ArrayList<>();
  ...
  public void loadData() {
    try {
      ...
      pageResult = violationHeatmapService.findAll(
          pageParams,
          criterias);
      ...
      if (pageResult != null && pageResult.getContent() != null) {
        ...
        // Auditar búsqueda
        logActivity("BUSCAR", "V_VIOLATION_HEATMAP", null,
  ...
  private void loadGlobalMetrics() {
    try {
      ...
      // Ejemplo: List<ViolationHeatmapMetricsSummary> metrics =
      // businessService.findAllView(ViolationHeatmapMetricsSummary.class);
      ...
      Messagebox.show("¿Está seguro de eliminar este registro?",
          ...
          event -> {
            if (Messagebox.ON_YES.equals(event.getName())) {
              try {
                violationHeatmapService.deleteById(itemId);
                log.info("Registro eliminado: ID={}", itemId);
                logActivity("BORRAR", "V_VIOLATION_HEATMAP", itemId, "Eliminado registro ID: " + itemId);
                loadData();
