...
public class ViolationHeatmapOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ViolationHeatmapMetricsSummary> metrics = businessService.findAllView(ViolationHeatmapMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(ViolationHeatmap.class, itemId);
