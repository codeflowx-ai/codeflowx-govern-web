...
/**
 * ViewModel para búsqueda y listado de ModelEvaluation
...
public class ModelEvaluationOverviewViewModel extends BaseFront<ModelEvaluationOverviewViewModel>{
    ...
    private PageResult<ModelEvaluation> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelEvaluation> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelEvaluationService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVMODELEVALUATIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "evaluationname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelEvaluationMetricsSummary> metrics = businessService.findAllView(ModelEvaluationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelEvaluationService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVMODELEVALUATIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
