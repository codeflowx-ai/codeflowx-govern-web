...
/**
 * ViewModel para búsqueda y listado de ModelPerformance
...
public class ModelPerformanceOverviewViewModel extends BaseFront<ModelPerformanceOverviewViewModel>{
    ...
    private PageResult<ModelPerformance> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelPerformance> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelPerformanceService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODMODELPERFORMANCES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modmetricname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelPerformanceMetricsSummary> metrics = businessService.findAllView(ModelPerformanceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelPerformanceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODMODELPERFORMANCES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
