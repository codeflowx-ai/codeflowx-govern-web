...
import com.codeflowx.govern.entity.views.evaluation.EvaluationMetrics;
import com.codeflowx.admin.Ssoractividad;
import com.codeflowx.govern.service.evaluation.EvaluationMetricsService;
...
/**
 * ViewModel para búsqueda y listado de EvaluationMetrics
...
public class EvaluationMetricsOverviewViewModel extends BaseFront<EvaluationMetricsOverviewViewModel>{
    ...
    private PageResult<EvaluationMetrics> pageResult;
    ...
    // ========== Datos ==========
    private List<EvaluationMetrics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = evaluationMetricsService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_EVALUATION_METRICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<EvaluationMetricsMetricsSummary> metrics = businessService.findAllView(EvaluationMetricsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            evaluationMetricsService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_EVALUATION_METRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
