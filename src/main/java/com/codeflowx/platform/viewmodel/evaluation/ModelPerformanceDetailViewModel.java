...
public class ModelPerformanceDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentModelPerformance = businessService.findById(ModelPerformance.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentModelPerformance);
                ...
                businessService.update(currentModelPerformance);
