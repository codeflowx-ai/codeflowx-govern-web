...
/**
 * ViewModel para búsqueda y listado de FairnessMetric
...
public class FairnessMetricOverviewViewModel extends BaseFront<FairnessMetricOverviewViewModel>{
    ...
    private PageResult<FairnessMetric> pageResult;
    ...
    // ========== Datos ==========
    private List<FairnessMetric> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = fairnessMetricService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVFAIRNESSMETRICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<FairnessMetricMetricsSummary> metrics = businessService.findAllView(FairnessMetricMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            fairnessMetricService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVFAIRNESSMETRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
