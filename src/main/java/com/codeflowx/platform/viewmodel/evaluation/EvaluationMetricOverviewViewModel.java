...
/**
 * ViewModel para búsqueda y listado de EvaluationMetric
...
public class EvaluationMetricOverviewViewModel extends BaseFront<EvaluationMetricOverviewViewModel>{
    ...
    private PageResult<EvaluationMetric> pageResult;
    ...
    // ========== Datos ==========
    private List<EvaluationMetric> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = evaluationMetricService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVEVALUATIONMETRICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<EvaluationMetricMetricsSummary> metrics = businessService.findAllView(EvaluationMetricMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            evaluationMetricService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVEVALUATIONMETRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
