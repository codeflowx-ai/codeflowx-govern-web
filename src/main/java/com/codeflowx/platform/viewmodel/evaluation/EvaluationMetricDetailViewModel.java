...
public class EvaluationMetricDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentEvaluationMetric = businessService.findById(EvaluationMetric.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentEvaluationMetric);
                ...
                businessService.update(currentEvaluationMetric);
