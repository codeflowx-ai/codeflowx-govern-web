...
/**
 * ViewModel para búsqueda y listado de ModelBiasAnalysis
...
public class ModelBiasAnalysisOverviewViewModel extends BaseFront<ModelBiasAnalysisOverviewViewModel>{
    ...
    private PageResult<ModelBiasAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<ModelBiasAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = modelBiasAnalysisService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MODMODELBIASANALYSES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "modseverity");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ModelBiasAnalysisMetricsSummary> metrics = businessService.findAllView(ModelBiasAnalysisMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            modelBiasAnalysisService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MODMODELBIASANALYSES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
