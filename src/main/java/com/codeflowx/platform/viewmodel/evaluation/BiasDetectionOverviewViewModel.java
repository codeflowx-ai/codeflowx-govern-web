...
/**
 * ViewModel para búsqueda y listado de BiasDetection
...
public class BiasDetectionOverviewViewModel extends BaseFront<BiasDetectionOverviewViewModel>{
    ...
    private PageResult<BiasDetection> pageResult;
    ...
    // ========== Datos ==========
    private List<BiasDetection> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = biasDetectionService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVBIASDETECTIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "severity");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<BiasDetectionMetricsSummary> metrics = businessService.findAllView(BiasDetectionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            biasDetectionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVBIASDETECTIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
