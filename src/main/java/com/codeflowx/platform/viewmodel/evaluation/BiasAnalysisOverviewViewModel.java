...
/**
 * ViewModel para búsqueda y listado de BiasAnalysis
...
public class BiasAnalysisOverviewViewModel extends BaseFront<BiasAnalysisOverviewViewModel>{
    ...
    private PageResult<BiasAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<BiasAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = biasAnalysisService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVBIASANALYSIS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "agentid");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<BiasAnalysisMetricsSummary> metrics = businessService.findAllView(BiasAnalysisMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            biasAnalysisService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVBIASANALYSIS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
