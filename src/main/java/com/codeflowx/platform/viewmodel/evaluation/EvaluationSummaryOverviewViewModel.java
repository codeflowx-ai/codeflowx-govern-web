...
import com.codeflowx.govern.entity.views.evaluation.EvaluationSummary;
import com.codeflowx.admin.Ssoractividad;
import com.codeflowx.govern.service.evaluation.EvaluationSummaryService;
...
/**
 * ViewModel para búsqueda y listado de EvaluationSummary
...
public class EvaluationSummaryOverviewViewModel extends BaseFront<EvaluationSummaryOverviewViewModel>{
    ...
    private PageResult<EvaluationSummary> pageResult;
    ...
    // ========== Datos ==========
    private List<EvaluationSummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = evaluationSummaryService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_EVALUATION_SUMMARY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<EvaluationSummaryMetricsSummary> metrics = businessService.findAllView(EvaluationSummaryMetricsSummary.class);
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/evaluation/evaluation-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            evaluationSummaryService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_EVALUATION_SUMMARY", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
