...
/**
 * ViewModel para búsqueda y listado de BiasRecommendation
...
public class BiasRecommendationOverviewViewModel extends BaseFront<BiasRecommendationOverviewViewModel>{
    ...
    private PageResult<BiasRecommendation> pageResult;
    ...
    // ========== Datos ==========
    private List<BiasRecommendation> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = biasRecommendationService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVBIASRECOMMENDATIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "estimatedeffort");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<BiasRecommendationMetricsSummary> metrics = businessService.findAllView(BiasRecommendationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            biasRecommendationService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVBIASRECOMMENDATIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
