...
/**
 * ViewModel para búsqueda y listado de MetricsVisualization
...
public class MetricsVisualizationOverviewViewModel extends BaseFront<MetricsVisualizationOverviewViewModel>{
    ...
    private PageResult<MetricsVisualization> pageResult;
    ...
    // ========== Datos ==========
    private List<MetricsVisualization> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = metricsVisualizationService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_METRICS_VISUALIZATION", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<MetricsVisualizationMetricsSummary> metrics = businessService.findAllView(MetricsVisualizationMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // NOTA: MetricsVisualization es una view, no debería tener delete
                            // Mantener businessService para operaciones especiales si es necesario
                            businessService.removeFromID(MetricsVisualization.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_METRICS_VISUALIZATION", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
