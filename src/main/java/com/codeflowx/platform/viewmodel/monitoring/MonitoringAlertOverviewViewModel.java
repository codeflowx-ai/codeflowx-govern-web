...
/**
 * ViewModel para búsqueda y listado de MonitoringAlert
...
public class MonitoringAlertOverviewViewModel extends BaseFront<MonitoringAlertOverviewViewModel>{
    ...
    private PageResult<MonitoringAlert> pageResult;
    ...
    // ========== Datos ==========
    private List<MonitoringAlert> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = monitoringAlertService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MONMONITORINGALERTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "monalertname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<MonitoringAlertMetricsSummary> metrics = businessService.findAllView(MonitoringAlertMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            monitoringAlertService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MONMONITORINGALERTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
