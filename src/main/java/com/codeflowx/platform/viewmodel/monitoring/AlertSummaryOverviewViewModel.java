...
/**
 * ViewModel para búsqueda y listado de AlertSummary
...
public class AlertSummaryOverviewViewModel extends BaseFront<AlertSummaryOverviewViewModel> {
    ...
    private PageResult<AlertSummary> pageResult;
    ...
    // ========== Datos ==========
    private List<AlertSummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = alertSummaryService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_ALERT_SUMMARY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AlertSummaryMetricsSummary> metrics = businessService.findAllView(AlertSummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // NOTA: AlertSummary es una view, no debería tener delete
                            // Mantener businessService para operaciones especiales si es necesario
                            businessService.removeFromID(AlertSummary.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_ALERT_SUMMARY", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
