...
/**
 * ViewModel para búsqueda y listado de MonitoringMetric
...
public class MonitoringMetricOverviewViewModel extends BaseFront<MonitoringMetricOverviewViewModel>{
    ...
    private PageResult<MonitoringMetric> pageResult;
    ...
    // ========== Datos ==========
    private List<MonitoringMetric> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = monitoringMetricService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "MONMONITORINGMETRICS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "monmetricname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<MonitoringMetricMetricsSummary> metrics = businessService.findAllView(MonitoringMetricMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            monitoringMetricService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "MONMONITORINGMETRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
