...
/**
 * ViewModel para búsqueda y listado de SystemAlert
...
public class SystemAlertOverviewViewModel extends BaseFront<SystemAlertOverviewViewModel>{
    ...
    private PageResult<SystemAlert> pageResult;
    ...
    // ========== Datos ==========
    private List<SystemAlert> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = systemAlertService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVSYSTEMALERTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "alerttitle");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<SystemAlertMetricsSummary> metrics = businessService.findAllView(SystemAlertMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            systemAlertService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVSYSTEMALERTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
