...
/**
 * ViewModel para búsqueda y listado de MonitoringDashboard
...
public class MonitoringDashboardOverviewViewModel extends BaseFront<MonitoringDashboardOverviewViewModel>{
    ...
    @WireVariable
    private BusinessService businessService; // Mantener para logActivity y operaciones especiales
    ...
    private PageResult<MonitoringDashboard> pageResult;
    ...
    // ========== Datos ==========
    private List<MonitoringDashboard> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = monitoringDashboardService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_MONITORING_DASHBOARD", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<MonitoringDashboardMetricsSummary> metrics = businessService.findAllView(MonitoringDashboardMetricsSummary.class);
    ...
    public void registerItem() {
        ...
        appendPage("plataforma/monitoring/monitoring-detail.zul", page.getFellow(IDDESKTOP), params);
    }
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // NOTA: MonitoringDashboard es una view, no debería tener delete
                            // Mantener businessService para operaciones especiales si es necesario
                            businessService.removeFromID(MonitoringDashboard.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_MONITORING_DASHBOARD", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
