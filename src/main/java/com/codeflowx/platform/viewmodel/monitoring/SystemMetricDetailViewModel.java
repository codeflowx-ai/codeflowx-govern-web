...
public class SystemMetricDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentSystemMetric = businessService.findById(SystemMetric.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentSystemMetric);
                ...
                businessService.update(currentSystemMetric);
