...
public class MonitoringMetricDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentMonitoringMetric = businessService.findById(MonitoringMetric.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentMonitoringMetric);
                ...
                businessService.update(currentMonitoringMetric);
