...
import com.codeflowx.govern.service.monitoring.SystemHealthService;
...
/**
 * ViewModel para búsqueda y listado de SystemHealth
...
public class SystemHealthOverviewViewModel extends BaseFront<SystemHealthOverviewViewModel>{
    ...
    private PageResult<SystemHealth> pageResult;
    ...
    // ========== Datos ==========
    private List<SystemHealth> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = systemHealthService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVSYSTEMHEALTH", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "componentname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<SystemHealthMetricsSummary> metrics = businessService.findAllView(SystemHealthMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            systemHealthService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVSYSTEMHEALTH", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
