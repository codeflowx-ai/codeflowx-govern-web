...
/**
 * ViewModel para búsqueda y listado de AnomalyHeatmap
...
public class AnomalyHeatmapOverviewViewModel extends BaseFront<AnomalyHeatmapOverviewViewModel>{
    ...
    private PageResult<AnomalyHeatmap> pageResult;
    ...
    // ========== Datos ==========
    private List<AnomalyHeatmap> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = anomalyHeatmapService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_ANOMALY_HEATMAP", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<AnomalyHeatmapMetricsSummary> metrics = businessService.findAllView(AnomalyHeatmapMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            // NOTA: AnomalyHeatmap es una view, no debería tener delete
                            // Mantener businessService para operaciones especiales si es necesario
                            businessService.removeFromID(AnomalyHeatmap.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_ANOMALY_HEATMAP", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
