...
/**
 * ViewModel para búsqueda y listado de SystemMetric
...
public class SystemMetricOverviewViewModel extends BaseFront<SystemMetricOverviewViewModel>{
    ...
    private PageResult<SystemMetric> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = systemMetricService.findAll(pageParams, criterias);
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "GOVSYSTEMMETRICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<SystemMetricMetricsSummary> metrics = businessService.findAllView(SystemMetricMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            systemMetricService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "GOVSYSTEMMETRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
