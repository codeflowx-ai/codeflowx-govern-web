...
public class SystemHealthDetailViewModel extends BaseFront<SystemHealthDetailViewModel>{
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentSystemHealth = systemHealthService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                currentSystemHealth = systemHealthService.create(currentSystemHealth);
                ...
                currentSystemHealth = systemHealthService.update(currentSystemHealth);
