...
import com.codeflowx.govern.entity.views.rag.EmbeddingGenerationProgress;
import com.codeflowx.govern.service.rag.EmbeddingGenerationProgressService;
...
/**
 * ViewModel para búsqueda y listado de EmbeddingGenerationProgress
...
public class EmbeddingGenerationProgressOverviewViewModel extends BaseFront<EmbeddingGenerationProgressOverviewViewModel>{
    ...
    @WireVariable
    private EmbeddingGenerationProgressService embeddingGenerationProgressService;
    ...
    private PageResult<EmbeddingGenerationProgress> pageResult;
    ...
    // ========== Datos ==========
    private List<EmbeddingGenerationProgress> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = embeddingGenerationProgressService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_EMBEDDING_GENERATION_PROGRESS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<EmbeddingGenerationProgressMetricsSummary> metrics = businessService.findAllView(EmbeddingGenerationProgressMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            embeddingGenerationProgressService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_EMBEDDING_GENERATION_PROGRESS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
