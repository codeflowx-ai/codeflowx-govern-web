...
public class RagMetricsSummaryOverviewViewModel extends BaseFront<RagMetricsSummaryOverviewViewModel>{
    ...
    public void loadData() {
        try {
            ...
            pageResult = ragMetricsSummaryService.findAll(
                pageParams,
                criterias
            );
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ragMetricsSummaryService.deleteById(itemId);
