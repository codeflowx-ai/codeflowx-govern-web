...
public class DatasourceStatisticsOverviewViewModel extends MasterPage {
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(DatasourceStatistics.class, itemId);
