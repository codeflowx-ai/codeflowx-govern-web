...
public class RagDataSourceDetailViewModel extends BaseFront<RagDataSourceDetailViewModel>{
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentRagDataSource = ragDataSourceService.findById(id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                ragDataSourceService.create(currentRagDataSource);
                ...
                ragDataSourceService.update(currentRagDataSource);
