...
/**
 * ViewModel para búsqueda y listado de RagSystem
...
public class RagSystemOverviewViewModel extends MasterPage {
    ...
    // ========== Datos ==========
    private List<RagSystem> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "RAGRAGSYSTEMS", null, 
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RagSystemMetricsSummary> metrics = businessService.findAllView(RagSystemMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(RagSystem.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "RAGRAGSYSTEMS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
