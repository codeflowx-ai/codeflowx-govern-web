...
import com.codeflowx.govern.entity.views.rag.IndexHealthDashboard;
import com.codeflowx.govern.service.rag.IndexHealthDashboardService;
...
/**
 * ViewModel para búsqueda y listado de IndexHealthDashboard
...
public class IndexHealthDashboardOverviewViewModel extends BaseFront<IndexHealthDashboardOverviewViewModel>{
    ...
    @WireVariable
    private IndexHealthDashboardService indexHealthDashboardService;
    ...
    private PageResult<IndexHealthDashboard> pageResult;
    ...
    public void loadData() {
        try {
            ...
            pageResult = indexHealthDashboardService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_INDEX_HEALTH_DASHBOARD", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<IndexHealthDashboardMetricsSummary> metrics = businessService.findAllView(IndexHealthDashboardMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            indexHealthDashboardService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_INDEX_HEALTH_DASHBOARD", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
