...
import com.codeflowx.govern.entity.views.rag.RagUsageByAgent;
import com.codeflowx.govern.service.rag.RagUsageByAgentService;
...
/**
 * ViewModel para búsqueda y listado de RagUsageByAgent
...
public class RagUsageByAgentOverviewViewModel extends BaseFront<RagUsageByAgentOverviewViewModel>{
    ...
    @WireVariable
    private RagUsageByAgentService ragUsageByAgentService;
    ...
    private PageResult<RagUsageByAgent> pageResult;
    ...
    // ========== Datos ==========
    private List<RagUsageByAgent> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = ragUsageByAgentService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_RAG_USAGE_BY_AGENT", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RagUsageByAgentMetricsSummary> metrics = businessService.findAllView(RagUsageByAgentMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ragUsageByAgentService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_RAG_USAGE_BY_AGENT", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
