...
/**
 * ViewModel para búsqueda y listado de RagDataSource
...
public class RagDataSourceOverviewViewModel extends BaseFront<RagDataSourceOverviewViewModel>{
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "RAGRAGDATASOURCES", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RagDataSourceMetricsSummary> metrics = businessService.findAllView(RagDataSourceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ragDataSourceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "RAGRAGDATASOURCES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
