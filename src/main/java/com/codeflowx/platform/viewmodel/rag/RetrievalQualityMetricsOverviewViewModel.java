...
import com.codeflowx.govern.entity.views.rag.RetrievalQualityMetrics;
import com.codeflowx.govern.service.rag.RetrievalQualityMetricsService;
...
/**
 * ViewModel para búsqueda y listado de RetrievalQualityMetrics
...
public class RetrievalQualityMetricsOverviewViewModel extends BaseFront<RetrievalQualityMetricsOverviewViewModel>{
    ...
    @WireVariable
    private RetrievalQualityMetricsService retrievalQualityMetricsService;
    ...
    private PageResult<RetrievalQualityMetrics> pageResult;
    ...
    // ========== Datos ==========
    private List<RetrievalQualityMetrics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = retrievalQualityMetricsService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_RETRIEVAL_QUALITY_METRICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RetrievalQualityMetricsMetricsSummary> metrics = businessService.findAllView(RetrievalQualityMetricsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            retrievalQualityMetricsService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_RETRIEVAL_QUALITY_METRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo ha c           // No lanzar excepción para que no interrumpa el flujo normal
        }
    }
