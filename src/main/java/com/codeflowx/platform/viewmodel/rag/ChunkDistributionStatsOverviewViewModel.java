...
/**
 * ViewModel para búsqueda y listado de ChunkDistributionStats
...
public class ChunkDistributionStatsOverviewViewModel extends MasterPage {
    ...
    @WireVariable
    private ChunkDistributionStatsService chunkDistributionStatsService;
    ...
    private PageResult<ChunkDistributionStats> pageResult;
    ...
    // ========== Datos ==========
    private List<ChunkDistributionStats> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = chunkDistributionStatsService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_CHUNK_DISTRIBUTION_STATS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ChunkDistributionStatsMetricsSummary> metrics = businessService.findAllView(ChunkDistributionStatsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            chunkDistributionStatsService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_CHUNK_DISTRIBUTION_STATS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
