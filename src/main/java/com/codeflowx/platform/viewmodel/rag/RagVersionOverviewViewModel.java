...
/**
 * ViewModel para búsqueda y listado de RagVersion
...
public class RagVersionOverviewViewModel extends BaseFront<RagVersionOverviewViewModel>{
    ...
    private PageResult<RagVersion> pageResult;
    ...
    // ========== Datos ==========
    private List<RagVersion> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = ragVersionService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "RAGRAGVERSIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "ragversion");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RagVersionMetricsSummary> metrics = businessService.findAllView(RagVersionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ragVersionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "RAGRAGVERSIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
