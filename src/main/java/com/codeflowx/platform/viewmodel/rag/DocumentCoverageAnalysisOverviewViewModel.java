...
import com.codeflowx.govern.entity.views.rag.DocumentCoverageAnalysis;
import com.codeflowx.govern.service.rag.DocumentCoverageAnalysisService;
...
/**
 * ViewModel para búsqueda y listado de DocumentCoverageAnalysis
...
public class DocumentCoverageAnalysisOverviewViewModel extends BaseFront<DocumentCoverageAnalysisOverviewViewModel>{
    ...
    @WireVariable
    private DocumentCoverageAnalysisService documentCoverageAnalysisService;
    ...
    private PageResult<DocumentCoverageAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<DocumentCoverageAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = documentCoverageAnalysisService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_DOCUMENT_COVERAGE_ANALYSIS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<DocumentCoverageAnalysisMetricsSummary> metrics = businessService.findAllView(DocumentCoverageAnalysisMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            documentCoverageAnalysisService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_DOCUMENT_COVERAGE_ANALYSIS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
