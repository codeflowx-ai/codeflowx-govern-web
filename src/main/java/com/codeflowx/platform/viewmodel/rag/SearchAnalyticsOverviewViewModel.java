...
import com.codeflowx.govern.entity.views.rag.SearchAnalytics;
import com.codeflowx.govern.service.rag.SearchAnalyticsService;
...
/**
 * ViewModel para búsqueda y listado de SearchAnalytics
...
public class SearchAnalyticsOverviewViewModel extends BaseFront<SearchAnalyticsOverviewViewModel>{
    ...
    private PageResult<SearchAnalytics> pageResult;
    ...
    // ========== Datos ==========
    private List<SearchAnalytics> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = searchAnalyticsService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_SEARCH_ANALYTICS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<SearchAnalyticsMetricsSummary> metrics = businessService.findAllView(SearchAnalyticsMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            searchAnalyticsService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_SEARCH_ANALYTICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
