...
/**
 * ViewModel para búsqueda y listado de RagOverview
...
public class RagOverviewOverviewViewModel extends BaseFront<RagOverviewOverviewViewModel>{
    ...
    // ========== Datos ==========
    private List<RagOverview> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = ragOverviewService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_RAG_OVERVIEW", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<RagOverviewMetricsSummary> metrics = businessService.findAllView(RagOverviewMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            ragOverviewService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_RAG_OVERVIEW", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
