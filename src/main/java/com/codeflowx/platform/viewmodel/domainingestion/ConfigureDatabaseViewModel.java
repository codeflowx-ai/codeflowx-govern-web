...
public class ConfigureDatabaseViewModel extends BaseFront<ConfigureDatabaseViewModel> {
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        dataSource.setDindstype("database");
    ...
    public void loadExistingSources() {
        try {
            Criterias criterias = new Criterias();
            criterias.addCriteria(new Criteria(Operation.AND, Evaluation.EQUALS, "dindstype", "database"));
    ...
    public void saveDataSource() {
        ...
        if (dataSource.getDindsconnectionstring() == null || dataSource.getDindsconnectionstring().trim().isEmpty()) {
            Messagebox.show("Ingrese connection string", "Validación", Messagebox.OK, Messagebox.EXCLAMATION);
            return;
        }
        ...
        try {
            ...
            logActivity("CREAR", "DOMAIN_DATA_SOURCE", dataSource.getIdxdatasource(), 
                "Fuente Database creada: " + dataSource.getDindsname());
            Messagebox.show("Fuente Database creada exitosamente", "Éxito", Messagebox.OK, Messagebox.INFORMATION);
