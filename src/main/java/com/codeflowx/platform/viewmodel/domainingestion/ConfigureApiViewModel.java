...
public class ConfigureApiViewModel extends BaseFront<ConfigureApiViewModel> {
    ...
    public void loadExistingSources() {
        try {
            Criterias criterias = new Criterias();
            criterias.addCriteria(new Criteria(Operation.AND, Evaluation.EQUALS, "dindstype", "api"));
    ...
    public void saveDataSource() {
        if (selectedDomain == null) {
            Messagebox.show("Seleccione un dominio", "Validación", Messagebox.OK, Messagebox.INFORMATION);
            return;
        }
        if (dataSource.getDindsname() == null || dataSource.getDindsname().trim().isEmpty()) {
            Messagebox.show("Ingrese un nombre", "Validación", Messagebox.OK, Messagebox.INFORMATION);
            return;
        }
        if (dataSource.getDindsendpoint() == null || dataSource.getDindsendpoint().trim().isEmpty()) {
            Messagebox.show("Ingrese un endpoint", "Validación", Messagebox.OK, Messagebox.INFORMATION);
            return;
        }
        ...
        try {
            ...
            logActivity("CREAR", "DOMAIN_DATA_SOURCE", dataSource.getIdxdatasource(), 
                "Fuente API creada: " + dataSource.getDindsname());
            Messagebox.show("Fuente API creada exitosamente", "Éxito", Messagebox.OK, Messagebox.INFORMATION);
