...
/**
 * ViewModel para búsqueda y listado de KubernetesCluster
...
public class KubernetesClusterOverviewViewModel extends BaseFront<KubernetesClusterOverviewViewModel>{
    ...
    private PageResult<KubernetesCluster> pageResult;
    ...
    // ========== Datos ==========
    private List<KubernetesCluster> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = kubernetesClusterService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFKUBERNETESCLUSTERS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infk8sname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<KubernetesClusterMetricsSummary> metrics = businessService.findAllView(KubernetesClusterMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            kubernetesClusterService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFKUBERNETESCLUSTERS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
