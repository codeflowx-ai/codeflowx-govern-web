...
/**
 * ViewModel para búsqueda y listado de CloudProvider
...
public class CloudProviderOverviewViewModel extends BaseFront<CloudProviderOverviewViewModel>{
    ...
    private PageResult<CloudProvider> pageResult;
    ...
    // ========== Datos ==========
    private List<CloudProvider> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = cloudProviderService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFCLOUDPROVIDERS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<CloudProviderMetricsSummary> metrics = businessService.findAllView(CloudProviderMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            cloudProviderService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFCLOUDPROVIDERS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
