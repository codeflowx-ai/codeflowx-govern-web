...
/**
 * ViewModel para búsqueda y listado de InfrastructureTemplate
...
public class InfrastructureTemplateOverviewViewModel extends BaseFront<InfrastructureTemplateOverviewViewModel>{
    ...
    private PageResult<InfrastructureTemplate> pageResult;
    ...
    // ========== Datos ==========
    private List<InfrastructureTemplate> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = infrastructureTemplateService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFTEMPLATES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "inftemplatename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InfrastructureTemplateMetricsSummary> metrics = businessService.findAllView(InfrastructureTemplateMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            infrastructureTemplateService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFTEMPLATES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
