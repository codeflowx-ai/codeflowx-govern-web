...
/**
 * ViewModel para búsqueda y listado de CloudResource
...
public class CloudResourceOverviewViewModel extends BaseFront<CloudResourceOverviewViewModel>{
    ...
    private PageResult<CloudResource> pageResult;
    ...
    // ========== Datos ==========
    private List<CloudResource> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = cloudResourceService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFCLOUDRESOURCES", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<CloudResourceMetricsSummary> metrics = businessService.findAllView(CloudResourceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            cloudResourceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFCLOUDRESOURCES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
