...
public class InfrastructureTemplateDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentInfrastructureTemplate = businessService.findById(InfrastructureTemplate.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentInfrastructureTemplate);
                ...
                businessService.update(currentInfrastructureTemplate);
