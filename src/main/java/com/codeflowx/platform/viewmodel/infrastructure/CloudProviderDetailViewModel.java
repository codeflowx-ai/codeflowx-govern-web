...
public class CloudProviderDetailViewModel extends MasterPage {
    ...
    private void loadItem(Long id) {
        try {
            ...
            currentCloudProvider = businessService.findById(CloudProvider.class, id);
    ...
    public void saveItem() {
        try {
            ...
            if (isNew) {
                businessService.save(currentCloudProvider);
                ...
                businessService.update(currentCloudProvider);
