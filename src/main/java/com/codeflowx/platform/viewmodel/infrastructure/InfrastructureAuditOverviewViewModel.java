...
/**
 * ViewModel para búsqueda y listado de InfrastructureAudit
...
public class InfrastructureAuditOverviewViewModel extends BaseFront<InfrastructureAuditOverviewViewModel>{
    ...
    private PageResult<InfrastructureAudit> pageResult;
    ...
    // ========== Datos ==========
    private List<InfrastructureAudit> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = infrastructureAuditService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFAUDITS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infauditresourcename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InfrastructureAuditMetricsSummary> metrics = businessService.findAllView(InfrastructureAuditMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            infrastructureAuditService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFAUDITS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
