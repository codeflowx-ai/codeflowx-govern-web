...
public class InfrastructureHealthMatrixOverviewViewModel extends MasterPage {
    ...
    public void loadData() {
        try {
            ...
            pageResult = businessService.findAllView(
                InfrastructureHealthMatrix.class,
                pageParams,
                criterias
            );
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InfrastructureHealthMatrixMetricsSummary> metrics = businessService.findAllView(InfrastructureHealthMatrixMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(InfrastructureHealthMatrix.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_INFRASTRUCTURE_HEALTH_MATRIX", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
