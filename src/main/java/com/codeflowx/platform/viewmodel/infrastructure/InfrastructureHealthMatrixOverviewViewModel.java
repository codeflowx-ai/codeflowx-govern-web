...
import com.codeflowx.govern.entity.views.infrastructure.InfrastructureHealthMatrix;
import com.codeflowx.govern.entity.views.infrastructure.InfrastructureHealthMatrixMetricsSummary;
import com.codeflowx.govern.service.infrastructure.InfrastructureHealthMatrixService;
import com.codeflowx.govern.service.infrastructure.InfrastructureHealthMatrixMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de InfrastructureHealthMatrix
...
public class InfrastructureHealthMatrixOverviewViewModel extends BaseFront<InfrastructureHealthMatrixOverviewViewModel>{
    ...
    @WireVariable
    private InfrastructureHealthMatrixService infrastructureHealthMatrixService;

    @WireVariable
    private InfrastructureHealthMatrixMetricsSummaryService infrastructureHealthMatrixMetricsSummaryService;
    ...
    private PageResult<InfrastructureHealthMatrix> pageResult;
    ...
    // ========== Datos ==========
    private List<InfrastructureHealthMatrix> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = infrastructureHealthMatrixService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_INFRASTRUCTURE_HEALTH_MATRIX", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            List<InfrastructureHealthMatrixMetricsSummary> metrics = infrastructureHealthMatrixMetricsSummaryService.findAll();
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemplo h;
