...
/**
 * ViewModel para búsqueda y listado de GpuInstance
...
public class GpuInstanceOverviewViewModel extends BaseFront<GpuInstanceOverviewViewModel>{
    ...
    private PageResult<GpuInstance> pageResult;
    ...
    // ========== Datos ==========
    private List<GpuInstance> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = gpuInstanceService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFGPUINSTANCES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infgpuname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<GpuInstanceMetricsSummary> metrics = businessService.findAllView(GpuInstanceMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            gpuInstanceService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFGPUINSTANCES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
