...
/**
 * ViewModel para búsqueda y listado de InfrastructureMetric
...
public class InfrastructureMetricOverviewViewModel extends BaseFront<InfrastructureMetricOverviewViewModel>{
    ...
    private PageResult<InfrastructureMetric> pageResult;
    ...
    // ========== Datos ==========
    private List<InfrastructureMetric> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = infrastructureMetricService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFMETRICS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infmetricname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InfrastructureMetricMetricsSummary> metrics = businessService.findAllView(InfrastructureMetricMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            infrastructureMetricService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFMETRICS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
