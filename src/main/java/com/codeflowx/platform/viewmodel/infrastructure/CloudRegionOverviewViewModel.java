...
/**
 * ViewModel para búsqueda y listado de CloudRegion
...
public class CloudRegionOverviewViewModel extends BaseFront<CloudRegionOverviewViewModel>{
    ...
    private PageResult<CloudRegion> pageResult;
    ...
    // ========== Datos ==========
    private List<CloudRegion> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = cloudRegionService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFCLOUDREGIONS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infregioncode");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<CloudRegionMetricsSummary> metrics = businessService.findAllView(CloudRegionMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            cloudRegionService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFCLOUDREGIONS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
