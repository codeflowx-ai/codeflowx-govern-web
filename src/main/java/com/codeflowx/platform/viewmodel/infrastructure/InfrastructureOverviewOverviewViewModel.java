...
public class InfrastructureOverviewOverviewViewModel extends MasterPage {
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InfrastructureOverviewMetricsSummary> metrics = businessService.findAllView(InfrastructureOverviewMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(InfrastructureOverview.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_INFRASTRUCTURE_OVERVIEW", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
