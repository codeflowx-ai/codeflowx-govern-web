...
import com.codeflowx.govern.entity.views.infrastructure.InfrastructureOverviewMetricsSummary;
import com.codeflowx.govern.service.infrastructure.InfrastructureOverviewService;
import com.codeflowx.govern.service.infrastructure.InfrastructureOverviewMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de InfrastructureOverview
...
public class InfrastructureOverviewOverviewViewModel extends BaseFront<InfrastructureOverviewOverviewViewModel>{
    ...
    @WireVariable
    private InfrastructureOverviewMetricsSummaryService infrastructureOverviewMetricsSummaryService;
    ...
    // ========== Datos ==========
    private List<InfrastructureOverview> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_INFRASTRUCTURE_OVERVIEW", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            List<InfrastructureOverviewMetricsSummary> metrics = infrastructureOverviewMetricsSummaryService.findAll();
