...
/**
 * ViewModel para búsqueda y listado de KubernetesNode
...
public class KubernetesNodeOverviewViewModel extends BaseFront<KubernetesNodeOverviewViewModel>{
    ...
    private PageResult<KubernetesNode> pageResult;
    ...
    // ========== Datos ==========
    private List<KubernetesNode> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = kubernetesNodeService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFK8SNODES", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infk8snodename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<KubernetesNodeMetricsSummary> metrics = businessService.findAllView(KubernetesNodeMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            kubernetesNodeService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFK8SNODES", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
