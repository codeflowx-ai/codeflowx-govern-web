...
/**
 * ViewModel para DETALLE/EDICIÓN/CREACIÓN de CloudRegion
 */
@Slf4j
@Getter
@Setter
@VariableResolver(DelegatingVariableResolver.class)
public class CloudRegionDetailViewModel extends BaseFront<CloudRegionDetailViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        if ("NEW".equals(mode)) {
            ...
            loadItem(idxcloudregion);
        } else {
            log.error("Modo inválido o falta idxcloudregion");
    ...
    private boolean validateRequiredFields() {
        ...
        if (currentCloudRegion.getInfregioncode() == null || currentCloudRegion.getInfregioncode().trim().isEmpty()) {
            errors.append("- Regioncode\n");
        }
        if (currentCloudRegion.getInfregioncode() != null && currentCloudRegion.getInfregioncode().length() > 100) {
            errors.append("- Regioncode no puede exceder 100 caracteres\n");
        }
        if (currentCloudRegion.getInfregionname() == null || currentCloudRegion.getInfregionname().trim().isEmpty()) {
            errors.append("- Regionname\n");
        }
    ...
    public void cancelEdit() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("dataParam", idxcloudregion);
        params.put("action", Action.LOAD);
        appendPage("plataforma/infrastructure/infrastructure-overview.zul", page.getFellow(IDDESKTOP), params);
    }
