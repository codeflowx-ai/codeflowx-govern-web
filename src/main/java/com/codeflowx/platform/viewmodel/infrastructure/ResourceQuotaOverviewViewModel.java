...
/**
 * ViewModel para búsqueda y listado de ResourceQuota
...
public class ResourceQuotaOverviewViewModel extends BaseFront<ResourceQuotaOverviewViewModel>{
    ...
    private PageResult<ResourceQuota> pageResult;
    ...
    // ========== Datos ==========
    private List<ResourceQuota> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = resourceQuotaService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFRESOURCEQUOTAS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infquotanamespace");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<ResourceQuotaMetricsSummary> metrics = businessService.findAllView(ResourceQuotaMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            resourceQuotaService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFRESOURCEQUOTAS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
