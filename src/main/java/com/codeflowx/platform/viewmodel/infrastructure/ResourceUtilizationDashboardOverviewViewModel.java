...
/**
 * ViewModel para búsqueda y listado de ResourceUtilizationDashboard
...
public class ResourceUtilizationDashboardOverviewViewModel extends BaseFront<ResourceUtilizationDashboardOverviewViewModel>{
