...
import com.codeflowx.govern.entity.views.infrastructure.InfrastructureMetricsSummaryMetricsSummary;
import com.codeflowx.govern.service.infrastructure.InfrastructureMetricsSummaryService;
import com.codeflowx.govern.service.infrastructure.InfrastructureMetricsSummaryMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de InfrastructureMetricsSummary
...
public class InfrastructureMetricsSummaryOverviewViewModel extends BaseFront<InfrastructureMetricsSummaryOverviewViewModel>{
    ...
    @WireVariable
    private InfrastructureMetricsSummaryMetricsSummaryService infrastructureMetricsSummaryMetricsSummaryService;
    ...
    private PageResult<InfrastructureMetricsSummary> pageResult;
    ...
    // ========== Datos ==========
    private List<InfrastructureMetricsSummary> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = infrastructureMetricsSummaryService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_INFRASTRUCTURE_METRICS_SUMMARY", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            List<InfrastructureMetricsSummaryMetricsSummary> metrics = infrastructureMetricsSummaryMetricsSummaryService.findAll();
     ...
     * @param mensaje  -- mensaje aclaratorio, ejemploe);
