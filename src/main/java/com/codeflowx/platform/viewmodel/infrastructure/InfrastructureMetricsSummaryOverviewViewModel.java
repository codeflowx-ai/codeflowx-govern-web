...
public class InfrastructureMetricsSummaryOverviewViewModel extends MasterPage {
    ...
    public void loadData() {
        try {
            ...
            pageResult = businessService.findAllView(
                InfrastructureMetricsSummary.class,
                pageParams,
                criterias
            );
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InfrastructureMetricsSummaryMetricsSummary> metrics = businessService.findAllView(InfrastructureMetricsSummaryMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(InfrastructureMetricsSummary.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_INFRASTRUCTURE_METRICS_SUMMARY", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
