...
import com.codeflowx.govern.entity.views.infrastructure.CapacityForecast;
import com.codeflowx.govern.service.infrastructure.CapacityForecastService;
...
/**
 * ViewModel para búsqueda y listado de CapacityForecast
...
public class CapacityForecastOverviewViewModel extends BaseFront<CapacityForecastOverviewViewModel>{
    ...
    @WireVariable
    private CapacityForecastService capacityForecastService;
    ...
    private PageResult<CapacityForecast> pageResult;
    ...
    // ========== Datos ==========
    private List<CapacityForecast> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = capacityForecastService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_CAPACITY_FORECAST", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<CapacityForecastMetricsSummary> metrics = businessService.findAllView(CapacityForecastMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            capacityForecastService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_CAPACITY_FORECAST", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
