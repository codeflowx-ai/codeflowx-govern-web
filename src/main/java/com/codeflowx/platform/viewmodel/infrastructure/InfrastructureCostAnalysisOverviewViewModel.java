...
public class InfrastructureCostAnalysisOverviewViewModel extends MasterPage {
    ...
    public void loadData() {
        try {
            ...
            pageResult = businessService.findAllView(
                InfrastructureCostAnalysis.class,
                pageParams,
                criterias
            );
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InfrastructureCostAnalysisMetricsSummary> metrics = businessService.findAllView(InfrastructureCostAnalysisMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?", 
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            businessService.removeFromID(InfrastructureCostAnalysis.class, itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "V_INFRASTRUCTURE_COST_ANALYSIS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
