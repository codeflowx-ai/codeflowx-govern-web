...
import com.codeflowx.govern.entity.views.infrastructure.InfrastructureCostAnalysis;
import com.codeflowx.govern.entity.views.infrastructure.InfrastructureCostAnalysisMetricsSummary;
import com.codeflowx.govern.service.infrastructure.InfrastructureCostAnalysisService;
import com.codeflowx.govern.service.infrastructure.InfrastructureCostAnalysisMetricsSummaryService;
...
/**
 * ViewModel para búsqueda y listado de InfrastructureCostAnalysis
...
public class InfrastructureCostAnalysisOverviewViewModel extends BaseFront<InfrastructureCostAnalysisOverviewViewModel>{
    ...
    @WireVariable
    private InfrastructureCostAnalysisService infrastructureCostAnalysisService;

    @WireVariable
    private InfrastructureCostAnalysisMetricsSummaryService infrastructureCostAnalysisMetricsSummaryService;
    ...
    private PageResult<InfrastructureCostAnalysis> pageResult;
    ...
    // ========== Datos ==========
    private List<InfrastructureCostAnalysis> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = infrastructureCostAnalysisService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "V_INFRASTRUCTURE_COST_ANALYSIS", null,
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            List<InfrastructureCostAnalysisMetricsSummary> metrics = infrastructureCostAnalysisMetricsSummaryService.findAll();
