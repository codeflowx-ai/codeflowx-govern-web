...
/**
 * ViewModel para búsqueda y listado de InfrastructureCost
...
public class InfrastructureCostOverviewViewModel extends BaseFront<InfrastructureCostOverviewViewModel>{
    ...
    private PageResult<InfrastructureCost> pageResult;
    ...
    // ========== Datos ==========
    private List<InfrastructureCost> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = infrastructureCostService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFCOSTS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infcostresourcename");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<InfrastructureCostMetricsSummary> metrics = businessService.findAllView(InfrastructureCostMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            infrastructureCostService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFCOSTS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
