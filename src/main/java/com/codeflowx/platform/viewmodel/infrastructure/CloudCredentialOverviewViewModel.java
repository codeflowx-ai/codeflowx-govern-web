...
/**
 * ViewModel para búsqueda y listado de CloudCredential
...
public class CloudCredentialOverviewViewModel extends BaseFront<CloudCredentialOverviewViewModel> {
    ...
    private PageResult<CloudCredential> pageResult;
    ...
    // ========== Datos ==========
    private List<CloudCredential> filteredItems = new ArrayList<>();
    ...
    public void loadData() {
        try {
            ...
            pageResult = cloudCredentialService.findAll(
                pageParams,
                criterias
            );
            ...
            if (pageResult != null && pageResult.getContent() != null) {
                ...
                // Auditar búsqueda
                logActivity("BUSCAR", "INFCREDENTIALS", null,
    ...
    private Criterias buildCriterias() {
        ...
        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            Criteria criteria = new Criteria(Operation.AND, Evaluation.LIKE, "infcredname");
    ...
    private void loadGlobalMetrics() {
        try {
            ...
            // Ejemplo: List<CloudCredentialMetricsSummary> metrics = businessService.findAllView(CloudCredentialMetricsSummary.class);
            ...
            Messagebox.show("¿Está seguro de eliminar este registro?",
                ...
                event -> {
                    if (Messagebox.ON_YES.equals(event.getName())) {
                        try {
                            cloudCredentialService.deleteById(itemId);
                            log.info("Registro eliminado: ID={}", itemId);
                            logActivity("BORRAR", "INFCREDENTIALS", itemId, "Eliminado registro ID: " + itemId);
                            loadData();
