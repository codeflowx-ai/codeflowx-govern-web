...
public class BiasReviewViewModel extends BaseFront<BiasReviewViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        log.info("🚀 Inicializando BiasReviewViewModel");
    ...
    private void loadMockData() {
        this.taskId = "mock-bias-review-001";
        this.processInstanceId = "mock-bias-review-process-001";
        log.info("🎭 Mock data loaded for Bias Review");
    }
    ...
    public void doSubmit() {
        try {
            if (mockMode) {
                ...
                logActivity("MOCK_BIAS_REVIEW", "BiasReview", null, "Simulación: " + decision);
