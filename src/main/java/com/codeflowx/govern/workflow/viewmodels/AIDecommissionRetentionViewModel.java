...
public class AIDecommissionRetentionViewModel extends BaseFront<AIDecommissionRetentionViewModel>{
    ...
    private String anonymizationDetails;
    ...
    private void loadContext() {
        try {
            ...
            log.error("Error cargando contexto de retención", e);
        }
    }
    ...
    public void doSubmit() {
        try {
            ...
            variables.put("dataRetentionPlan", retentionStrategy);
            variables.put("dataRetentionEndDate", retentionEndDate);
            variables.put("dataAnonymizationDetails", anonymizationDetails);
            variables.put("retentionReviewedBy", ctxBean.getUser().getUsuname());
            taskService.complete(taskId, variables);
            Executions.sendRedirect("/plataforma/workflow/task-inbox.zul");
        } catch (Exception e) {
            log.error("Error registrando plan de retención", e);
