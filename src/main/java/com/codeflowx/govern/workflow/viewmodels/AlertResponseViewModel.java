...
public class AlertResponseViewModel extends BaseFront<AlertResponseViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        log.info("🚀 Inicializando AlertResponseViewModel");
    ...
    private void loadMockData() {
        this.taskId = "mock-alert-response-001";
        this.processInstanceId = "mock-alert-process-001";
        log.info("🎭 Mock data loaded for Alert Response");
    }
    ...
    public void doSubmit() {
        try {
            if (mockMode) {
                ...
                logActivity("MOCK_ALERT_RESPONSE", "AlertResponse", null, "Simulación: " + decision);
                Messagebox.show("✅ [DEMO] Respuesta registrada: " + decision, "Demo Mode", 
