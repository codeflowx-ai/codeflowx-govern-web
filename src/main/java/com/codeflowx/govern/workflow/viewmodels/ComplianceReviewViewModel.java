...
/**
 * Revisión de compliance findings
 * Proceso: 04_COMPLIANCE_MONITORING
 */
@Slf4j
@Getter
@Setter
...
public class ComplianceReviewViewModel extends BaseFront<ComplianceReviewViewModel>{
    ...
    public void afterCompose(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        log.info("🚀 Inicializando ComplianceReviewViewModel");
    ...
    private void loadMockData() {
        this.taskId = "mock-compliance-review-001";
        this.processInstanceId = "mock-compliance-process-001";
        log.info("🎭 Mock data loaded for Compliance Review");
    }
    ...
    public void doSubmit() {
        try {
            if (mockMode) {
                ...
                logActivity("MOCK_COMPLIANCE_REVIEW", "ComplianceReview", null, "Simulación: " + decision);
