...
public class ExperimentsDetailViewModel extends MasterPage implements Serializable {
    ...
    private void loadExperiment(Long experimentId) {
        try {
            ...
            currentExperiment = businessService.findById(Experiment.class, experimentId);
    ...
    private void loadExperimentRuns(Long experimentId) {
        try {
            ...
            PageResult<Run> result = businessService.findAllEntity(Run.class, params, criterias);
    ...
    private void loadHpoTrials(Long experimentId) {
        try {
            ...
            PageResult<HPOTrial> result = businessService.findAllEntity(HPOTrial.class, params, new Criterias());
    ...
    private void loadMetricsSummary(Long experimentId) {
        try {
            ...
            PageResult<TrainingMetricsSummary> result = businessService.findAllView(TrainingMetricsSummary.class, params, new Criterias());
