...
public class MainDashboardViewModel extends MasterPage {
    ...
    private void loadDashboardSummary() {
        try {
            ...
            // AdminDashboardSummary es una VIEW
    ...
    private void loadTokenMetrics() {
        try {
            ...
            // TokenMetrics es una TABLE
            PageResult<TokenMetrics> result = businessService.findAllEntity(
                TokenMetrics.class,
                pageParams
            );
    ...
    private void loadModuleDashboards() {
        try {
            ...
            PageResult<AgentHealthDashboard> agentResult = businessService.findAllView(
                AgentHealthDashboard.class, pageParams
            );
            ...
            PageResult<GovernanceDashboardSummary> govResult = businessService.findAllView(
                GovernanceDashboardSummary.class, pageParams
            );
            ...
            PageResult<HpoProgressDashboard> trainResult = businessService.findAllView(
                HpoProgressDashboard.class, pageParams
            );
            ...
            // Serving Performance - VIEW
            PageResult<ServingPerformanceDashboard> servResult = businessService.findAllView(
                ServingPerformanceDashboard.class, pageParams
            );
