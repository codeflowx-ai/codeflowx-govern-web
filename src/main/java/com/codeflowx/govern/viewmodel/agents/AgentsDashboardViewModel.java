...
import com.codeflowx.govern.service.agents.AgentDeploymentStatusService;
...
public class AgentsDashboardViewModel extends BaseFront<AgentsDashboardViewModel> {
    ...
    private void loadHealthDashboard() {
        try {
            ...
            PageResult<AgentHealthDashboard> result = agentHealthDashboardService.findAll(pageParams, new Criterias());
            ...
            log.debug("Error inesperado al cargar dashboard de salud: {}", e.getMessage());
            healthDashboard = null;
        }
    }
    ...
    private void loadPerformanceMetrics() {
        try {
            ...
            PageResult<AgentPerformanceMetrics> result = agentPerformanceMetricsService.findAll(pageParams, new Criterias());
            ...
            log.error("Error inesperado al cargar métricas de rendimiento", e);
        }
    }
    ...
    private void loadDeploymentStatuses() {
        try {
            ...
            PageResult<AgentDeploymentStatus> result = agentDeploymentStatusService.findAll(pageParams, new Criterias());
            ...
            log.error("Error inesperado al cargar estados de deployment", e);
        }
    }
    ...
    private void loadComplianceStatuses() {
        try {
            ...
            PageResult<AgentComplianceStatus> result = agentComplianceStatusService.findAll(pageParams, new Criterias());
            ...
            log.error("Error inesperado al cargar estados de compliance", e);
        }
    }
    ...
    public void destroy() {
        ...
        try {
            ...
            // Limpiar servicios
            agentService = null;
            agentHealthDashboardService = null;
            agentPerformanceMetricsService = null;
            agentDeploymentStatusService = null;
            agentComplianceStatusService = null;
